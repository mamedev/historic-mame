...
{
	{  0,1,"NEG",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{  3,1,"COM",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{  4,1,"LSR",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{  6,1,"ROR",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{  7,1,"ASR",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{  8,1,"ASL",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{  9,1,"ROL",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{ 10,1,"DEC",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{ 12,1,"INC",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{ 13,1,"TST",     DIR, EA_UINT8, EA_MEM_RDWR,  6},
	{ 14,1,"JMP",     DIR, EA_UINT8, EA_ABS_PC,    3},
	{ 15,1,"CLR",     DIR, EA_UINT8, EA_MEM_WR,    6},
	...
	{144,1,"SUBA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{145,1,"CMPA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{146,1,"SBCA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{147,1,"SUBD",    DIR, EA_UINT16,EA_MEM_RD,    6},
	{148,1,"ANDA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{149,1,"BITA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{150,1,"LDA",     DIR, EA_UINT8, EA_MEM_RD,    4},
	{151,1,"STA",     DIR, EA_UINT8, EA_MEM_WR,    4},
	{152,1,"EORA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{153,1,"ADCA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{154,1,"ORA",     DIR, EA_UINT8, EA_MEM_RD,    4},
	{155,1,"ADDA",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{156,1,"CPX",     DIR, EA_UINT16,EA_MEM_RD,    6},
	{157,1,"JSR",     DIR, EA_UINT8, EA_ABS_PC,    7},
	{158,1,"LDX",     DIR, EA_UINT16,EA_MEM_RD,    5},
	{159,1,"STX",     DIR, EA_UINT16,EA_MEM_WR,    5},
	...
	{208,1,"SUBB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{209,1,"CMPB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{210,1,"SBCB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{211,1,"ADDD",    DIR, EA_UINT8, EA_MEM_RD,    6},
	{212,1,"ANDB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{213,1,"BITB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{214,1,"LDB",     DIR, EA_UINT8, EA_MEM_RD,    4},
	{215,1,"STB",     DIR, EA_UINT8, EA_MEM_WR,    4},
	{216,1,"EORB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{217,1,"ADCB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{218,1,"ORB",     DIR, EA_UINT8, EA_MEM_RD,    4},
	{219,1,"ADDB",    DIR, EA_UINT8, EA_MEM_RD,    4},
	{220,1,"LDD",     DIR, EA_UINT16,EA_MEM_RD,    5},
	{221,1,"STD",     DIR, EA_UINT16,EA_MEM_WR,    5},
	{222,1,"LDU",     DIR, EA_UINT16,EA_MEM_RD,    5},
	{223,1,"STU",     DIR, EA_UINT16,EA_MEM_WR,    5},
...
static opcodeinfo pg2opcodes[NUMPG2OPS] =
{
	...
	{147,2,"CMPD",    DIR, EA_UINT16,EA_MEM_RD,    7},
	{156,2,"CMPY",    DIR, EA_UINT16,EA_MEM_RD,    7},
	{158,2,"LDY",     DIR, EA_UINT16,EA_MEM_RD,    6},
	{159,2,"STY",     DIR, EA_UINT16,EA_MEM_RD,    6},
	...
	{222,2,"LDS",     DIR, EA_UINT16,EA_MEM_RD,    6},
	{223,2,"STS",     DIR, EA_UINT16,EA_MEM_WR,    6},
...
static opcodeinfo pg3opcodes[NUMPG3OPS] =
{
	...
	{147,2,"CMPU",    DIR, EA_UINT16,EA_MEM_RD,    7},
	{156,2,"CMPS",    DIR, EA_UINT16,EA_MEM_RD,    7},
