...
#define read_imm_8()  m68000_read_memory_8(((g_cpu_pc+=2)-1)&0xffffff)
#define read_imm_16() m68000_read_memory_16(((g_cpu_pc+=2)-2)&0xffffff)
#define read_imm_32() m68000_read_memory_32(((g_cpu_pc+=4)-4)&0xffffff)

#define peek_imm_8()  m68000_read_memory_8(g_cpu_pc & 0xffffff)
#define peek_imm_16() m68000_read_memory_16(g_cpu_pc & 0xffffff)
#define peek_imm_32() m68000_read_memory_32(g_cpu_pc & 0xffffff)
...
static void d68020_chk2_8(void)
{
   uint extension = read_imm_16();
   sprintf(g_dasm_str, "chk2.b  %s, %c%d; (2+)", get_ea_mode_str_8(g_cpu_ir), BIT_F(extension) ? 'A' : 'D', (extension>>12)&7);
}

static void d68020_chk2_16(void)
{
   uint extension = read_imm_16();
   sprintf(g_dasm_str, "chk2.w  %s, %c%d; (2+)", get_ea_mode_str_16(g_cpu_ir), BIT_F(extension) ? 'A' : 'D', (extension>>12)&7);
}

static void d68020_chk2_32(void)
{
   uint extension = read_imm_16();
   sprintf(g_dasm_str, "chk2.l  %s, %c%d; (2+)", get_ea_mode_str_32(g_cpu_ir), BIT_F(extension) ? 'A' : 'D', (extension>>12)&7);
}
...
static void d68020_cmp2_8(void)
{
   uint extension = read_imm_16();
   sprintf(g_dasm_str, "cmp2.b  %s, %c%d; (2+)", get_ea_mode_str_8(g_cpu_ir), BIT_F(extension) ? 'A' : 'D', (extension>>12)&7);
}

static void d68020_cmp2_16(void)
{
   uint extension = read_imm_16();
   sprintf(g_dasm_str, "cmp2.w  %s, %c%d; (2+)", get_ea_mode_str_8(g_cpu_ir), BIT_F(extension) ? 'A' : 'D', (extension>>12)&7);
}

static void d68020_cmp2_32(void)
{
   uint extension = read_imm_16();
   sprintf(g_dasm_str, "cmp2.l  %s, %c%d; (2+)", get_ea_mode_str_8(g_cpu_ir), BIT_F(extension) ? 'A' : 'D', (extension>>12)&7);
}
...
/*  opcode handler    mask    match   ea mask */
   ...
   {d68020_cas_8        , 0xffc8, 0x0ac0, 0x3f8},
   {d68020_cas_16       , 0xffc8, 0x0cc0, 0x3f8},
   {d68020_cas_32       , 0xffc8, 0x0ec0, 0x3f8},
   ...
   {d68020_chk2_8       , 0xffc0, 0x00c0, 0x27b},
   {d68020_chk2_16      , 0xffc0, 0x02c0, 0x27b},
   {d68020_chk2_32      , 0xffc0, 0x04c0, 0x27b},
   ...
   {d68020_cmp2_8       , 0xffc0, 0x00c0, 0x27b},
   {d68020_cmp2_16      , 0xffc0, 0x02c0, 0x27b},
   {d68020_cmp2_32      , 0xffc0, 0x04c0, 0x27b},
   ...
   {d68000_movem_re_16  , 0xffc0, 0x4880, 0x37b},
   {d68000_movem_re_32  , 0xffc0, 0x48c0, 0x37b},
   ...
   {d68020_tst_pcdi_32  , 0xffff, 0x4afa, 0x000},
   {d68020_tst_pcix_32  , 0xffff, 0x4afb, 0x000},
   {d68020_tst_i_32     , 0xffff, 0x4afc, 0x000},
