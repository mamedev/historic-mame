...
/* Default to autovector until support is added to mame */
extern int (*m68000_irq_callback)(int irqline);
#define m68000_interrupt_acknowledge(int_level) (m68000_irq_callback) ? (*m68000_irq_callback)(int_level) : -1
