...
UINT32  read_8  (UINT32 address);
UINT32  read_16 (UINT32 address);
UINT32  read_32 (UINT32 address);
...
static UINT32 g_3bit_qdata_table[8] = {8, 1, 2, 3, 4, 5, 6, 7};

static UINT32 g_5bit_data_table[32] =
{
...
{
   UINT32 extension1 = read_imm_16();
   UINT32 extension2 = read_imm_16();
   UINT32 new_pc = g_cpu_pc;
   new_pc += make_int_16(peek_imm_16());
...
static int CLIB_DECL compare_nof_true_bits(const void *aptr, const void *bptr)
{
   UINT32 a = ((opcode_struct*)aptr)->mask;
   UINT32 b = ((opcode_struct*)bptr)->mask;
