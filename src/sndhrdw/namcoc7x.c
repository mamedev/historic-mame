...
void namcoc7x_on_driver_init(void)
{
	...
	memory_install_read16_handler(1, ADDRESS_SPACE_PROGRAM, 0x82, 0x83, 0, 0, speedup_r);
	memory_install_write16_handler(1, ADDRESS_SPACE_PROGRAM, 0x82, 0x83, 0, 0, speedup_w);
}
