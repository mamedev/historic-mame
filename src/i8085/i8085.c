...
static UINT8 ROP(void) { return cpu_readop(I.PC.W.l++); }
static UINT8 ARG(void) { return cpu_readop_arg(I.PC.W.l++); }
static UINT16 ARG16(void) { unsigned w = cpu_readop_arg(I.PC.W.l++); w += cpu_readop_arg(I.PC.W.l++) << 8; return w; }
static UINT8 RM(int a) { return cpu_readmem16(a); }
static void WM(UINT32 a, UINT8 v) { cpu_writemem16(a, v); }
...
INLINE void ExecOne(int opcode)
{
	switch (opcode)
	{
		...
		case 0xfb: I8085_ICount -= 4;	/* EI */
			...
			if (I.irq_state[0] != CLEAR_LINE) I.IREQ |= IM_INTR;
			if (I.irq_state[1] != CLEAR_LINE) I.IREQ |= IM_RST55;
			if (I.irq_state[2] != CLEAR_LINE) I.IREQ |= IM_RST65;
			if (I.irq_state[3] != CLEAR_LINE) I.IREQ |= IM_RST75;
#endif
...
#if NEW_INTERRUPT_SYSTEM
	if (I.ISRV & IM_INTR)  I.IRQ1 = (I.irq_callback)(0);
	if (I.ISRV & IM_RST55) I.IRQ1 = (I.irq_callback)(1);
	if (I.ISRV & IM_RST65) I.IRQ1 = (I.irq_callback)(2);
    if (I.ISRV & IM_RST75) I.IRQ1 = (I.irq_callback)(3);
#endif
...
void I8085_set_irq_line(int irqline, int state)
{
	...
	if (state == CLEAR_LINE) {
		if (!(I.IM & IM_IEN)) {
			switch (irqline) {
				case 0: I8085_SetINTR(0); break;
				case 1: I8085_SetRST55(0); break;
				case 2: I8085_SetRST65(0); break;
				case 3: I8085_SetRST75(0); break;
            }
        }
	} else {
		if (!(I.IM & IM_IEN)) {
			switch (irqline) {
				case 0: I8085_SetINTR(1); break;
				case 1: I8085_SetRST55(1); break;
				case 2: I8085_SetRST65(1); break;
				case 3: I8085_SetRST75(1); break;
			}
		}
    }
}
...
void    I8085_Cause_Interrupt(int type)
{
	...
	{
		case I8085_SID:
			LOG((errorlog, "I8085_Cause_Interrupt: SID\n"));
			I8085_SetSID(1);
			break;
		case I8085_TRAP:
			LOG((errorlog, "I8085_Cause_Interrupt: TRAP\n"));
			I8085_SetTRAP(1);
			break;
		case I8085_RST75:
			LOG((errorlog, "I8085_Cause_Interrupt: RST7.5\n"));
			I8085_SetRST75(1);
			break;
		case I8085_RST65:
			LOG((errorlog, "I8085_Cause_Interrupt: RST6.5\n"));
			I8085_SetRST65(1);
			break;
		case I8085_RST55:
			LOG((errorlog, "I8085_Cause_Interrupt: RST5.5\n"));
			I8085_SetRST55(1);
			break;
		default:
			LOG((errorlog, "I8085_Cause_Interrupt: INTR $%X\n", type));
			I8085_SetINTR(type);
			break;
	}
}
