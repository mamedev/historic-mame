...
extern  FILE * errorlog;
        if (errorlog) fprintf (errorlog, "I8085 illegal instruction %04X $%02X\n", pc, cpu_readop(pc));
#endif
}
...
void    I8085_Cause_Interrupt(int type)
{
        switch (type)
        {
                case I8085_SID:
#ifdef  VERBOSE
                        if (errorlog) fprintf (errorlog, "I8085_Cause_Interrupt: SID\n");
#endif
                        I8085_SetSID(1);
                        break;
                case I8085_TRAP:
#ifdef  VERBOSE
                        if (errorlog) fprintf (errorlog, "I8085_Cause_Interrupt: TRAP\n");
#endif
                        I8085_SetTRAP(1);
                        break;
                case I8085_RST75:
#ifdef  VERBOSE
                        if (errorlog) fprintf (errorlog, "I8085_Cause_Interrupt: RST7.5\n");
#endif
                        I8085_SetRST75(1);
                        break;
                case I8085_RST65:
#ifdef  VERBOSE
                        if (errorlog) fprintf (errorlog, "I8085_Cause_Interrupt: RST6.5\n");
#endif
                        I8085_SetRST65(1);
                        break;
                case I8085_RST55:
#ifdef  VERBOSE
                        if (errorlog) fprintf (errorlog, "I8085_Cause_Interrupt: RST5.5\n");
#endif
                        I8085_SetRST55(1);
                        break;
                default:
#ifdef  VERBOSE
                        if (errorlog) fprintf (errorlog, "I8085_Cause_Interrupt: INTR $%X\n", type);
#endif
                        I8085_SetINTR(type);
                        break;
        }
