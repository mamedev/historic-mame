...
mame_timer *_mame_timer_alloc_ptr(void (*callback)(void *), const char *file, int line, const char *func);
...
#define mame_timer_alloc_ptr(c)			_mame_timer_alloc_ptr(c, __FILE__, __LINE__, #c)
