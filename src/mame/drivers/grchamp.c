...
static ADDRESS_MAP_START( main_portmap, ADDRESS_SPACE_IO, 8 )
	...
	AM_RANGE(0x00, 0x00) AM_MIRROR(0x78) AM_READ(port_tag_to_handler8("ACCEL"))
	AM_RANGE(0x02, 0x02) AM_MIRROR(0x78) AM_READ(sub_to_main_comm_r)
	AM_RANGE(0x03, 0x03) AM_MIRROR(0x78) AM_READ(port_tag_to_handler8("WHEEL"))
	AM_RANGE(0x04, 0x04) AM_MIRROR(0x78) AM_READ(port_tag_to_handler8("DSWA"))
	AM_RANGE(0x05, 0x05) AM_MIRROR(0x78) AM_READ(port_tag_to_handler8("DSWB"))
	AM_RANGE(0x06, 0x06) AM_MIRROR(0x78) AM_READ(port_tag_to_handler8("TILT"))
...
INPUT_PORTS_START( grchamp )
	...
	PORT_BIT( 0xff, 0x00, IPT_PEDAL ) PORT_MINMAX(0x00,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(16) PORT_CODE_INC(KEYCODE_LCONTROL)
