...
INPUT_PORTS_START( term2 )
	...
	PORT_START
	PORT_BIT( 0x00ff, 0x0080, IPT_AD_STICK_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0,0xff) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_CENTERDELTA(0) PORT_REVERSE PORT_PLAYER(1)
...
//  PORT_DIPSETTING(      0x0000, DEF_STR( Unused ))
	...
	PORT_START
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_MINMAX(0,0xff) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_CENTERDELTA(0) PORT_PLAYER(1)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0,0xff) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_CENTERDELTA(0) PORT_REVERSE PORT_PLAYER(2)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_Y ) PORT_CROSSHAIR(Y, 1.0, 0.0, 0) PORT_MINMAX(0,0xff) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_CENTERDELTA(0) PORT_PLAYER(2)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )
INPUT_PORTS_END
...
static MACHINE_DRIVER_START( zunit )
	...
	MDRV_SCREEN_VBLANK_TIME(TIME_IN_USEC(COMPUTED_VBLANK(400, 432, 57)))
...
static MACHINE_DRIVER_START( yunit_core )
	...
	MDRV_SCREEN_VBLANK_TIME(TIME_IN_USEC(COMPUTED_VBLANK(256, 288, MKLA5_FPS)))
	MDRV_MACHINE_RESET(midyunit)
	MDRV_NVRAM_HANDLER(midyunit)
...
static MACHINE_DRIVER_START( trog )
	...
	MDRV_SCREEN_VBLANK_TIME(TIME_IN_USEC(COMPUTED_VBLANK(256, 288, MKLA5_FPS)))
	MDRV_SCREEN_VISIBLE_AREA(0, 395, 0, 255)
MACHINE_DRIVER_END


static MACHINE_DRIVER_START( strkforc )
	MDRV_IMPORT_FROM(yunit_cvsd_4bit)
	MDRV_SCREEN_VBLANK_TIME(TIME_IN_USEC(COMPUTED_VBLANK(255, 288, MKLA5_FPS)))
	MDRV_SCREEN_VISIBLE_AREA(0, 399, 0, 254)
MACHINE_DRIVER_END
...
static MACHINE_DRIVER_START( smashtv )
	...
	MDRV_SCREEN_VBLANK_TIME(TIME_IN_USEC(COMPUTED_VBLANK(256, 288, MKLA5_FPS)))
	MDRV_SCREEN_VISIBLE_AREA(0, 409, 0, 255)
MACHINE_DRIVER_END
...
static MACHINE_DRIVER_START( term2 )
	...
	MDRV_SCREEN_VBLANK_TIME(TIME_IN_USEC(COMPUTED_VBLANK(255, 288, MKLA5_FPS)))
	MDRV_SCREEN_VISIBLE_AREA(0, 399, 0, 255)
//  MDRV_SCREEN_VISIBLE_AREA(0, 403, 0, 254)
MACHINE_DRIVER_END


static MACHINE_DRIVER_START( mk )
	MDRV_IMPORT_FROM(yunit_adpcm)
	MDRV_SCREEN_VBLANK_TIME(TIME_IN_USEC(COMPUTED_VBLANK(254, 288, MKLA5_FPS)))
