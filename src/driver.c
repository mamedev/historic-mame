...
extern struct GameDriver curvebal_driver;	/* GV-134 (c) 1984 Mylstar */
	/* other games running on this hardware: */
	/* Us vs. Them (laserdisc, conversion from MACH 3 */
	/* no others known. */
...
extern struct GameDriver zarzon_driver;		/* (c) [1981] Taito */
