...
*/
	...
	DRIVER( espradeo )	/* (c) 1998 Atlus/Cave */
...
TESTDRIVER( gigawing )	/* 22/02/1999 Giga Wing (USA) */
...
TESTDRIVER( dbz2 )		/* (c) 1994 Banpresto */
...
//	DRIVER( mslug4 )	/* 0263 (c) 2002 Mega Enterprise / Playmore Corporation */
