...
TESTDRIVER( ainferno )	/* C45 (c) 1990 Taito America Corporation (US) */
	...
	DRIVER( spcinv95 )	/* E06 (c) 1995 Taito America Corporation (US) */
...
TESTDRIVER( sango119 )	/* (c) 1999 */
TESTDRIVER( sango117 )	/* (c) 1999 */
TESTDRIVER( sango115 )	/* (c) 1999 */
