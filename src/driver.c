...
TESTDRIVER( chasehq2 )	/* C09 */
TESTDRIVER( chashq2a )	/* C09 */
TESTDRIVER( chashq2u )	/* C09 */
...
TESTDRIVER( sftm )		/* (c) 1995 Capcom/Incredible Technologies */
...
*/
	...
	/* Fire Truck */	/* 030926			1978/06 [6800] */
