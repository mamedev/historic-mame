...
static unsigned get_d8(unsigned seg, unsigned *off)
{
    return GetMemInc(seg, (*off));
}

static unsigned get_d16(unsigned seg, unsigned *off)
{
...
static char *get_mem(unsigned ModRM, unsigned seg, unsigned *off, char **reg, char *msg)
{
...
static WORD get_disp(unsigned seg, unsigned *off)
{
...
static WORD get_disp16(unsigned seg, unsigned *off)
{
    unsigned disp = GetMemInc(seg, (*off));
...
static void print_instruction(unsigned seg, unsigned off, int *tab, char *buf)
{
    unsigned ModRM = GetMemB(seg,off);
    sprintf(buf, "%-6s ", itext[tab[(ModRM & 0x38) >> 3]]);
}
    
static unsigned decode_br8(unsigned seg, unsigned off, char *buf)
{
...
static unsigned decode_r8b(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg,off);
...
static unsigned decode_wr16(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg,off);
...
static unsigned decode_r16w(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg,off);
...
static unsigned decode_ald8(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"al,%02X",get_d8(seg, &off));
    return off;
}

static unsigned decode_axd16(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"ax,%04X",get_d16(seg, &off));
    return off;
}

static unsigned decode_pushpopseg(unsigned seg, unsigned off, char *buf)
{
    strcpy(buf, get_seg_reg(instruction_byte));
    return off;
}

static unsigned decode_databyte(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"%02X", instruction_byte);
    return off;
}

static unsigned decode_wordreg(unsigned seg, unsigned off, char *buf)
{
...
static unsigned decode_cond_jump(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"%-5s %04X", condition[instruction_byte & 0xf], get_disp(seg, &off));
    return off;
}

static unsigned decode_bd8(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_wd16(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_wd8(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
    char *mem = get_mem(ModRM, seg, &off, word_reg, wordp);
    sprintf(buf,"%s,%02X", mem, get_d8(seg, &off));
...
static unsigned decode_ws(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_sw(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_w(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_b(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_xchgax(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf, "ax,%s", word_reg[instruction_byte & 0x7]);
    return off;
}

static unsigned decode_far(unsigned seg, unsigned off, char *buf)
{
...
static unsigned decode_almem(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"al,[%04X]", get_d16(seg, &off));
    return off;
}

static unsigned decode_axmem(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"ax,[%04X]", get_d16(seg, &off));
    return off;
}

static unsigned decode_memal(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"[%04X],al", get_d16(seg, &off));
    return off;
}

static unsigned decode_memax(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"[%04X],ax", get_d16(seg, &off));
    return off;
}

static unsigned decode_string(unsigned seg, unsigned off, char *buf)
{
...
static unsigned decode_rd(unsigned seg, unsigned off, char *buf)
{
...
static unsigned decode_d16(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"%04X", get_d16(seg, &off));
    return off;
}

static unsigned decode_int3(unsigned seg, unsigned off, char *buf)
{
    strcpy(buf, "3");
    return off;
}

static unsigned decode_d8(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"%02X", get_d8(seg, &off));
    return off;
}

static unsigned decode_bbit1(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_wbit1(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_bbitcl(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_wbitcl(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_disp(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf,"%04X", get_disp(seg, &off));
    return off;
}

static unsigned decode_escape(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM  = GetMemInc(seg, off);
...
static unsigned decode_adjust(unsigned seg, unsigned off, char *buf)
{
    unsigned num = GetMemInc(seg, off);
...
static unsigned decode_d8al(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf, "%02X,al", get_d8(seg, &off));
    return off;
}

static unsigned decode_d8ax(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf, "%02X,ax", get_d8(seg, &off));
    return off;
}

static unsigned decode_axd8(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf, "ax,%02X", get_d8(seg, &off));
    return off;
}

static unsigned decode_far_ind(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemInc(seg, off);
...
static unsigned decode_portdx(unsigned seg, unsigned off, char *buf)
{
...
static unsigned decode_disp16(unsigned seg, unsigned off, char *buf)
{
    sprintf(buf, "%04X", get_disp16(seg, &off));
    return off;
}

static unsigned decode_f6(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemB(seg, off);
    if ((ModRM & 0x38) == 0x00)
...
static unsigned decode_f7(unsigned seg, unsigned off, char *buf)
{
    unsigned ModRM = GetMemB(seg, off);
    if ((ModRM & 0x38) == 0x00)
...
static unsigned decode_ff(unsigned seg, unsigned off, char *buf)
{
...
static unsigned decode_bioscall(unsigned seg, unsigned off, char *buf)
{
    unsigned addr;
...
unsigned disasm(unsigned seg, unsigned off, char *buffer)
{
    struct Disasm *d;

    instruction_byte = GetMemInc(seg, off);
    d = &disasm_table[instruction_byte];

    if (d->supp != NULL)
        print_instruction(seg, off, d->supp, buffer);
    else
        sprintf(buffer, (d->flags & DF_NOSPACE) ? "%s" : "%-6s ",
                itext[d->text]);

    if (d->type != NULL)
        off = (d->type)(seg, off, &buffer[strlen(buffer)]);

    return off;
}

unsigned I86Dasm (unsigned seg, unsigned off, char *buffer)
{
    char buffer1[80];
    char buffer2[80];
    char buffer3[3];
    ...
    for (; !debug_abort && count > 0; count--)
    {
        do
        {
            sprintf(buffer, "%04X:%04X ", seg, off);
            buffer1[0] = '\0';
            newoff = disasm(seg, off, buffer1);
            buffer2[0] = '\0';
            for (; off < newoff; off++)
            {
                sprintf(buffer3,"%02X", GetMemB(seg, off));
                strcat(buffer2,buffer3);
            }
            sprintf(buffer3, "%-14s%s", buffer2,buffer1);
