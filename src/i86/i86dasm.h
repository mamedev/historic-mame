...
static unsigned decode_br8(unsigned, unsigned, char *);
static unsigned decode_r8b(unsigned, unsigned, char *);
static unsigned decode_wr16(unsigned, unsigned, char *);
static unsigned decode_r16w(unsigned, unsigned, char *);
static unsigned decode_ald8(unsigned, unsigned, char *);
static unsigned decode_axd16(unsigned, unsigned, char *);
static unsigned decode_pushpopseg(unsigned, unsigned, char *);
static unsigned decode_databyte(unsigned, unsigned, char *);
static unsigned decode_wordreg(unsigned, unsigned, char *);
static unsigned decode_cond_jump(unsigned, unsigned, char *);
static unsigned decode_bd8(unsigned, unsigned, char *);
static unsigned decode_wd16(unsigned, unsigned, char *);
static unsigned decode_wd8(unsigned, unsigned, char *);
static unsigned decode_ws(unsigned, unsigned, char *);
static unsigned decode_sw(unsigned, unsigned, char *);
static unsigned decode_w(unsigned, unsigned, char *);
static unsigned decode_string(unsigned, unsigned, char *);
static unsigned decode_xchgax(unsigned, unsigned, char *);
static unsigned decode_far(unsigned, unsigned, char *);
static unsigned decode_almem(unsigned, unsigned, char *);
static unsigned decode_axmem(unsigned, unsigned, char *);
static unsigned decode_memal(unsigned, unsigned, char *);
static unsigned decode_memax(unsigned, unsigned, char *);
static unsigned decode_rd(unsigned, unsigned, char *);
static unsigned decode_d16(unsigned, unsigned, char *);
static unsigned decode_int3(unsigned, unsigned, char *);
static unsigned decode_d8(unsigned, unsigned, char *);
static unsigned decode_bbit1(unsigned, unsigned, char *);
static unsigned decode_wbit1(unsigned, unsigned, char *);
static unsigned decode_bbitcl(unsigned, unsigned, char *);
static unsigned decode_wbitcl(unsigned, unsigned, char *);
static unsigned decode_escape(unsigned, unsigned, char *);
static unsigned decode_disp(unsigned, unsigned, char *);
static unsigned decode_adjust(unsigned, unsigned, char *);
static unsigned decode_d8al(unsigned, unsigned, char *);
static unsigned decode_d8ax(unsigned, unsigned, char *);
static unsigned decode_axd8(unsigned, unsigned, char *);
static unsigned decode_disp16(unsigned, unsigned, char *);
static unsigned decode_far_ind(unsigned, unsigned, char *);
static unsigned decode_portdx(unsigned, unsigned, char *);
static unsigned decode_f6(unsigned, unsigned, char *);
static unsigned decode_f7(unsigned, unsigned, char *);
static unsigned decode_b(unsigned, unsigned, char *);
static unsigned decode_ff(unsigned, unsigned, char *);
static unsigned decode_bioscall(unsigned, unsigned, char *);
...
{ 
    ...
    "div", "idiv", "clc", "stc", "cli", "sti", "cld", "std", "db", "???"
};
...
{
    int text;
    unsigned (*type)(unsigned, unsigned, char *);
    int flags;
    int *supp;
} disasm_table[256] =
{
