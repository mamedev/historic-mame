...
struct conversion_t {
	...
	{ 2, { "mame", "game", "sourcefile", 0, 0 }, process_item2 },
	...
	{ 3, { "mame", "game", "disk", "merge", 0 }, process_item3 },
	...
	{ 3, { "mame", "game", "disk", "status", 0 }, process_romstatus },
	...
	{ 3, { "mame", "game", "driver", "emulation", 0 }, process_item3 },
