...
{
	galpani2_bg15_bitmap  = auto_bitmap_alloc_format(256*8, 256, BITMAP_FORMAT_INDEXED16);
	galpani2_bg8_bitmap_0 = auto_bitmap_alloc_format(512, 256, BITMAP_FORMAT_INDEXED16);
	galpani2_bg8_bitmap_1 = auto_bitmap_alloc_format(512, 256, BITMAP_FORMAT_INDEXED16);
