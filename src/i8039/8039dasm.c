...
char *Formats[] = {
    ...
    FMT("11101rrraaaaaaaa", "djnz %R,%A"),
    FMT("00000101", "en  i"),
    FMT("00100101", "en  tcnti"),
    FMT("01110101", "ent0 clk"),
    FMT("00001001", "in  a,P0"),
    FMT("00001010", "in  a,P1"),
    FMT("00010111", "inc a"),
    FMT("00011rrr", "inc %R"),
    FMT("0001000r", "inc @%R"),
    FMT("00001000", "ins a,bus"),
    FMT("0001 0110aaaaaaaa", "jtf %A"),
    FMT("0010 0110aaaaaaaa", "jnt0 %A"),
    FMT("0011 0110aaaaaaaa", "jt0 %A"),
    FMT("0100 0110aaaaaaaa", "jnt1 %A"),
    FMT("0101 0110aaaaaaaa", "jt1 %A"),
    FMT("0111 0110aaaaaaaa", "jf1 %A"),
    FMT("1000 0110aaaaaaaa", "jni %A"),
    FMT("1001 0110aaaaaaaa", "jnz %A"),
    FMT("1011 0110aaaaaaaa", "jf0 %A"),
    FMT("1100 0110aaaaaaaa", "jz  %A"),
    FMT("1110 0110aaaaaaaa", "jnc %A"),
    FMT("1111 0110aaaaaaaa", "jc  %A"),
