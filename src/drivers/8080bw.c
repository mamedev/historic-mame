...
INPUT_PORTS_START( desertgu )
    ...
    PORT_DIPSETTING(    0x0c, "Scandinavian" )
...
/* 852 */ GAME( 1980, invdpt2m, invadpt2, invaders, invdpt2m, invdpt2m, ROT270, "Midway", "Space Invaders Part II (Midway)" )
/* 870    																		"Midway", "Space Invaders Deluxe (cocktail) "*/
		  ...
		  GAME( ????, alieninv, invaders, invaders, alieninv, invaders, ROT270, "bootleg", "Alien Invasion Part II" )
		  ...
		  GAME( 1980, astlaser, 0,        invaders, astlaser, invdpt2m, ROT270, "<unknown>", "Astro Laser" )
		  GAME( 1980, intruder, astlaser, invaders, intruder, invdpt2m, ROT270, "Game Plan, Inc. (Taito)", "Intruder" )
		  GAME( 1979, spcewarl, astlaser, invaders, astlaser, invdpt2m, ROT270, "Leijac (Konami)","Space War (Leijac)" )
		  ...
		  GAME( 1979, desterth, lrescue,  invaders, desterth, invaders, ROT270, "bootleg", "Destination Earth" )
		  ...
		  GAME( 1979, solfight, ozmawars, invaders, solfight, 8080bw,   ROT270, "bootleg", "Solar Fight" )
