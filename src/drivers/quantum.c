...
ROM_START( quantum1_rom )
	ROM_REGION(0x014000)
    ROM_LOAD_EVEN( "136016.101", 0x000000, 0x002000, 0x6d6c10aa , 0x5af0bd5b )
    ROM_LOAD_ODD ( "136016.106", 0x000000, 0x002000, 0xf8098bbd , 0xf9724666 )
    ROM_LOAD_EVEN( "136016.102", 0x004000, 0x002000, 0xe248a2b4 , 0x408d34f4 )
    ROM_LOAD_ODD ( "136016.107", 0x004000, 0x002000, 0x08a8ebee , 0x63154484 )
    ROM_LOAD_EVEN( "136016.103", 0x008000, 0x002000, 0x8f3b4f1f , 0x948f228b )
    ROM_LOAD_ODD ( "136016.108", 0x008000, 0x002000, 0x16aa75d6 , 0xe4c48e4e )
    ROM_LOAD_EVEN( "136016.104", 0x00C000, 0x002000, 0xbd97cfe7 , 0xbf271e5c )
    ROM_LOAD_ODD ( "136016.109", 0x00C000, 0x002000, 0x35fe3930 , 0xd2894424 )
    ROM_LOAD_EVEN( "136016.105", 0x010000, 0x002000, 0xf574385a , 0x13ec512c )
    ROM_LOAD_ODD ( "136016.110", 0x010000, 0x002000, 0x943b9d71 , 0xacb50363 )
ROM_END

ROM_START( quantum_rom )
	ROM_REGION(0x014000)
    ROM_LOAD_EVEN( "136016.201", 0x000000, 0x002000, 0x8cfa0e3a , 0x7e7be63a )
    ROM_LOAD_ODD ( "136016.206", 0x000000, 0x002000, 0x75bd063d , 0x2d8f5759 )
    ROM_LOAD_EVEN( "136016.102", 0x004000, 0x002000, 0xe248a2b4 , 0x408d34f4 )
    ROM_LOAD_ODD ( "136016.107", 0x004000, 0x002000, 0x08a8ebee , 0x63154484 )
    ROM_LOAD_EVEN( "136016.203", 0x008000, 0x002000, 0x87164704 , 0xbdc52fad )
    ROM_LOAD_ODD ( "136016.208", 0x008000, 0x002000, 0xa6e3e47d , 0xdab4066b )
    ROM_LOAD_EVEN( "136016.104", 0x00C000, 0x002000, 0xbd97cfe7 , 0xbf271e5c )
    ROM_LOAD_ODD ( "136016.109", 0x00C000, 0x002000, 0x35fe3930 , 0xd2894424 )
    ROM_LOAD_EVEN( "136016.105", 0x010000, 0x002000, 0xf574385a , 0x13ec512c )
    ROM_LOAD_ODD ( "136016.110", 0x010000, 0x002000, 0x943b9d71 , 0xacb50363 )
