...
INPUT_PORTS_START( chinhero )
	...
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN3 ) /* service */
	...
	PORT_START
	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_PLAYER2 | IPF_4WAY )
	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 | IPF_4WAY )
...
INPUT_PORTS_START( shangkid )
	...
	**	RV2 - Sound Effects
	*/
	PORT_DIPNAME( 0x01, 0x00, "Freeplay" )
	PORT_DIPSETTING(	0x00, DEF_STR( Off ) )
