...
static MACHINE_DRIVER_START( starwars )
	...
	MDRV_WATCHDOG_TIME_INIT(TIME_IN_HZ(CLOCK_3KHZ / 128))
...
ROM_START( starwar1 )
	...
	/* Mathbox PROMs */
	ROM_REGION( 0x1100, REGION_PROMS, 0)
	...
	ROM_LOAD( "136021-105.1l",   0x1000, 0x0100, CRC(82fc3eb2) SHA1(184231c7baef598294860a7d2b8a23798c5c7da6) ) /* AVG PROM */
ROM_END
