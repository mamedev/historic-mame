...
INPUT_PORTS_START( loderndf )
	...
	PORT_BIT(  0x40, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(1) PORT_NAME("P1 Button 3 / Retry")// Can be used as Retry button
	...
	PORT_BIT(  0x40, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(2) PORT_NAME("P1 Button 3 / Retry")// Can be used as Retry button
