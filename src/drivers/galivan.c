...
{
	{ 1, 0x00000, &charlayout_512,            0,   8 },
	{ 1, 0x04000, &tilelayout,             8*16,  16 },
	{ 1, 0x24000, &spritelayout_512, 8*16+16*16, 256 },
	{ -1 } /* end of array */
};

static struct GfxDecodeInfo ninjemak_gfxdecodeinfo[] =
{
	{ 1, 0x00000, &charlayout_1024,            0,   8 },
	{ 1, 0x08000, &tilelayout,              8*16,  16 },
	{ 1, 0x28000, &spritelayout_1024, 8*16+16*16, 256 },
	{ -1 } /* end of array */
};
...
ROM_START( galivan )
	...
	ROM_LOAD( "gv7.14f",      0x04000, 0x8000, 0xeaa1a0db ) /* tiles */
	ROM_LOAD( "gv8.15f",      0x0c000, 0x8000, 0xf174a41e )
	ROM_LOAD( "gv9.17f",      0x14000, 0x8000, 0xedc60f5d )
	ROM_LOAD( "gv10.19f",     0x1c000, 0x8000, 0x41f27fca )
	ROM_LOAD( "gv14.4f",      0x24000, 0x8000, 0x03e2229f ) /* sprites */
	ROM_LOAD( "gv13.1f",      0x2c000, 0x8000, 0xbca9e66b )
...
ROM_START( ninjemak )
	...
	ROM_REGION_DISPOSE(0x4c000)	/* Region 1 - temporary for gfx roms */
	ROM_LOAD( "ninjemak.4",   0x00000, 0x8000, 0x83702c37 )	/* chars */
	ROM_LOAD( "ninjemak.8",   0x08000, 0x8000, 0x655f0a58 ) /* tiles */
	ROM_LOAD( "ninjemak.9",   0x10000, 0x8000, 0x934e1703 )
	ROM_LOAD( "ninjemak.10",  0x18000, 0x8000, 0x955b5c45 )
	ROM_LOAD( "ninjemak.11",  0x20000, 0x8000, 0xbbd2e51c )
	ROM_LOAD( "ninjemak.16",  0x28000, 0x8000, 0x8df93fed )  /* sprites */
	ROM_LOAD( "ninjemak.17",  0x30000, 0x8000, 0xa3efd0fc )
	ROM_LOAD( "ninjemak.14",  0x38000, 0x8000, 0xbff332d3 )
	ROM_LOAD( "ninjemak.15",  0x40000, 0x8000, 0x56430ed4 )

	ROM_REGION( 0x08000 )			/* Region 2 - bg scroll data */
...
struct GameDriver driver_youma =
{
	__FILE__,
	&driver_ninjemak,
	"youma",
