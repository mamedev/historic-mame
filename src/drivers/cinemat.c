...
INPUT_PORTS_START ( spacewar_input_ports )
	...
	PORT_BITX( 0x08, IP_ACTIVE_LOW,  0, "Option 0", OSD_KEY_0_PAD, IP_JOY_NONE )
	PORT_BITX( 0x04, IP_ACTIVE_LOW,  0, "Option 5", OSD_KEY_5_PAD, IP_JOY_NONE )
	PORT_BIT ( 0x02, IP_ACTIVE_LOW,  IPT_BUTTON2 | IPF_PLAYER2 )
	PORT_BIT ( 0x01, IP_ACTIVE_LOW,  IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER1 )

	PORT_START /* inputs low */
	PORT_BITX( 0x80, IP_ACTIVE_LOW,  0, "Option 7", OSD_KEY_7_PAD, IP_JOY_NONE )
	PORT_BITX( 0x40, IP_ACTIVE_LOW,  0, "Option 2", OSD_KEY_2_PAD, IP_JOY_NONE )
	PORT_BITX( 0x20, IP_ACTIVE_LOW,  0, "Option 6", OSD_KEY_6_PAD, IP_JOY_NONE )
	PORT_BITX( 0x10, IP_ACTIVE_LOW,  0, "Option 1", OSD_KEY_1_PAD, IP_JOY_NONE )
	PORT_BITX( 0x08, IP_ACTIVE_LOW,  0, "Option 9", OSD_KEY_9_PAD, IP_JOY_NONE )
	PORT_BITX( 0x04, IP_ACTIVE_LOW,  0, "Option 4", OSD_KEY_4_PAD, IP_JOY_NONE )
	PORT_BITX( 0x02, IP_ACTIVE_LOW,  0, "Option 8", OSD_KEY_8_PAD, IP_JOY_NONE )
	PORT_BITX( 0x01, IP_ACTIVE_LOW,  0, "Option 3", OSD_KEY_3_PAD, IP_JOY_NONE )
...
INPUT_PORTS_START ( barrier_input_ports )
	...
	PORT_BITX( 0x40, IP_ACTIVE_LOW,  0, "Skill C", OSD_KEY_C, IP_JOY_NONE )
	PORT_BIT ( 0x20, IP_ACTIVE_LOW,  IPT_UNUSED )
	PORT_BIT ( 0x10, IP_ACTIVE_LOW,  IPT_START2 )
	PORT_BIT ( 0x08, IP_ACTIVE_LOW,  IPT_JOYSTICK_DOWN | IPF_4WAY | IPF_PLAYER1 )
	PORT_BITX( 0x04, IP_ACTIVE_LOW,  0, "Skill B", OSD_KEY_B, IP_JOY_NONE )
	PORT_BIT ( 0x02, IP_ACTIVE_LOW,  IPT_UNUSED )
	PORT_BITX( 0x01, IP_ACTIVE_LOW,  0, "Skill A", OSD_KEY_A, IP_JOY_NONE )
