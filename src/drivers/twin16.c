...
GX903	Cuebrick
GX870	Final Round / Hard Puncher
...
Known Issues:
	...
	Devil's World:
	- bad priority (open chest)
	- missing foreground tiles on later stages (cpu synchronization issue?)
...
extern void fround_screenrefresh( struct osd_bitmap *bitmap, int fullrefresh );
extern void twin16_vh_screenrefresh( struct osd_bitmap *bitmap, int fullrefresh );

extern void cuebrick_decode( void );
extern void fround_decode( void );
extern void gradius2_decode( void );
extern void devilw_twin16_decode( void );
...
#define FIXRAM_r					MRA_BANK3, &twin16_fixram
#define FIXRAM_w					MWA_BANK3

#define COMRAM_r					MRA_BANK4
#define COMRAM_w					MWA_BANK4

#define twin16_sprite_gfx_ram_w		MWA_BANK5
#define twin16_sprite_gfx_ram_r		MRA_BANK5, &twin16_sprite_gfx_ram

#define twin16_tile_gfx_ram_w		MWA_BANK6
#define twin16_tile_gfx_ram_r		MRA_BANK7, &twin16_tile_gfx_ram
...
static void twin16_paletteram_w(int offset,int data){ // identical to tmnt_paletteram_w
...
static struct MemoryReadAddress readmem[] = {
	...
	{ 0x0b0000, 0x0b3fff, battery_backed_ram_r, &battery_backed_ram }, /* cuebrick only */
	{ 0x0c000e, 0x0c000f, twin16_sprite_status_r },
	{ 0x100000, 0x103fff, FIXRAM_r },
	{ 0x120000, 0x123fff, VIDRAM_r, &videoram },
	{ 0x140000, 0x143fff, OBJRAM_r, &spriteram },
	{ -1 }
};
...
static struct MemoryWriteAddress writemem[] = {
	...
	{ 0x120000, 0x123fff, VIDRAM_w },
	{ 0x140000, 0x143fff, OBJRAM_w },
	{ -1 }
};
...
struct GameDriver grdius2a_driver =  {
	__FILE__,
	&vulcan_driver,
	"grdius2a",
...
struct GameDriver grdius2b_driver =  {
	__FILE__,
	&vulcan_driver,
	"grdius2b",
...
struct GameDriver hpuncher_driver =  {
	__FILE__,
	0,
	"hpuncher",
	"Hard Puncher (Japan)",
