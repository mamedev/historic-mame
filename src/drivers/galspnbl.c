...
Note: the sprite graphics contain a "(c) Tecmo", and the sprite system is
...
- does the game support 2 players? I didn't find a start button.
...
static struct MemoryReadAddress readmem[] =
{
	...
	{ 0x700000, 0x703fff, MRA_BANK1 },
	{ 0x708000, 0x70ffff, MRA_BANK2 },
	{ 0x880000, 0x880fff, MRA_BANK3 },
	{ 0x900000, 0x900fff, MRA_BANK4 },
	{ 0x904000, 0x904fff, MRA_BANK5 },
...
static struct MemoryWriteAddress writemem[] =
{
	...
	{ 0x700000, 0x703fff, MWA_BANK1 },	/* work RAM */
	{ 0x708000, 0x70ffff, MWA_BANK2 },	/* work RAM, bitmaps are decompressed here */
	{ 0x880000, 0x880fff, MWA_BANK3, &spriteram, &spriteram_size },
{ 0x8ff400, 0x8fffff, MWA_NOP },	/* ??? */
	{ 0x900000, 0x900fff, MWA_BANK4, &colorram },
{ 0x901000, 0x903fff, MWA_NOP },	/* ??? */
	{ 0x904000, 0x904fff, MWA_BANK5, &videoram },
...
{ 0xa01800, 0xa027ff, MWA_NOP },	/* more palette ? */
	...
	{ 0xa80020, 0xa80021, watchdog_reset_w },	/* ? */
...
static struct MachineDriver machine_driver_galspnbl =
{
...
ROM_START( galspnbl )
	...
	ROM_LOAD( "18.rom",       0x40000, 0x40000, BADCRC(0xe8f7d889) )	// BAD ADDRESS LINES (mask=000010)
...
GAMEX( 1996, galspnbl, 0, galspnbl, galspnbl, 0, ROT90_16BIT, "Comad", "Gals Pinball", GAME_NO_COCKTAIL )
