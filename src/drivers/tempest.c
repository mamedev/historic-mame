...
ROM_START( tempest_rom ) /* rev 3 */
	...
	ROM_LOAD( "136002.113", 0x9000, 0x0800, 0xc4180c0e , 0x65d61fe7 )
	ROM_LOAD( "136002.114", 0x9800, 0x0800, 0x3bf4999a , 0x11077375 )
	ROM_LOAD( "136002.115", 0xa000, 0x0800, 0x22bb1713 , 0xf3e2827a )
	ROM_LOAD( "136002.316", 0xa800, 0x0800, 0xee8c0306 , 0xaeb0f7e9 )
	ROM_LOAD( "136002.217", 0xb000, 0x0800, 0x85768680 , 0xef2eb645 )
	ROM_LOAD( "136002.118", 0xb800, 0x0800, 0x461ca3a4 , 0xbeb352ab )
	ROM_LOAD( "136002.119", 0xc000, 0x0800, 0x02e4a6ae , 0xa4de050f )
	ROM_LOAD( "136002.120", 0xc800, 0x0800, 0x82d1e4ed , 0x35619648 )
	ROM_LOAD( "136002.121", 0xd000, 0x0800, 0xe663151f , 0x73d38e47 )
	ROM_LOAD( "136002.222", 0xd800, 0x0800, 0xb5c39e95 , 0x707bd5c3 )
	ROM_RELOAD(             0xf800, 0x0800 ) /* for reset/interrupt vectors */
	/* Mathbox ROMs */
	ROM_LOAD( "136002.123", 0x3000, 0x0800, 0xca906060 , 0x29f7e937 )
	ROM_LOAD( "136002.124", 0x3800, 0x0800, 0xb6c4f9f8 , 0xc16ec351 )
ROM_END
...
ROM_START( tempest1_rom ) /* rev 1 */
	...
	ROM_LOAD( "136002.114", 0x9800, 0x0800, 0x3bf4999a , 0x11077375 )
	ROM_LOAD( "136002.115", 0xa000, 0x0800, 0x22bb1713 , 0xf3e2827a )
	ROM_LOAD( "136002.116", 0xa800, 0x0800, 0xee2a0306 , 0x7356896c )
	ROM_LOAD( "136002.117", 0xb000, 0x0800, 0x85788680 , 0x55952119 )
	ROM_LOAD( "136002.118", 0xb800, 0x0800, 0x461ca3a4 , 0xbeb352ab )
	ROM_LOAD( "136002.119", 0xc000, 0x0800, 0x02e4a6ae , 0xa4de050f )
	ROM_LOAD( "136002.120", 0xc800, 0x0800, 0x82d1e4ed , 0x35619648 )
	ROM_LOAD( "136002.121", 0xd000, 0x0800, 0xe663151f , 0x73d38e47 )
	ROM_LOAD( "136002.122", 0xd800, 0x0800, 0x292ebfb4 , 0x796a9918 )
	ROM_RELOAD(             0xf800, 0x0800 ) /* for reset/interrupt vectors */
	/* Mathbox ROMs */
	ROM_LOAD( "136002.123", 0x3000, 0x0800, 0xca906060 , 0x29f7e937 )
	ROM_LOAD( "136002.124", 0x3800, 0x0800, 0xb6c4f9f8 , 0xc16ec351 )
...
ROM_START( temptube_rom )
	...
	ROM_LOAD( "136002.316", 0xa800, 0x0800, 0xee8c0306 , 0xaeb0f7e9 )
	ROM_LOAD( "136002.217", 0xb000, 0x0800, 0x85768680 , 0xef2eb645 )
	ROM_LOAD( "tube.118", 0xb800, 0x0800, 0xf4ecc108 , 0xcefb03f0 )
	ROM_LOAD( "136002.119", 0xc000, 0x0800, 0x02e4a6ae , 0xa4de050f )
	ROM_LOAD( "136002.120", 0xc800, 0x0800, 0x82d1e4ed , 0x35619648 )
	ROM_LOAD( "136002.121", 0xd000, 0x0800, 0xe663151f , 0x73d38e47 )
	ROM_LOAD( "136002.222", 0xd800, 0x0800, 0xb5c39e95 , 0x707bd5c3 )
...
ROM_START( tempest3_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "tempest.x", 0x9000, 0x1000, -1 , 0x0 )
	ROM_LOAD( "tempest.1", 0xa000, 0x1000, -1 , 0x0 )
	ROM_LOAD( "tempest.3", 0xb000, 0x1000, -1 , 0x0 )
	ROM_LOAD( "tempest.5", 0xc000, 0x1000, -1 , 0x0 )
	ROM_LOAD( "tempest.7", 0xd000, 0x1000, -1 , 0x0 )
	ROM_RELOAD(            0xf000, 0x1000 )	/* for reset/interrupt vectors */
	/* Mathbox ROMs */
	ROM_LOAD( "tempest.np3", 0x3000, 0x1000, -1 , 0x0 )
ROM_END
#endif
