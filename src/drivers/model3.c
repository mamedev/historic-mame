...
ROM_START( fvipers2 )	/* Step 2.0 */
	...
	ROM_REGION( 0x1000000, REGION_SOUND1, 0 )	/* SCSP samples */
        ...
        ROM_LOAD( "mpr-20577",  0x400000, 0x400000, CRC(3b236187) SHA1(0ba1513e0652f6686b306a4f600a565570b1ebcc) ) /* IC23 ?? */
        ROM_LOAD( "mpr-20578",  0x800000, 0x400000, CRC(d222f2d4) SHA1(f6128f8267e91242d7fc3d85beb2cd35124dd018) ) /* IC24 ?? */
...
ROM_START( spikeout )	/* Step 2.1 */
	...
	ROM_REGION( 0x1000000, REGION_SOUND1, 0 )	/* SCSP samples */
        ...
        ROM_LOAD( "mpr21151.23",  0x400000, 0x400000, CRC(599527b9) SHA1(bc124f916a72c85a1f2a10ababc4254adc951697) )
        ROM_LOAD( "mpr21152.24",  0x800000, 0x400000, CRC(0afdee87) SHA1(2be20991a6d8fbee51dddc2dd0fbae7e43e5b3df) )
...
ROM_START( spikeofe )	/* Step 2.1 */
	...
	ROM_REGION( 0x1000000, REGION_SOUND1, 0 )	/* SCSP samples */
        ...
        ROM_LOAD( "mpr21631.23",  0x400000, 0x400000, CRC(299036c5) SHA1(861f5d6579ee0fba1793140468194c2ef0fd0b7f) )
        ROM_LOAD( "mpr21630.24",  0x800000, 0x400000, CRC(9f2deadd) SHA1(964dea6c8f5e34c5682cd7ca207a853aab80306e) )
...
ROM_START( eca )	/* Step 2.1 */
	...
	ROM_REGION( 0x1000000, REGION_SOUND1, 0 )	/* SCSP samples */
        ...
        ROM_LOAD( "mpr22888.23",  0x400000, 0x400000, CRC(018fcf22) SHA1(c5133358f591d699f177617463e7dfa22edf5369) )
        ROM_LOAD( "mpr22889.24",  0x800000, 0x400000, CRC(4f9ba45d) SHA1(d60314e852637edf6510be52b9b6576a1f3e1b7e) )
