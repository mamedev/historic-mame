...
INPUT_PORTS_START( ikarius_input_ports )
	...
	PORT_DIPNAME( 0x01, 0x01, "Special bit" )
	...
	PORT_DIPNAME( 0x30, 0x30, "Coin A" )
	PORT_DIPSETTING(    0x00, "4 Coins/1 Credit" )
	PORT_DIPSETTING(    0x10, "3 Coins/1 Credit" )
	PORT_DIPSETTING(    0x20, "2 Coins/1 Credit" )
	PORT_DIPSETTING(    0x30, "1 Coin /1 Credit" )
	PORT_DIPNAME( 0xc0, 0xc0, "Coin B" )
...
INPUT_PORTS_START( gwar_input_ports )
	...
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x08, 0x08, "Monitor" )
...
INPUT_PORTS_START( athena_input_ports )
	...
	PORT_START	/* DSW1 */
	PORT_DIPNAME( 0x01, 0x01, "Continue" ) /* unconfirmed */
	PORT_DIPSETTING(    0x01, "Coin Up" )
	PORT_DIPSETTING(    0x00, "Standard" )
	PORT_DIPNAME( 0x02, 0x02, "Screen Flip" ) /* unconfirmed */
	...
	PORT_START /* DSW2 */
	PORT_DIPNAME( 0x03, 0x03, "Difficulty" ) /* unconfirmed */
	PORT_DIPSETTING(    0x03, "Easy" )
	PORT_DIPSETTING(    0x02, "Normal" )
	PORT_DIPSETTING(    0x01, "Hard" )
	PORT_DIPSETTING(    0x00, "Hardest" )
	PORT_DIPNAME( 0x04, 0x04, "Demo Sound" ) /* unconfirmed */
	PORT_DIPSETTING(    0x04, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x08, 0x08, "Freeze Screen" )
	PORT_DIPSETTING(    0x08, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x30, 0x30, "Bonus" ) /* unconfirmed */
	PORT_DIPSETTING(    0x30, "50K / 100K" )
	PORT_DIPSETTING(    0x20, "60K / 120K" )
	PORT_DIPSETTING(    0x10, "100K / 200K" )
	PORT_DIPSETTING(    0x00, "None" )
	PORT_DIPNAME( 0x40, 0x40, "Unknown DSW2 1" )
	PORT_DIPSETTING(    0x40, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x80, 0x80, "Unknown DSW2 2" )
	PORT_DIPSETTING(    0x80, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
INPUT_PORTS_END
...
INPUT_PORTS_START( psychos_input_ports )
	...
	PORT_START  /* DIPSW 1 */
	PORT_DIPNAME( 0x01, 0x01, "Test Mode" )   /* Test Mode */
	PORT_DIPSETTING(    0x01, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x02, 0x02, "Video Flip" )
	...
	PORT_DIPSETTING(    0x20, "2 Coins/1 Credit" )
	PORT_DIPSETTING(    0x30, "1 Coin/1 Credit" )
	PORT_DIPNAME( 0xC0, 0xC0, "Unknown" )
