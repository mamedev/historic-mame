...
ROM_START( diverboy )
	...
	ROM_LOAD16_BYTE( "db_01.bin", 0x00000, 0x20000, 0x6aa11366 )
	ROM_LOAD16_BYTE( "db_02.bin", 0x00001, 0x20000, 0x45f8a673 )

	ROM_REGION( 0x10000, REGION_CPU2, 0 ) /* z80 */
	ROM_LOAD( "db_05.bin", 0x00000, 0x8000, 0xffeb49ec ) /* this part is empty */
	ROM_CONTINUE( 0x0000, 0x8000 ) /* this part contains the code */

	ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE ) /* GFX */
	ROM_LOAD16_BYTE( "db_08.bin", 0x000000, 0x80000, 0x7bb96220 )
	ROM_LOAD16_BYTE( "db_09.bin", 0x000001, 0x80000, 0x12b15476 )

	ROM_REGION( 0x180000, REGION_GFX2, ROMREGION_DISPOSE ) /* GFX */
	ROM_LOAD16_BYTE( "db_07.bin", 0x000000, 0x20000, 0x18485741 )
	ROM_LOAD16_BYTE( "db_10.bin", 0x000001, 0x20000, 0xc381d1cc )
	ROM_LOAD16_BYTE( "db_06.bin", 0x040000, 0x20000, 0x21b4e352 )
	ROM_LOAD16_BYTE( "db_11.bin", 0x040001, 0x20000, 0x41d29c81 )

	ROM_REGION( 0x80000, REGION_SOUND1, 0 ) /* Sound */
	ROM_LOAD( "db_03.bin", 0x00000, 0x80000, 0x50457505 )

	ROM_REGION( 0x20000, REGION_SOUND2, 0 ) /* Sound */
	ROM_LOAD( "db_04.bin", 0x00000, 0x20000, 0x01b81da0 ) /* same as tumble pop?, is this used? */
ROM_END
