...
{
	/* palette */
	BLACK,ORANGE,PINK,WHITE,	/* left part of ship */
	BLACK,RED,BLUE,YELLOW,	/* mystery on intro screen */
	BLACK,RED,BLUE,YELLOW,
	BLACK,BLUE,PURPLE,PINK,
	BLACK,PINK,GREEN,RED,	/* fuel on intro screen */
	BLACK,GREEN,PINK,YELLOW,	/* final enemy on intro screen */
	BLACK,WHITE,RED,CYAN,	/* right part of ship */
	BLACK,YELLOW,RED,PURPLE	/* level indicator */
};
