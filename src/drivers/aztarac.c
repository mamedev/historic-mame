...
INPUT_PORTS_START( aztarac_input_ports )
    ...
    PORT_START /* IN1 */
    PORT_ANALOG( 0x1f, 0xf, IPT_AD_STICK_Y | IPF_CENTER | IPF_REVERSE, 100, 1, 0, 0, 0x1e )
    ...
    PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( Service_Mode ), KEYCODE_F1, IP_JOY_NONE )
