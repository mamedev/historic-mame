...
ROM_START( irobot_rom )
    ...
    ROM_LOAD( "136029.208", 0x6000, 0x2000, 0x5293ebc3 , 0xb4d0be59 )
    ROM_LOAD( "136029.209", 0x8000, 0x4000, 0xf17caf78 , 0xf6be3cd0 )
    ROM_LOAD( "136029.210", 0xC000, 0x4000, 0xc65e3444 , 0xc0eb2133 )
    ROM_LOAD( "136029.405", 0x10000, 0x4000, 0x3323d65b , 0x9163efe4 )
    ROM_LOAD( "136029.206", 0x14000, 0x4000, 0xc61dc3f3 , 0xe114a526 )
    ROM_LOAD( "136029.207", 0x18000, 0x4000, 0x0000203a , 0xb4556cb0 )

    ROM_REGION_DISPOSE(0x800)  /* temporary space for graphics (disposed after conversion) */
    ROM_LOAD( "136029.124", 0x0000, 0x800, 0x45a74435 , 0x848948b6 )

    ROM_REGION(0x10000)  /* temoporary space for mathbox roms */
    ROM_LOAD( "ir103.bin", 0x0000, 0x2000, 0x3c76511c , 0x0c83296d )
    ROM_LOAD( "ir104.bin", 0x2000, 0x2000, 0x6920da70 , 0x0a6cdcca )
    ROM_LOAD( "ir101.bin", 0x4000, 0x4000, 0xb832117e , 0x62a38c08 )
    ROM_LOAD( "ir102.bin", 0x8000, 0x4000, 0x1c241382 , 0x9d588f22 )
    ROM_LOAD( "ir111.bin", 0xC000, 0x400, 0x04c30d07 , 0x9fbc9bf3 )
    ROM_LOAD( "ir112.bin", 0xC400, 0x400, 0x1ee50209 , 0xb2713214 )
    ROM_LOAD( "ir113.bin", 0xC800, 0x400, 0x84a8060a , 0x7875930a )
    ROM_LOAD( "ir114.bin", 0xCC00, 0x400, 0x221c0c00 , 0x51d29666 )
    ROM_LOAD( "ir115.bin", 0xD000, 0x400, 0x4256040e , 0x00f9b304 )
    ROM_LOAD( "ir116.bin", 0xD400, 0x400, 0x03f70c0d , 0x326aba54 )
    ROM_LOAD( "ir117.bin", 0xD800, 0x400, 0x26000f04 , 0x98efe8d0 )
    ROM_LOAD( "ir118.bin", 0xDC00, 0x400, 0x269a0c06 , 0x4a6aa7f9 )
    ROM_LOAD( "ir119.bin", 0xE000, 0x400, 0x572b070f , 0xa5a13ad8 )
    ROM_LOAD( "ir120.bin", 0xE400, 0x400, 0x8b2a0a0a , 0x2a083465 )
    ROM_LOAD( "ir121.bin", 0xE800, 0x400, 0x6263030b , 0xadebcb99 )
    ROM_LOAD( "ir122.bin", 0xEC00, 0x400, 0x4802070c , 0xda7b6f79 )
    ROM_LOAD( "ir123.bin", 0xF000, 0x400, 0x4fc40008 , 0x39fff18f )
