...
ROM_START( xybots_rom )
	...
	ROM_LOAD_EVEN( "2112.c17", 0x00000, 0x10000, 0x72d5a685 )
	ROM_LOAD_ODD ( "2113.c19", 0x00000, 0x10000, 0x040ce26e )
	ROM_LOAD_EVEN( "2114.b17", 0x20000, 0x08000, 0xd5550ed7 )
	ROM_LOAD_ODD ( "2115.b19", 0x20000, 0x08000, 0x1129739f )

	ROM_REGION(0xc2000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "2102.l13", 0x00000, 0x08000, 0x19b162f5 )
	ROM_RELOAD(           0x08000, 0x08000 )
	ROM_LOAD( "2103.l11", 0x10000, 0x10000, 0x10474989 )
	ROM_LOAD( "2117.l7",  0x30000, 0x10000, 0x08510009 )
	ROM_LOAD( "1105.de1", 0x40000, 0x10000, 0x53870bb1 )
	ROM_LOAD( "1106.e1",  0x50000, 0x10000, 0xc416b8cc )
	ROM_LOAD( "1107.f1",  0x60000, 0x10000, 0x252ba05b )
	ROM_LOAD( "1108.fj1", 0x70000, 0x10000, 0xd149a8f5 )
	ROM_LOAD( "1109.j1",  0x80000, 0x10000, 0x3b0dbf55 )
	ROM_LOAD( "1110.k1",  0x90000, 0x10000, 0xa9f6fe6a )
	ROM_LOAD( "1111.kl1", 0xa0000, 0x10000, 0x8ea35fb3 )
	ROM_LOAD( "1101.c4",  0xc0000, 0x02000, 0xa012a648 )

	ROM_REGION(0x14000)	/* 64k for 6502 code */
	ROM_LOAD( "xybots.snd", 0x10000, 0x4000, 0x0178512e )
