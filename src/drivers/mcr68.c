...
ROM_START( xenophob_rom )
	ROM_REGION(0x40000)
	ROM_LOAD_EVEN( "xeno_pro.3c", 0x00000, 0x10000, 0x4d1f1ec9 , 0xf44c2e60 )
	ROM_LOAD_ODD ( "xeno_pro.3b", 0x00000, 0x10000, 0xa717ede5 , 0x01609a3b )
	ROM_LOAD_EVEN( "xeno_pro.2c", 0x20000, 0x10000, 0xd6d78577 , 0xe45bf669 )
	ROM_LOAD_ODD ( "xeno_pro.2b", 0x20000, 0x10000, 0x21f4510a , 0xda5d39d5 )

	ROM_REGION_DISPOSE(0x50000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "xeno_bg.12d", 0x00000, 0x08000, 0xa7648f06 , 0xc32288b1 )
	ROM_LOAD( "xeno_bg.11d", 0x08000, 0x08000, 0x66b31c05 , 0x3d2cf284 )
	ROM_LOAD( "xeno_fg.10j", 0x10000, 0x10000, 0x2b3cb69c , 0x6a7a3516 )
	ROM_LOAD( "xeno_fg.9j", 0x20000, 0x10000, 0x3a9a164a , 0x82fb3e09 )
	ROM_LOAD( "xeno_fg.8j", 0x30000, 0x10000, 0x34bada44 , 0x20e682f5 )
	ROM_LOAD( "xeno_fg.7j", 0x40000, 0x10000, 0xa36462ec , 0xb12eddb2 )

	ROM_REGION(0x40000)  /* Sounds Good board */
	ROM_LOAD_EVEN( "xeno_snd.u7", 0x00000, 0x10000, 0x98a2948a , 0x77561d15 )
	ROM_LOAD_ODD ( "xeno_snd.u17", 0x00000, 0x10000, 0x8397a3b1 , 0x837a1a71 )
	ROM_LOAD_EVEN( "xeno_snd.u8", 0x20000, 0x10000, 0x861a826c , 0x6e2915c7 )
	ROM_LOAD_ODD ( "xeno_snd.u18", 0x20000, 0x10000, 0x04132bd1 , 0x12492145 )
ROM_END

ROM_START( spyhunt2_rom )
	ROM_REGION(0x40000)
	ROM_LOAD_EVEN( "3c", 0x0000, 0x10000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "3b", 0x0000, 0x10000, 0x54429658 , 0x0 )
	ROM_LOAD_EVEN( "2c", 0x20000, 0x10000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "2b", 0x20000, 0x10000, 0x54429658 , 0x0 )

	ROM_REGION_DISPOSE(0x90000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "bg1.12d", 0x00000, 0x8000, 0xefa953c5 , 0x0 )
	ROM_LOAD( "bg0.11d", 0x08000, 0x8000, 0x88fe2998 , 0x0 )
	ROM_LOAD( "fg3.10j", 0x10000, 0x20000, 0x06033763 , 0x0 )
	ROM_LOAD( "fg2.9j", 0x30000, 0x20000, 0xdf6c8714 , 0x0 )
	ROM_LOAD( "fg1.8j", 0x50000, 0x20000, 0xa0449c5e , 0x0 )
	ROM_LOAD( "fg0.7j", 0x70000, 0x20000, 0xf9f7bf39 , 0x0 )
...
ROM_START( blasted_rom )
	...
	ROM_REGION_DISPOSE(0x50000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "12d", 0x00000, 0x8000, 0xefa953c5 , 0x0 )
	ROM_LOAD( "11d", 0x08000, 0x8000, 0x88fe2998 , 0x0 )
	ROM_LOAD( "fg0", 0x10000, 0x10000, 0x06033763 , 0x0 )
	ROM_LOAD( "fg1", 0x20000, 0x10000, 0xdf6c8714 , 0x0 )
	ROM_LOAD( "fg2", 0x30000, 0x10000, 0xa0449c5e , 0x0 )
	ROM_LOAD( "fg3", 0x40000, 0x10000, 0xf9f7bf39 , 0x0 )
...
ROM_START( zwackery_rom )
	ROM_REGION(0x40000)
	ROM_LOAD_EVEN( "pro0.bin", 0x0000, 0x4000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "pro1.bin", 0x0000, 0x4000, 0x54429658 , 0x0 )
	ROM_LOAD_EVEN( "pro2.bin", 0x8000, 0x4000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "pro3.bin", 0x8000, 0x4000, 0x54429658 , 0x0 )
	ROM_LOAD_EVEN( "pro4.bin", 0x10000, 0x4000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "pro5.bin", 0x10000, 0x4000, 0x54429658 , 0x0 )
	ROM_LOAD_EVEN( "pro6.bin", 0x18000, 0x4000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "pro7.bin", 0x18000, 0x4000, 0x54429658 , 0x0 )
	ROM_LOAD_EVEN( "pro8.bin", 0x20000, 0x4000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "pro9.bin", 0x20000, 0x4000, 0x54429658 , 0x0 )
	ROM_LOAD_EVEN( "pro10.bin", 0x28000, 0x4000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "pro11.bin", 0x28000, 0x4000, 0x54429658 , 0x0 )
	ROM_LOAD_EVEN( "pro12.bin", 0x30000, 0x4000, 0x471a3c00 , 0x0 )
	ROM_LOAD_ODD ( "pro13.bin", 0x30000, 0x4000, 0x54429658 , 0x0 )

	ROM_REGION_DISPOSE(0x50000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "tilee.bin", 0x00000, 0x4000, 0xefa953c5 , 0x0 )
	ROM_LOAD( "tilef.bin", 0x04000, 0x4000, 0xefa953c5 , 0x0 )
	ROM_LOAD( "tileg.bin", 0x08000, 0x4000, 0xefa953c5 , 0x0 )
	ROM_LOAD( "tileh.bin", 0x0C000, 0x4000, 0xefa953c5 , 0x0 )

	ROM_LOAD( "spr6h.bin", 0x10000, 0x4000, 0x06033763 , 0x0 )
	ROM_LOAD( "spr6j.bin", 0x14000, 0x4000, 0x06033763 , 0x0 )
	ROM_LOAD( "spr7h.bin", 0x18000, 0x4000, 0x06033763 , 0x0 )
	ROM_LOAD( "spr7j.bin", 0x1C000, 0x4000, 0x06033763 , 0x0 )
	ROM_LOAD( "spr10h.bin", 0x20000, 0x4000, 0x06033763 , 0x0 )
	ROM_LOAD( "spr10j.bin", 0x24000, 0x4000, 0x06033763 , 0x0 )
	ROM_LOAD( "spr11h.bin", 0x28000, 0x4000, 0x06033763 , 0x0 )
	ROM_LOAD( "spr11j.bin", 0x2C000, 0x4000, 0x06033763 , 0x0 )
