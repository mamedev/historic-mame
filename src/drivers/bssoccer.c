/***************************************************************************
					...
					-= Back Street Soccer  &  Ultra Balloon =-
...
WRITE16_HANDLER( bssoccer_soundlatch_w )
{
	if (ACCESSING_LSB)
	{
...
static MEMORY_READ16_START( bssoccer_readmem )
	...
	{ 0x400000, 0x4001ff, bssoccer_paletteram16_r	},	// Banked Palette
...
static MEMORY_WRITE16_START( bssoccer_writemem )
	...
	{ 0x400000, 0x4001ff, bssoccer_paletteram16_w, &paletteram16 },  // Banked Palette
	{ 0x400200, 0x400fff, MWA16_RAM 				},	//
	{ 0x600000, 0x61ffff, MWA16_RAM, &spriteram16	},	// Sprites
	{ 0xa00000, 0xa00001, bssoccer_soundlatch_w		},	// To Sound CPU
	{ 0xa00002, 0xa00003, bssoccer_flipscreen_w		},	// Flip Screen
...
static MEMORY_READ16_START( uballoon_readmem )
	...
	{ 0x200000, 0x2001ff, bssoccer_paletteram16_r	},	// Banked Palette
...
static MEMORY_WRITE16_START( uballoon_writemem )
	...
	{ 0x200000, 0x2001ff, bssoccer_paletteram16_w, &paletteram16 },  // Banked Palette
	...
	{ 0x600000, 0x600001, bssoccer_soundlatch_w		},	// To Sound CPU
	{ 0x600004, 0x600005, bssoccer_flipscreen_w		},	// Flip Screen
