...
ROM_START( cop01_rom )
	...
	ROM_LOAD( "cop01.2b", 0x0000, 0x4000, 0x0dac94a2 , 0x5c2734ab )
	ROM_LOAD( "cop02.4b", 0x4000, 0x4000, 0xbc8ff33b , 0x9c7336ef )
	ROM_LOAD( "cop03.5b", 0x8000, 0x4000, 0x852b8129 , 0x2566c8bf )

	ROM_REGION_DISPOSE(0x1A000)
	/* Tiles */
	ROM_LOAD( "cop14.15g", 0x0000, 0x2000, 0x801e53d0 , 0x066d1c55 )

	/* Background */
	ROM_LOAD( "cop04.15c", 0x2000, 0x4000, 0xed4b27db , 0x622d32e6 )
	ROM_LOAD( "cop05.16c", 0x6000, 0x4000, 0x2a25667d , 0xc6ac5a35 )

	/* Sprites */
	/*
	ROM_LOAD( "cop10.3e", 0x0A000, 0x2000, 0x619b703b , 0x444cb19d )
	ROM_LOAD( "cop06.3g", 0x0C000, 0x2000, 0xd9c15c53 , 0xf1c1f4a5 )

	ROM_LOAD( "cop13.8e", 0x0E000, 0x2000, 0x8fb89324 , 0x07c4ea66 )
	ROM_LOAD( "cop09.8g", 0x10000, 0x2000, 0x02e2fd04 , 0x855a2ec3 )

	ROM_LOAD( "cop11.5e", 0x12000, 0x2000, 0x4a5c0070 , 0x9078bc04 )
	ROM_LOAD( "cop07.5g", 0x14000, 0x2000, 0x7133594d , 0x11db7b72 )

	ROM_LOAD( "cop12.6e", 0x16000, 0x2000, 0x767747a7 , 0x257a6706 )
	ROM_LOAD( "cop08.6g", 0x18000, 0x2000, 0x64822cb0 , 0xa63ddda6 )
	*/
	...
	ROM_LOAD( "copproma.13d", 0x000, 0x100, 0x26880006 , 0x97f68a7a )
	ROM_LOAD( "coppromb.14d", 0x100, 0x100, 0xe3bb0201 , 0x39a40b4c )
	ROM_LOAD( "coppromc.15d", 0x200, 0x100, 0xab010301 , 0x8181748b )
	ROM_LOAD( "coppromd.19d", 0x300, 0x100, 0x72770609 , 0x6a63dbb8 )
	ROM_LOAD( "copprome.2e", 0x400, 0x100, 0xb50e0c08 , 0x214392fa )

	ROM_REGION(0x10000)     /* 64k for code */
	ROM_LOAD( "cop15.17b", 0x0000, 0x4000, 0xa7e82b5a , 0x6a5f08fa )
	ROM_LOAD( "cop16.18b", 0x4000, 0x4000, 0x9c039d7b , 0x56bf6946 )
ROM_END
