...
ROM_START( bbusters )
	...
	ROM_LOAD16_BYTE( "bb-3.k10",   0x000000, 0x20000, 0x04da1820 )
	ROM_LOAD16_BYTE( "bb-5.k12",   0x000001, 0x20000, 0x777e0611 )
	ROM_LOAD16_BYTE( "bb-2.k8",    0x040000, 0x20000, 0x20141805 )
	ROM_LOAD16_BYTE( "bb-4.k11",   0x040001, 0x20000, 0xd482e0e9 )

	ROM_REGION( 0x10000, REGION_CPU2, 0 )
	ROM_LOAD( "bb-1.e6",     0x000000, 0x10000, 0x4360f2ee )

	ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE )
	ROM_LOAD( "bb-10.l9",    0x000000, 0x20000, 0x490c0d9b )

	ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE )
	ROM_LOAD( "bb-f11.m16",  0x000000, 0x80000, 0x39fdf9c0 )
	ROM_LOAD( "bb-f12.m13",  0x080000, 0x80000, 0x69ee046b )
	ROM_LOAD( "bb-f13.m12",  0x100000, 0x80000, 0xf5ef840e )
	ROM_LOAD( "bb-f14.m11",  0x180000, 0x80000, 0x1a7df3bb )

	ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE )
	ROM_LOAD( "bb-f21.l10",  0x000000, 0x80000, 0x530f595b )
	ROM_LOAD( "bb-f22.l12",  0x080000, 0x80000, 0x889c562e )
	ROM_LOAD( "bb-f23.l13",  0x100000, 0x80000, 0xc89fe0da )
	ROM_LOAD( "bb-f24.l15",  0x180000, 0x80000, 0xe0d81359 )

	ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE )
	ROM_LOAD( "bb-back1.m4", 0x000000, 0x80000, 0xb5445313 )

	ROM_REGION( 0x80000, REGION_GFX5, ROMREGION_DISPOSE )
	ROM_LOAD( "bb-back2.m6", 0x000000, 0x80000, 0x8be996f6 )

	ROM_REGION( 0x10000, REGION_USER1, 0 ) /* Zoom table */
	ROM_LOAD( "bb-6.e7",       0x000000, 0x10000, 0x61f3de03 )
	/* This rom also as bb-7.h7 */
	/* This rom also as bb-8.a14 */
	/* This rom also as bb-9.c14 */

	ROM_REGION( 0x80000, REGION_SOUND1, 0 )
	ROM_LOAD( "bb-pcma.l5",  0x000000, 0x80000, 0x44cd5bfe )

	ROM_REGION( 0x80000, REGION_SOUND2, 0 )
	ROM_LOAD( "bb-pcmb.l3",  0x000000, 0x80000, 0xc8d5dd53 )
ROM_END

ROM_START( mechatt )
	ROM_REGION( 0x80000, REGION_CPU1, 0 )
	ROM_LOAD16_BYTE( "ma5-e.bin", 0x000000, 0x20000, 0x9bbb852a )
	ROM_LOAD16_BYTE( "ma4.bin",   0x000001, 0x20000, 0x0d414918 )
	ROM_LOAD16_BYTE( "ma7.bin",   0x040000, 0x20000, 0x61d85e1b )
	ROM_LOAD16_BYTE( "ma6-f.bin", 0x040001, 0x20000, 0x4055fe8d )

	ROM_REGION( 0x10000, REGION_CPU2, 0 )
	ROM_LOAD( "ma3.bin",       0x000000, 0x10000, 0xc06cc8e1 )

	ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE )
	ROM_LOAD( "ma1.bin",       0x000000, 0x10000, 0x24766917 )

	ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE )
	ROM_LOAD( "mao89p13.bin",  0x000000, 0x80000, 0x8bcb16cf )
	ROM_LOAD( "ma189p15.bin",  0x080000, 0x80000, 0xb84d9658 )
	ROM_LOAD( "ma289p17.bin",  0x100000, 0x80000, 0x6cbe08ac )
	ROM_LOAD( "ma389m15.bin",  0x180000, 0x80000, 0x34d4585e )

	ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE )
	/* Unused */

	ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE )
	ROM_LOAD( "mab189a2.bin",  0x000000, 0x80000, 0xe1c8b4d0 )

	ROM_REGION( 0x80000, REGION_GFX5, ROMREGION_DISPOSE )
	ROM_LOAD( "mab289c2.bin",  0x000000, 0x80000, 0x14f97ceb )

	ROM_REGION( 0x20000, REGION_SOUND1, 0 )
	ROM_LOAD( "ma2.bin",       0x000000, 0x20000, 0xea4cc30d )

	ROM_REGION( 0x20000, REGION_USER1, 0 ) /* Zoom table */
	ROM_LOAD( "ma8.bin",       0x000000, 0x10000, 0x61f3de03 )
