...
INPUT_PORTS_START( input_ports )
    ...
    PORT_DIPSETTING(    0x00, "On" )
    PORT_DIPNAME( 0x10, 0x00, "Controls", IP_KEY_NONE )
    PORT_DIPSETTING(    0x10, "Dual" )
...
ROM_START( psychic5_rom )
	...
	ROM_LOAD( "P5D", 0x00000, 0x08000, 0x1ccae1dc )
	ROM_LOAD( "P5E", 0x10000, 0x10000, 0x11a40886 )

	ROM_REGION( 0x48000 )   			/* graphics (disposed after conversion) */
	ROM_LOAD( "P5B", 0x00000, 0x10000, 0x9ae2b9cc )	/* sprite tiles */
	ROM_LOAD( "P5C", 0x10000, 0x10000, 0x5a0d6411 )
	ROM_LOAD( "P5G", 0x20000, 0x10000, 0x2e7a2dd4 )	/* background tiles */
	ROM_LOAD( "P5H", 0x30000, 0x10000, 0x2631df25 )
	ROM_LOAD( "P5F", 0x40000, 0x08000, 0xb957cea9 ) /* foreground tiles */

	ROM_REGION( 0x10000 ) 				/*64K for 2nd z80 CPU*/
	ROM_LOAD( "P5A", 0x00000, 0x08000, 0x12e2f076 )
ROM_END
