...
INPUT_PORTS_START( gldncrwn )
	...
	PORT_DIPSETTING(    0x08, "Medium-High" )
	PORT_DIPSETTING(    0x0C, DEF_STR( High ) )
	PORT_DIPNAME( 0x10, 0x00, "Base Pricing on:" )
 ...
 */
	...
	PORT_DIPNAME( 0x04, 0x04, "Time bar" )
...
// input ports for dutch quintoon /////////////////////////////////
	...
	PORT_START_TAG("STROBE11")
	PORT_DIPNAME( 0x01, 0x00, "Time bar" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x01, DEF_STR( On  ) )
	...
	PORT_DIPNAME( 0x04, 0x00, "Attract mode" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x04, DEF_STR( On  ) )

	PORT_DIPNAME( 0x08, 0x00, "Attract mode language" )
	PORT_DIPSETTING(    0x00, "Dutch"    )
...
// input ports for UK quintoon ////////////////////////////////////////////
	...
	PORT_START_TAG("STROBE10")
	PORT_DIPNAME( 0x01, 0x00, "Coin Lockout")
	...
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x02, DEF_STR( On  ) )
	PORT_DIPNAME( 0x1C, 0x1C, "Target percentage" )
...
// input ports for sltblgtk  //////////////////////////////////////////////
	...
	PORT_START_TAG("STROBE9")
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_SERVICE) PORT_NAME("Test Switch") PORT_CODE(KEYCODE_Y)
	PORT_DIPNAME( 0x02, 0x00, "CashMeters in refill menu" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x02, DEF_STR( On  ) )
	PORT_DIPNAME( 0x04, 0x00, "Token Inhibit?" )
	PORT_DIPSETTING(    0x00, DEF_STR( No  ) )
	PORT_DIPSETTING(    0x04, DEF_STR( Yes ) )
	PORT_DIPNAME( 0x08, 0x00, "20 Bfr Inhibit?" )
	PORT_DIPSETTING(    0x00, DEF_STR( No  ) )
	PORT_DIPSETTING(    0x08, DEF_STR( Yes ) )
	PORT_DIPNAME( 0x10, 0x00, "50 Bfr Inhibit?" )
	PORT_DIPSETTING(    0x00, DEF_STR( No ) )
	PORT_DIPSETTING(    0x10, DEF_STR( Yes  ) )
	...
	PORT_DIPNAME( 0x0E, 0x0E, "Payout Percentage" )
	...
	PORT_START_TAG("STROBE11")
	PORT_DIPNAME( 0x01, 0x01, "Timebar" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x01, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x00, "Clear credits" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x02, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x00, "Attract mode" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off  ) )
...
// input ports for sltblgpo  //////////////////////////////////////////////
	...
	PORT_START_TAG("STROBE9")
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_SERVICE) PORT_NAME("Test Switch") PORT_CODE(KEYCODE_Y)
	PORT_DIPNAME( 0x02, 0x00, "Hopper Limit" )
	PORT_DIPSETTING(    0x00, "300" )
	PORT_DIPSETTING(    0x02, "500" )
	PORT_BIT(0x04, IP_ACTIVE_HIGH, IPT_UNKNOWN)
	PORT_DIPNAME( 0x18, 0x00, "Attendant payout" )
	...
	PORT_START_TAG("STROBE10")
	PORT_DIPNAME( 0x01, 0x00, "Bfr 20 Inhibit?" )
	PORT_DIPSETTING(    0x00, DEF_STR( No ) )
	...
	PORT_START_TAG("STROBE11")
	PORT_DIPNAME( 0x01, 0x00, "Clear credits on reset?" )
	PORT_DIPSETTING(    0x00, DEF_STR( No ) )
	PORT_DIPSETTING(    0x01, DEF_STR( Yes ) )
	PORT_DIPNAME( 0x02, 0x00, "Attract Mode" )
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On  ) )
	PORT_DIPNAME( 0x1C, 0x08, "Target Percentage" )
...
INPUT_PORTS_START( paradice )
	...
	PORT_START_TAG("STROBE11")
	PORT_DIPNAME( 0x03, 0x00, "Winlines to go" )
