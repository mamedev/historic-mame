...
ROM_START( sharkatt_rom )
	...
	ROM_LOAD( "sharkatt.0", 0x0000, 0x0800, 0xf5e073e2 , 0xc71505e9 )
	ROM_LOAD( "sharkatt.1", 0x0800, 0x0800, 0x530ecada , 0x3e3abf70 )
	ROM_LOAD( "sharkatt.2", 0x1000, 0x0800, 0x75669bb8 , 0x96ded944 )
	ROM_LOAD( "sharkatt.3", 0x1800, 0x0800, 0x97c93c3b , 0x007283ae )
	ROM_LOAD( "sharkatt.4a", 0x2000, 0x0800, 0x3249d0b5 , 0x5cb114a7 )
	ROM_LOAD( "sharkatt.5", 0x2800, 0x0800, 0xa12e27fa , 0x1d88aaad )
	ROM_LOAD( "sharkatt.6", 0x3000, 0x0800, 0xc2f475d0 , 0xc164bad4 )
	ROM_LOAD( "sharkatt.7", 0x3800, 0x0800, 0x81742618 , 0xd78c4b8b )
	ROM_LOAD( "sharkatt.8", 0x4000, 0x0800, 0x751f1f01 , 0x5958476a )
	ROM_LOAD( "sharkatt.9", 0x4800, 0x0800, 0x4bddae47 , 0x4915eb37 )
	ROM_LOAD( "sharkatt.10", 0x5000, 0x0800, 0x1b8365bb , 0x9d07cb68 )
	ROM_LOAD( "sharkatt.11", 0x5800, 0x0800, 0xcaed67f9 , 0x21edc962 )
	ROM_LOAD( "sharkatt.12a", 0x6000, 0x0800, 0x0efb8901 , 0x5dd8785a )
