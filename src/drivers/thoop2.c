...
ROM_START( thoop2 )
	...
	ROM_LOAD16_BYTE(	"th2c23.040",	0x000000, 0x080000, 0x3e465753 )
	ROM_LOAD16_BYTE(	"th2c22.040",	0x000001, 0x080000, 0x837205b7 )

	ROM_REGION( 0x800000, REGION_GFX1, ROMREGION_DISPOSE )
	ROM_LOAD( "th2-h8.32m",		0x000000, 0x400000, 0x60328a11 )
	ROM_LOAD( "th2-h12.32m",	0x400000, 0x400000, 0xb25c2d3e )

	ROM_REGION( 0x140000, REGION_SOUND1, 0 )	/* ADPCM samples - sound chip is OKIM6295 */
	ROM_LOAD( "th2-c1.080",		0x000000, 0x100000, 0x8fac8c30 )
	ROM_RELOAD(					0x040000, 0x100000 )
	/* 0x00000-0x2ffff is fixed, 0x30000-0x3ffff is bank switched */
ROM_END

GAMEX( 1994, thoop2,  0, thoop2, thoop2,  0, ROT0, "Gaelco", "Thunder Hoop 2: Strikes Back", GAME_UNEMULATED_PROTECTION )
