...
ROM_START( galpani2 )
	...
	ROM_LOAD16_BYTE( "g000t1.133", 0x000000, 0x080000, 0x332048e7 )
	ROM_LOAD16_BYTE( "g001t1.134", 0x000001, 0x080000, 0xc92937c3 )

 	ROM_REGION( 0x1000000, REGION_CPU2, 0 )			/* CPU#2 Code */
	ROM_LOAD16_BYTE( "g002t1.125", 0x000000, 0x020000, 0xa3034e1c )
	ROM_LOAD16_BYTE( "g003t1.126", 0x000001, 0x020000, 0x20d3a2ad )

	ROM_REGION16_BE( 0x1500000, REGION_USER1, 0 )	/* Backgrounds (CPU2) */
	ROM_LOAD16_BYTE( "gp2-300b.053", 0x0000000, 0x100000, 0xd7d12920 )
	ROM_LOAD16_BYTE( "gp2-300a.052", 0x0000001, 0x100000, 0x09ebedba )
	ROM_LOAD( "gp2-301.035", 0x0200000, 0x200000, 0xe71e749d )
	ROM_LOAD( "gp2-302.036", 0x0400000, 0x200000, 0x832ebbb0 )
	ROM_LOAD( "gp2-303.037", 0x0600000, 0x200000, 0x36c872d0 )
	ROM_LOAD( "gp2-304.038", 0x0800000, 0x200000, 0x7200f918 )
	ROM_LOAD( "gp2-305.039", 0x0a00000, 0x200000, 0xa308dc4b )
	ROM_LOAD( "gp2-306.040", 0x0c00000, 0x200000, 0xcd294225 )
	ROM_LOAD( "gp2-307.041", 0x0e00000, 0x200000, 0x0fda01af )
	ROM_LOAD( "gp2-308.042", 0x1000000, 0x200000, 0x3c806376 )
	ROM_LOAD16_BYTE( "gp2-309a.050", 0x1200000, 0x100000, 0x2c025ec3 )
	ROM_LOAD16_BYTE( "gp2-309b.051", 0x1200001, 0x100000, 0xe8bf1730 )
	ROM_LOAD( "gp2-310a.055", 0x1400000, 0x100000, 0x01eca246 )

	ROM_REGION( 0x480000, REGION_GFX1, ROMREGION_DISPOSE )	/* Sprites */
	ROM_LOAD( "gp2-200.046", 0x080000, 0x080000, 0x11b49470 )
	ROM_CONTINUE(            0x000000, 0x080000             )
	ROM_LOAD( "gp2-201.047", 0x180000, 0x080000, 0x2f6392b4 )
	ROM_CONTINUE(            0x100000, 0x080000             )
	ROM_LOAD( "gp2-202.048", 0x280000, 0x080000, 0xc8177181 )
	ROM_CONTINUE(            0x200000, 0x080000             )
	ROM_LOAD( "gp2-203.049", 0x380000, 0x080000, 0x14e0cb38 )
	ROM_CONTINUE(            0x300000, 0x080000             )
	ROM_LOAD16_BYTE( "g204t1.33", 0x400000, 0x040000, 0x65a1f838 )
	ROM_LOAD16_BYTE( "g204t1.27", 0x400001, 0x040000, 0x39059f66 )

	ROM_REGION( 0x140000, REGION_SOUND1, ROMREGION_SOUNDONLY )	/* Samples */
	ROM_LOAD( "gp2-100.043", 0x040000, 0x100000, 0x4235ac5b )	// $10 x $10000
	ROM_COPY( REGION_SOUND1, 0x0c0000, 0, 0x40000 )

	ROM_REGION( 0x400000, REGION_SOUND2, ROMREGION_SOUNDONLY )	/* Samples */
	ROM_LOAD( "gp2-102.045", 0x000000, 0x100000, 0xb4bee779 )	//  $8 x $40000
	ROM_CONTINUE(            0x200000, 0x100000 )
	ROM_LOAD( "gp2-101.044", 0x100000, 0x100000, 0xf75ba6a0 )	//  $4 x $40000
