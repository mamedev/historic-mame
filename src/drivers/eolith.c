...
static ADDRESS_MAP_START( eolith_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0xfa000000, 0xfbffffff) AM_ROM AM_REGION(REGION_USER2, 0)//mirror for hiddnctch
	...
	AM_RANGE(0xfd000000, 0xfeffffff) AM_ROM AM_REGION(REGION_USER2, 0)
...
ROM_START( hidnctch )
	...
	ROM_REGION( 0x2000000, REGION_USER2, ROMREGION_ERASE00 ) /* Game Data */
	ROM_LOAD32_WORD( "hc1_u34.bin", 0x0000000, 0x400000, CRC(482f3e52) SHA1(7a527c6af4c80e10cc25219a04ccf7c7ea1b23af) )
	ROM_LOAD32_WORD( "hc0_u39.bin", 0x0000002, 0x400000, CRC(eefb6add) SHA1(a0f6f2cf86699a666be0647274d8c9381782640d) )
	ROM_LOAD32_WORD( "hc3_u35.bin", 0x0800000, 0x400000, CRC(80c59133) SHA1(66ca4c2c014c4a1c87c46a3971732f0a2be95408) )
	ROM_LOAD32_WORD( "hc2_u40.bin", 0x0800002, 0x400000, CRC(914a1544) SHA1(683cb007ace50d1ba88253da6ad71dc3a395299d) )
	ROM_LOAD32_WORD( "hc5_u36.bin", 0x1000000, 0x400000, CRC(74b1719d) SHA1(fe2325259117598ad7c23217426ac9c28440e3a0) )
	ROM_LOAD32_WORD( "hc4_u41.bin", 0x1000002, 0x400000, CRC(9a9e2203) SHA1(a90f5842b63696753e6c16114b1893bbeb91e45c) )
...
ROM_START( landbrk )
	...
	ROM_REGION( 0x2000000, REGION_USER2, ROMREGION_ERASE00 ) /* Game Data */
	ROM_LOAD32_WORD( "00.bin", 0x0000002, 0x200000, CRC(a803aace) SHA1(52a9e27b4f400767a953aa01321a9fa7cdbf3976) )
	ROM_LOAD32_WORD( "01.bin", 0x0000000, 0x200000, CRC(439c95cc) SHA1(18830024b2e43f0a89a7bd32841fbcb574e50fc6) )
	ROM_LOAD32_WORD( "02.bin", 0x0400002, 0x200000, CRC(a0c2828c) SHA1(967dc467d25f093749aa0146ebf54959c9803b92) )
	ROM_LOAD32_WORD( "03.bin", 0x0400000, 0x200000, CRC(5106b61a) SHA1(5e584ce5247d598e59d071579edb1da87fb2c9d6) )
	ROM_LOAD32_WORD( "04.bin", 0x0800002, 0x200000, CRC(fbe4a215) SHA1(2dec06a8641ef3db2a5448c95677ee8d7b0dc0ad) )
	ROM_LOAD32_WORD( "05.bin", 0x0800000, 0x200000, CRC(61d422b2) SHA1(c9774747c94cac44ffd3c1781374c009950b2add) )
	ROM_LOAD32_WORD( "06.bin", 0x0c00002, 0x200000, CRC(bc4f7f30) SHA1(31e7a6077a823f16a645547c9c11640535e02eb3) )
	ROM_LOAD32_WORD( "07.bin", 0x0c00000, 0x200000, CRC(d4d108ce) SHA1(d462690b782b363db5a062e6e04fe0c00e21bd46) )
	ROM_LOAD32_WORD( "08.bin", 0x1000002, 0x200000, CRC(36237654) SHA1(38a4d6d195683128c05d8869ff4184d79d26fead) )
	ROM_LOAD32_WORD( "09.bin", 0x1000000, 0x200000, CRC(9171828b) SHA1(648a398654bfba2e7681a3eee61e3803538929b5) )
	ROM_LOAD32_WORD( "10.bin", 0x1400002, 0x200000, CRC(fe51744d) SHA1(2f6fb5cc7a52d2fa3459b9b2cf3450a227c19643) )
	ROM_LOAD32_WORD( "11.bin", 0x1400000, 0x200000, CRC(fe6fd5e0) SHA1(66442b0d308517ebf0e13653cf4289ee9e9e0741) )
	ROM_LOAD32_WORD( "12.bin", 0x1800002, 0x200000, CRC(9f0f17f3) SHA1(c280dd5127ea6d1585f8b7ad753de45e1beaca8f) )
	ROM_LOAD32_WORD( "13.bin", 0x1800000, 0x200000, CRC(c7d51bbe) SHA1(a399087496f1c3f4c4b9e9b97e97585302ff29e5) )
	ROM_LOAD32_WORD( "14.bin", 0x1c00002, 0x200000, CRC(f30f7bc5) SHA1(8b3e002b773a88229d013e1d95336736a259c698) )
	ROM_LOAD32_WORD( "15.bin", 0x1c00000, 0x200000, CRC(bc1664e3) SHA1(a13a4e1df8d9825a72ecca1552ee52958c0d33d8) )
...
ROM_START( landbrka )
	...
	ROM_REGION( 0x2000000, REGION_USER2, ROMREGION_ERASE00 ) /* Game Data */
	ROM_LOAD32_WORD( "lb2-000.u39", 0x0000002, 0x400000, CRC(b37faf7a) SHA1(30e9af3957ada7c72d85f55add221c2e9b3ea823) )
	ROM_LOAD32_WORD( "lb2-001.u34", 0x0000000, 0x400000, CRC(07e620c9) SHA1(19f95316208fb4e52cef78f18c5d93460a644566) )
	ROM_LOAD32_WORD( "lb2-002.u40", 0x0800002, 0x400000, CRC(3bb4bca6) SHA1(115029be4a4e322549a35f3ae5093ec161e9a421) )
	ROM_LOAD32_WORD( "lb2-003.u35", 0x0800000, 0x400000, CRC(28ce863a) SHA1(1ba7d8be0ed4459dbdf99df18a2ad817904b9f04) )
	ROM_LOAD32_WORD( "lb2-004.u41", 0x1000002, 0x400000, CRC(cbe84b06) SHA1(52505939fb88cd24f409c795fe5ceed5b41a52c2) )
	ROM_LOAD32_WORD( "lb2-005.u36", 0x1000000, 0x400000, CRC(350c77a3) SHA1(231e65ea7db19019615a8aa4444922bcd5cf9e5c) )
	ROM_LOAD32_WORD( "lb2-006.u42", 0x1800002, 0x400000, CRC(22c57cd8) SHA1(c9eb745523005876395ff7f0b3e996994b3f1220) )
	ROM_LOAD32_WORD( "lb2-007.u37", 0x1800000, 0x400000, CRC(31f957b3) SHA1(ab1c4c50c2d5361ba8db047feb714423d84e6df4) )
...
ROM_START( raccoon )
	...
	ROM_REGION( 0x2000000, REGION_USER2, ROMREGION_ERASE00 ) /* Game Data */
	ROM_LOAD32_WORD( "racoon.u1",  0x0000000, 0x200000, CRC(49775125) SHA1(2b8ee9dd767465999c828d65bb02b8aaad94177c) )
 	ROM_LOAD32_WORD( "racoon.u10", 0x0000002, 0x200000, CRC(f702390e) SHA1(47520ba0e6d3f044136a517ebbec7426a66ce33d) )
 	ROM_LOAD32_WORD( "racoon.u2",  0x0400000, 0x200000, CRC(1eb00529) SHA1(d9af75e116f5237a3c6812538b77155b9c08dd5c) )
 	ROM_LOAD32_WORD( "racoon.u11", 0x0400002, 0x200000, CRC(3f23f368) SHA1(eb1ea51def2cde5e7e4f334888294b794aa03dfc) )
 	ROM_LOAD32_WORD( "racoon.u5",  0x0800000, 0x200000, CRC(5fbac174) SHA1(1d3e3f40a737d61ff688627891dec183af7fa19a) )
 	ROM_LOAD32_WORD( "racoon.u14", 0x0800002, 0x200000, CRC(870fe45e) SHA1(f8d800b92eb1ee9ef4663319fd3cb1f5e52d0e72) )
...
static DRIVER_INIT(landbrka)
{
	...
	memory_region(REGION_USER1)[0x14f02]=0;
	memory_region(REGION_USER1)[0x14f03]=3;
}
