...
ROM_START( punkshot )
	...
	ROM_REGION( 0x200000, REGION_GFX2, 0 )	/* graphics (addressable by the main CPU) */
	ROM_LOAD( "907d07.k2",    0x000000, 0x100000, 0xb0fe4543 )
	ROM_LOAD( "907d08.k7",    0x100000, 0x100000, 0xd5ac8d9d )
...
GAMEX(1991, tmnt2a,   tmnt2,    tmnt2,    ssrid4ps, gfx,      ROT0,  "Konami", "Teenage Mutant Ninja Turtles - Turtles in Time (Asia 4 Players)", GAME_UNEMULATED_PROTECTION )	// ver. ADA
