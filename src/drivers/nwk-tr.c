...
static DRIVER_INIT(racingj)
{
	...
	backup_ram[0x0d] = 0x00;	//
	backup_ram[0x0e] = 0xbd;	// checksum
	backup_ram[0x0f] = 0x19;	// checksum
...
static DRIVER_INIT(racingj2)
{
	...
	backup_ram[0x00] = 0x47;	// 'G'
	backup_ram[0x01] = 0x6e;	// 'n'
	backup_ram[0x02] = 0x38;	// '6'
	backup_ram[0x03] = 0x38;	// '7'
	backup_ram[0x04] = 0x38;	// '6'
	backup_ram[0x05] = 0x00;	//
	backup_ram[0x06] = 0x00;	//
	backup_ram[0x07] = 0x00;	//
	backup_ram[0x08] = 0x00;	//
...
ROM_START(racingj)
	...
	ROM_LOAD32_WORD("676a04.bin", 0x000000, 0x200000, CRC(d7808cb6) SHA1(0668fae5bb94cc120fe196d4b18200f7b512317f))
	ROM_LOAD32_WORD("676a05.bin", 0x000002, 0x200000, CRC(fb4de1ad) SHA1(f6aa4eb1b5d22901a2aaf899ed3237a9dfdc55b5))
...
ROM_START(thrilld)
	...
	ROM_REGION32_BE(0x400000, REGION_USER2, 0)		/* Data roms */
	ROM_LOAD32_WORD("713a04.16t", 0x000000, 0x200000, CRC(c994aaa8) SHA1(d82b9930a11e5384ad583684a27c95beec03cd5a))
	ROM_LOAD32_WORD("713a05.14t", 0x000002, 0x200000, CRC(6f1e6802) SHA1(91f8a170327e9b4ee6a64aee0c106b981a317e69))
