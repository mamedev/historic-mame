...
ROM_START( toki_rom )
	...
	ROM_REGION(0x220000)	/* 2*64k for foreground tiles */
	ROM_LOAD( "TOKI.E21", 0x000000, 0x08000, 0x62bbb4d3 )
	ROM_LOAD( "TOKI.E13", 0x008000, 0x08000, 0x47775ce5 )
	ROM_LOAD( "TOKI.E22", 0x010000, 0x08000, 0xf6e030fc )
	ROM_LOAD( "TOKI.E7" , 0x018000, 0x08000, 0xc2a6d2f0 )
							/* 16*64k for sprites */
	ROM_LOAD( "TOKI.E26", 0x020000, 0x20000, 0xf240d60a )
	ROM_LOAD( "TOKI.E28", 0x040000, 0x20000, 0x1525bd97 )
	ROM_LOAD( "TOKI.E34", 0x060000, 0x20000, 0x93776021 )
	ROM_LOAD( "TOKI.E36", 0x080000, 0x20000, 0x14d49b24 )
	ROM_LOAD( "TOKI.E30", 0x0a0000, 0x20000, 0x0b00822e )
	ROM_LOAD( "TOKI.E32", 0x0c0000, 0x20000, 0x625a59fa )
	ROM_LOAD( "TOKI.E38", 0x0e0000, 0x20000, 0xf062260c )
	ROM_LOAD( "TOKI.E40", 0x100000, 0x20000, 0xb78b0da3 )
							/* 8*64k for background #1 tiles */
	ROM_LOAD( "TOKI.E23", 0x120000, 0x10000, 0xeafea71c)
	ROM_LOAD( "TOKI.E24", 0x130000, 0x10000, 0x1515fcb5)
	ROM_LOAD( "TOKI.E15", 0x140000, 0x10000, 0x63200f60 )
	ROM_LOAD( "TOKI.E16", 0x150000, 0x10000, 0x328cb95c )
	ROM_LOAD( "TOKI.E17", 0x160000, 0x10000, 0xa4908982 )
	ROM_LOAD( "TOKI.E18", 0x170000, 0x10000, 0xe5de7236 )
	ROM_LOAD( "TOKI.E8",  0x180000, 0x10000, 0x12e1d7f9 )
	ROM_LOAD( "TOKI.E9" , 0x190000, 0x10000, 0x14318607 )
							/* 8*64k for background #2 tiles */
	ROM_LOAD( "TOKI.E25", 0x1a0000, 0x10000, 0x7f2775f5 )
	ROM_LOAD( "TOKI.E20", 0x1b0000, 0x10000, 0x82ed13fd )
	ROM_LOAD( "TOKI.E11", 0x1c0000, 0x10000, 0x262c3c66 )
	ROM_LOAD( "TOKI.E12", 0x1d0000, 0x10000, 0xe2f714a9 )
	ROM_LOAD( "TOKI.E19", 0x1e0000, 0x10000, 0x8d6314f9 )
	ROM_LOAD( "TOKI.E14", 0x1f0000, 0x10000, 0xdf55f5cb )
	ROM_LOAD( "TOKI.E10", 0x200000, 0x10000, 0xa06d2c4d )
	ROM_LOAD( "TOKI.E6" , 0x210000, 0x10000, 0xa5a88cec )

	ROM_REGION(0x18000)	/* 64k for code + 32k for banked data */
	ROM_LOAD( "TOKI.E1", 0x00000, 0x8000, 0x391e1c32 )
