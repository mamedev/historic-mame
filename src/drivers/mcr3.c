...
INPUT_PORTS_START( destderb_input_ports )
	...
	PORT_ANALOG ( 0xfc, 0x00, IPT_DIAL | IPF_REVERSE, 50, 10, 0, 0, 0 )
	...
	PORT_DIPNAME( 0x02, 0x02, "Difficulty" )
...
INPUT_PORTS_START( rampage_input_ports )
	...
	PORT_DIPNAME( 0x08, 0x08, "Coin A" )
	PORT_DIPSETTING(    0x00, "2 Coins/1 Credit" )
	PORT_DIPSETTING(    0x08, "1 Coin/1 Credit" )
	PORT_DIPNAME( 0x70, 0x70, "Coin B" )
	...
	PORT_BITX( 0x80,    0x80, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Rack Advance", OSD_KEY_F1, IP_JOY_NONE )
	PORT_DIPSETTING(    0x80, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
...
/* 0x00 says 2 Coins/2 Credits in service mode, but gives 1 Coin/1 Credit */
	...
	PORT_ANALOG( 0xff, 0x30, IPT_AD_STICK_Y | IPF_PLAYER2, 100, 10, 0, 0x30, 0xff )

	PORT_START	/* new fake for acceleration */
	PORT_ANALOG( 0xff, 0x30, IPT_AD_STICK_Y | IPF_PLAYER1, 100, 10, 0, 0x30, 0xff )

	PORT_START	/* new fake for steering */
	PORT_ANALOG( 0xff, 0x74, IPT_AD_STICK_X | IPF_PLAYER2 | IPF_REVERSE, 80, 10, 0, 0x34, 0xb4 )

	PORT_START	/* new fake for steering */
	PORT_ANALOG( 0xff, 0x74, IPT_AD_STICK_X | IPF_PLAYER1 | IPF_REVERSE, 80, 10, 0, 0x34, 0xb4 )
...
INPUT_PORTS_START( spyhunt_input_ports )
	...
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BITX( 0x10, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_TOGGLE, "Gear Shift", OSD_KEY_ENTER, IP_JOY_DEFAULT )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_TILT )
	...
	PORT_START	/* new fake for acceleration */
	PORT_ANALOG( 0xff, 0x30, IPT_AD_STICK_Y | IPF_REVERSE, 100, 10, 0, 0x30, 0xff )

	PORT_START	/* new fake for steering */
	PORT_ANALOG( 0xff, 0x74, IPT_AD_STICK_X | IPF_CENTER, 80, 10, 0, 0x34, 0xb4 )
INPUT_PORTS_END
