...
INPUT_PORTS_START( g80v_generic )
	...
	PORT_START_TAG("D1")
	PORT_DIPNAME( 0x0f, 0x03, DEF_STR ( Coin_A )) PORT_DIPLOCATION("SW2:1,2,3,4")
	...
	PORT_START_TAG("D0")
	PORT_DIPNAME( 0x0f, 0x03, DEF_STR ( Coin_B )) PORT_DIPLOCATION("SW2:5,6,7,8")
	PORT_DIPSETTING(	0x00, DEF_STR ( 4C_1C ))
	PORT_DIPSETTING(	0x01, DEF_STR ( 3C_1C ))
	PORT_DIPSETTING(	0x09, "2 Coins/1 Credit 5/3 6/4" )
	PORT_DIPSETTING(	0x0a, "2 Coins/1 Credit 4/3" )
...
INPUT_PORTS_START( elim2 )
	...
	PORT_MODIFY("D2")
	PORT_DIPNAME( 0x03, 0x00, DEF_STR( Difficulty )) PORT_DIPLOCATION("SW1:5,6")
	PORT_DIPSETTING(	0x00, DEF_STR( Easy ))
	PORT_DIPSETTING(	0x01, DEF_STR( Normal ))
	PORT_DIPSETTING(	0x02, DEF_STR( Hard ))
	PORT_DIPSETTING(	0x03, DEF_STR( Very_Hard ))
	PORT_DIPNAME( 0x0c, 0x04, DEF_STR( Bonus_Life )) PORT_DIPLOCATION("SW1:7,8")
...
INPUT_PORTS_START( elim4 )
	...
	PORT_DIPNAME( 0x0e, 0x00, DEF_STR( Coin_A )) PORT_DIPLOCATION("SW2:6,7,8")
...
INPUT_PORTS_START( spacfury )
	...
	PORT_DIPSETTING(	0x02, DEF_STR( Hard ))
	PORT_DIPSETTING(	0x03, DEF_STR( Very_Hard ))
	PORT_DIPNAME( 0x0c, 0x08, DEF_STR( Bonus_Life )) PORT_DIPLOCATION("SW1:7,8")
