...
INPUT_PORTS_START( turtship_input_ports )
	...
	PORT_START      /* DSW0 */
	PORT_BITX( 0x01, 0x01, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", 0, IP_JOY_NONE, 0 )
	...
	PORT_DIPNAME( 0xe0, 0xa0, "Lives", IP_KEY_NONE )
	...
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0xe0, 0xe0, "Coinage", IP_KEY_NONE )
	PORT_DIPSETTING(    0x00, "4 Coins/1 Credit" )
