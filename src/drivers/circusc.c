...
ROM_START( circusc_rom )
	...
	ROM_LOAD( "a02_j18.bin", 0x0000, 0x020, 0x091a3e2c ) /* palette */
	ROM_LOAD( "c10_j16.bin", 0x0020, 0x100, 0xd6500b06 ) /* character lookup table */
	ROM_LOAD( "b07_j17.bin", 0x0120, 0x100, 0x9f980206 ) /* sprite lookup table */
