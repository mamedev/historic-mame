...
extern int atarisys2_pedal_count;
...
static struct MemoryWriteAddress main_writemem[] =
{
	...
	{ 0x8000, 0x81ff, atarisys2_slapstic_w, &atarigen_slapstic },
...
static void csprint_init(void)
{
	...
	atarigen_slapstic_num = 109;
	atarigen_eeprom_default = NULL;

	atarisys2_pedal_count = 2;
	atarisys2_mo_mask = 0x07ff;
...
ROM_START( a720_rom )
	...
	ROM_LOAD( "1117.rom",     0x040000, 0x08000, 0x5a55f149 ) 	/* playfield, planes 2/3 */
	ROM_LOAD( "1118.rom",     0x048000, 0x08000, 0x9bb2429e )
...
ROM_START( apb_rom )
	...
	ROM_LOAD( "1101",         0x0a0000, 0x08000, 0x0ef13513 )	/* motion objects, planes 0/1 */
	ROM_CONTINUE(             0x080000, 0x08000 )
	...
	ROM_CONTINUE(             0x0d8000, 0x08000 )
	ROM_LOAD( "1105",         0x120000, 0x08000, 0x9b78a88e )	/* motion objects, planes 2/3 */
	ROM_CONTINUE(             0x100000, 0x08000 )
	ROM_LOAD( "1106",         0x128000, 0x08000, 0x4787ff58 )
	ROM_CONTINUE(             0x108000, 0x08000 )
	ROM_LOAD( "1107",         0x130000, 0x08000, 0x0e85f2ac )
	ROM_CONTINUE(             0x110000, 0x08000 )
	ROM_LOAD( "1108",         0x138000, 0x08000, 0x70ff9308 )
	ROM_CONTINUE(             0x118000, 0x08000 )
	ROM_LOAD( "1113",         0x160000, 0x08000, 0x4a445356 )
	ROM_CONTINUE(             0x140000, 0x08000 )
	ROM_LOAD( "1114",         0x168000, 0x08000, 0xb9b27f3c )
	ROM_CONTINUE(             0x148000, 0x08000 )
	ROM_LOAD( "1115",         0x170000, 0x08000, 0xa7671dd8 )
	ROM_CONTINUE(             0x150000, 0x08000 )
	ROM_LOAD( "1116",         0x178000, 0x08000, 0x879fc7de )
	ROM_CONTINUE(             0x158000, 0x08000 )
