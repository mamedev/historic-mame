...
ROM_START( wrally )
	...
	ROM_LOAD16_BYTE(	"worldr17.c23",	0x000000, 0x080000, 0x050f5629 )
	ROM_LOAD16_BYTE(	"worldr16.c22",	0x000001, 0x080000, 0x9e0d126c )

	ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE )
	ROM_LOAD16_BYTE( "worldr21.i13",	0x000000, 0x080000, 0xb7fddb12 )
	ROM_LOAD16_BYTE( "worldr20.i11",	0x000001, 0x080000, 0x58b2809a )
	ROM_LOAD16_BYTE( "worldr19.i09",	0x100000, 0x080000, 0x018b35bb )
	ROM_LOAD16_BYTE( "worldr18.i07",	0x100001, 0x080000, 0xb37c807e )

	ROM_REGION( 0x140000, REGION_SOUND1, 0 )	/* ADPCM samples - sound chip is OKIM6295 */
	ROM_LOAD( "worldr14.c01",	0x000000, 0x080000, 0xe931c2ee )
	/* 0x00000-0x2ffff is fixed, 0x30000-0x3ffff is bank switched from all the ROMs */
	ROM_RELOAD(		0x040000, 0x080000 )
	ROM_LOAD( "worldr15.c03",	0x0c0000, 0x080000, 0x11f0fe2c )
ROM_END

ROM_START( wrallya )
	ROM_REGION( 0x100000, REGION_CPU1, 0 )	/* 68000 code */
	ROM_LOAD16_BYTE(	"c23.bin",	0x000000, 0x080000, 0x8b7d93c3 )
	ROM_LOAD16_BYTE(	"c22.bin",	0x000001, 0x080000, 0x56da43b6 )
...
//	ROM_LOAD( "h12.bin",	0x000000, 0x100000, 0x3353dc00 )
//	ROM_LOAD( "h8.bin",		0x100000, 0x100000, 0x58dcd024 )
