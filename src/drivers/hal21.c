...
static struct GfxDecodeInfo aso_gfxdecodeinfo[] = {
	...
	{ REGION_GFX1, 0x0, &char256,    128*3,  8 },	/* colors 384..511 */
	{ REGION_GFX2, 0x0, &char1024,   128*1, 16 },	/* colors 128..383 */
	{ REGION_GFX3, 0x0, &sprite1024, 128*0, 16 },	/* colors   0..127 */
	{ -1 }
};
...
ROM_START( hal21 )
	...
	ROM_REGIONX( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE  ) /* background tiles */
	ROM_LOAD( "hal21p11.bin", 0x0000, 0x4000, 0x24abc57e )

	ROM_REGIONX( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE  ) /* 16x16 sprites */
...
ROM_START( aso )
	...
	ROM_REGIONX( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE ) /* characters */
...
struct GameDriver driver_hal21j =
{
	__FILE__,
	&driver_hal21,
	"hal21j",
