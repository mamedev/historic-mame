...
ROM_START( sbasketb_rom )
	...
	ROM_LOAD( "sbb_j13.bin", 0x6000, 0x2000, 0x31c615be , 0x263ec36b )
	ROM_LOAD( "sbb_j11.bin", 0x8000, 0x4000, 0x0f580fca , 0x0a4d7a82 )
	ROM_LOAD( "sbb_j09.bin", 0xc000, 0x4000, 0xb5e9f53d , 0x4f9dd9a0 )

	ROM_REGION_DISPOSE(0x10000)    /* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "sbb_e12.bin", 0x0000, 0x4000, 0xc34f6429 , 0xe02c54da )
	ROM_LOAD( "sbb_h06.bin", 0x4000, 0x4000, 0x613e1e6c , 0xcfbbff07 )
	ROM_LOAD( "sbb_h08.bin", 0x8000, 0x4000, 0x5eb646ec , 0xc75901b6 )
	ROM_LOAD( "sbb_h10.bin", 0xc000, 0x4000, 0xd02d8a3d , 0x95bc5942 )

	ROM_REGION(0x0500)    /* color proms */
	ROM_LOAD( "405e17", 0x0000, 0x0100, 0x79420806 , 0xb4c36d57 ) /* palette red component */
	ROM_LOAD( "405e16", 0x0100, 0x0100, 0x6fbe000a , 0x0b7b03b8 ) /* palette green component */
	ROM_LOAD( "405e18", 0x0200, 0x0100, 0x2be60502 , 0x9e533bad ) /* palette blue component */
	ROM_LOAD( "405e20", 0x0300, 0x0100, 0x52760d06 , 0x8ca6de2f ) /* character lookup table */
	ROM_LOAD( "405e19", 0x0400, 0x0100, 0x9c100808 , 0xe0bc782f ) /* sprite lookup table */

	ROM_REGION(0x10000)     /* 64k for audio cpu */
	ROM_LOAD( "sbb_e13.bin", 0x0000, 0x2000, 0x3d1ba1cb , 0x1ec7458b )

	ROM_REGION(0x10000)     /* 64k for speech rom */
	ROM_LOAD( "sbb_e15.bin", 0x0000, 0x2000, 0x1c954ee7 , 0x01bb5ce9 )
ROM_END
