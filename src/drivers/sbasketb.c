...
ROM_START( sbasketb_rom )
	...
	ROM_LOAD( "405e17", 0x0000, 0x0100, 0x79420806 ) /* palette red component */
	ROM_LOAD( "405e16", 0x0100, 0x0100, 0x6fbe000a ) /* palette green component */
	ROM_LOAD( "405e18", 0x0200, 0x0100, 0x2be60502 ) /* palette blue component */
	ROM_LOAD( "405e20", 0x0300, 0x0100, 0x52760d06 ) /* character lookup table */
	ROM_LOAD( "405e19", 0x0400, 0x0100, 0x9c100808 ) /* sprite lookup table */
