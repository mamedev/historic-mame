...
Interrupts:
CPU #1 IRQ generated by coins, detect on audio PCB
CPU #1 FIRQ generated by VBLANK, collision detect, and beam detect
CPU #2 IRQ generated by VSYNC
CPU #2 FIRQ generated by write to sound command register
...
/* globals */
unsigned char exidy440_bank;

/* local variables */
static unsigned char port_0_xor;
static unsigned char port_2_xor;
static unsigned char port_3_xor;
static unsigned char mirror_vblank_bit;
static unsigned char mirror_trigger_bit;
static unsigned char copy_protection_read;
static unsigned char coin_state;
static unsigned char last_coins;

/* local function prototypes */
void exidy440_init_machine(void);

int exidy440_input_r(int offset);
int exidy440_io1_r(int offset);
void exidy440_bankram_w(int offset, int data);
void exidy440_io1_w(int offset, int data);

int exidy440_hiload(void);
void exidy440_hisave(void);

int exidy440_interrupt(void);
int topsecex_interrupt(void);

/* sound driver data & functions */
extern unsigned char exidy440_sound_command;
extern unsigned char exidy440_sound_command_ack;
extern unsigned char *exidy440_m6844_data;
extern unsigned char *exidy440_sound_banks;
...
extern unsigned char *exidy440_imageram;
extern unsigned char *exidy440_latched_x;
extern unsigned char *exidy440_scanline;
extern unsigned char exidy440_firq_vblank;
extern unsigned char exidy440_firq_beam;
extern unsigned char topsecex_yscroll;
...
static struct MemoryReadAddress readmem_cpu1[] =
{
	...
	{ 0x2b03, 0x2b03, exidy440_input_r },
	{ 0x2c00, 0x2dff, exidy440_paletteram_r },
	{ 0x2e00, 0x2eff, exidy440_io1_r },
...
static struct MemoryWriteAddress writemem_cpu1[] =
{
	...
	{ 0x2e00, 0x2eff, exidy440_io1_w },
	{ 0x3000, 0x3fff, MWA_RAM },
	{ 0x4000, 0x7fff, exidy440_bankram_w },
...
/* the generic machine driver */
static struct MachineDriver exidy440_machine_driver =
{
...
/* a modified machine driver for Top Secret */
static struct MachineDriver topsecex_machine_driver =
{
	/* basic machine hardware */
	{
		{
...
struct GameDriver crossbow_driver =
{
	__FILE__,
	0,
	"crossbow",
...
struct GameDriver cheyenne_driver =
{
	__FILE__,
	0,
	"cheyenne",
...
struct GameDriver combat_driver =
{
	__FILE__,
	0,
	"combat",
...
struct GameDriver claypign_driver =
{
	__FILE__,
	0,
	"claypign",
...
struct GameDriver chiller_driver =
{
	__FILE__,
	0,
	"chiller",
...
INPUT_PORTS_START( topsecex_input_ports )
	...
	PORT_START				/* start button */
	PORT_BITX( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3, "Fireball", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0 )
	PORT_BITX( 0x02, IP_ACTIVE_LOW, IPT_BUTTON4, "Laser", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0 )
	PORT_BITX( 0x04, IP_ACTIVE_LOW, IPT_BUTTON5, "Missile", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0 )
	PORT_BITX( 0x08, IP_ACTIVE_LOW, IPT_BUTTON6, "Oil", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0 )
	PORT_BITX( 0x10, IP_ACTIVE_LOW, IPT_BUTTON7, "Turbo", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0 )
	PORT_BITX( 0x20, IP_ACTIVE_LOW, IPT_BUTTON8, "Shield", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0 )
	PORT_BIT(  0x40, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BITX( 0x80, IP_ACTIVE_LOW, IPT_START1, "Top Secret", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0 )
INPUT_PORTS_END


void topsecex_init(void)
{
	port_0_xor = 0xff;
	port_2_xor = 0xff;
	port_3_xor = 0x04;
...
struct GameDriver topsecex_driver =
{
	__FILE__,
	0,
	"topsecex",
...
struct GameDriver hitnmiss_driver =
{
	__FILE__,
	0,
	"hitnmiss",
...
struct GameDriver whodunit_driver =
{
	__FILE__,
	0,
	"whodunit",
...
INPUT_PORTS_START( showdown_input_ports )
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 )
	PORT_DIPNAME( 0x0c, 0x0c, "Hands", IP_KEY_NONE )
...
static int showdown_bank_triggered;
...
int showdown_pld_select1_r(int offset)
{
	...
	{
		static const unsigned char bankdata[0x18] =
		{
			0x15,0x40,0xc1,0x8d,0x4c,0x84,0x0e,0xce,
			0x52,0xd0,0x99,0x48,0x80,0x09,0xc9,0x45,
			0xc4,0x8e,0x5a,0x92,0x18,0xd8,0x51,0xc0
...
struct GameDriver showdown_driver =
{
	__FILE__,
	0,
	"showdown",
...
int topsecex_interrupt(void)
{
	/* generate coin interrupts */
	handle_coins();
	return topsecex_vblank_interrupt();
}
