...
ROM_START( gberet_rom )
	...
	ROM_LOAD( "577h09",      0x00000, 0x0020, 0x6e0aa662 ) /* palette */
	ROM_LOAD( "577h10",      0x00020, 0x0100, 0xf5c40200 ) /* sprites */
	ROM_LOAD( "577h11",      0x00120, 0x0100, 0x1ec60000 ) /* characters */
ROM_END
