...
INPUT_PORTS_START(sf1jp_input_ports)
	...
	PORT_DIPNAME( 0x02, 0x02, "Attract music" )
	...
	PORT_START
	PORT_DIPNAME( 0x07, 0x07, "Continuation max stage" )
	...
	PORT_DIPNAME( 0x18, 0x18, "Round time" )
	...
	*/
	...
	PORT_START
	PORT_DIPNAME( 0x07, 0x07, "Buy-in max stage" )
	PORT_DIPSETTING(    0x07, "5th" )
	PORT_DIPSETTING(    0x06, "4th" )
	PORT_DIPSETTING(    0x05, "3rd" )
	PORT_DIPSETTING(    0x04, "2nd" )
	...
	PORT_DIPNAME( 0x08, 0x08, "Number of start countries" )
	...
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BITX(0x80, 0x00, 0x80, "Freeze", OSD_KEY_F2, IP_JOY_NONE )
