...
{
	palette_set_color(machine,  0, 0x00, 0x00, 0x00);	/* terrain */
	palette_set_color(machine,  1, 0x18, 0x18, 0x18);
	palette_set_color(machine,  2, 0x30, 0x30, 0x30);
	palette_set_color(machine,  3, 0x48, 0x48, 0x48);
	palette_set_color(machine,  4, 0x60, 0x60, 0x60);
	palette_set_color(machine,  5, 0x78, 0x78, 0x78);
	palette_set_color(machine,  6, 0x90, 0x90, 0x90);
	palette_set_color(machine,  7, 0xA8, 0xA8, 0xA8);
	palette_set_color(machine,  8, 0x10, 0x10, 0x10);	/* sprites */
	palette_set_color(machine,  9, 0xE0, 0xE0, 0xE0);
	palette_set_color(machine, 10, 0xA0, 0xA0, 0xA0);
	palette_set_color(machine, 11, 0x48, 0x48, 0x48);
	palette_set_color(machine, 12, 0x10, 0x10, 0x10);
	palette_set_color(machine, 13, 0x48, 0x48, 0x48);
	palette_set_color(machine, 14, 0xA0, 0xA0, 0xA0);
	palette_set_color(machine, 15, 0xE0, 0xE0, 0xE0);
	palette_set_color(machine, 16, 0x00, 0x00, 0x00);	/* missiles */
	palette_set_color(machine, 17, 0xFF, 0xFF, 0xFF);
	palette_set_color(machine, 18, 0x00, 0x00, 0x00);	/* text */
	palette_set_color(machine, 19, 0xE0, 0xE0, 0xE0);
}
