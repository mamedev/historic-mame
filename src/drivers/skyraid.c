...
ROM_START( skyraid )
	...
	ROM_LOAD( "030595.e1", 0x7000, 0x800, 0xc6cb3a2b )
	ROM_RELOAD(            0xF000, 0x800 )
	ROM_LOAD( "030594.d1", 0x7800, 0x800, 0x27979e96 )
	ROM_RELOAD(            0xF800, 0x800 )

	ROM_REGION( 0x0200, REGION_GFX1, ROMREGION_DISPOSE ) /* alpha numerics */
	ROM_LOAD( "030598.h2", 0x0000, 0x200, 0x2a7c5fa0 )

	ROM_REGION( 0x0800, REGION_GFX2, ROMREGION_DISPOSE ) /* sprites */
	ROM_LOAD( "030599.m7", 0x0000, 0x800, 0x0cd179ea )

	ROM_REGION( 0x0100, REGION_GFX3, ROMREGION_DISPOSE ) /* missiles */
	ROM_LOAD_NIB_LOW ( "030597.n5", 0x0000, 0x100, 0x319ff49c )
	ROM_LOAD_NIB_HIGH( "030596.m4", 0x0000, 0x100, 0x30454ed0 )

	ROM_REGION( 0x0800, REGION_USER1, 0 ) /* terrain */
	ROM_LOAD_NIB_LOW ( "030584.j5", 0x0000, 0x800, 0x81f6e8a5 )
	ROM_LOAD_NIB_HIGH( "030585.k5", 0x0000, 0x800, 0xb49bec3f )

	ROM_REGION( 0x0100, REGION_USER2, 0 ) /* trapezoid */
	ROM_LOAD_NIB_LOW ( "030582.a6", 0x0000, 0x100, 0x0eacd595 )
	ROM_LOAD_NIB_HIGH( "030583.b6", 0x0000, 0x100, 0x3edd6fbc )

	ROM_REGION( 0x0300, REGION_PROMS, 0 )
	ROM_LOAD( "006559.c4", 0x0200, 0x100, 0x5a8d0e42 ) /* sync */
ROM_END
