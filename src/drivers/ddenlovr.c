...
93 Animalandia Jr.                          2xZ80   AY8910 +          M6295     NL-004 (x2), NL-003 (x2), NL-001    TMP82C51 (USART)
...
static void do_plot(int x,int y,int pen)
{
	...
	// swap x & y (seen hanakanz gal check)
...
INPUT_PORTS_START( hanakanz )
	...
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_SERVICE4	)	// note
...
//  PORT_DIPSETTING(    0x00, "1" )
	...
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x00, "In Game Sound" )
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
