...
ROM_START( ringrage )
	...
	ROM_LOAD16_BYTE("d21-01.17", 0x400000, 0x200000, CRC(1fb6f07d) SHA1(a7d21d4b0b0b141c4dbe66554e5362e2c8876067) )
	ROM_LOAD16_BYTE("d21-05.18", 0xc00000, 0x100000, CRC(ed894fe1) SHA1(5bf2fb6abdcf25bc525a2c3b29dbf7aca0b18fea) )
ROM_END
...
ROM_START( landmakr )
	...
	ROM_LOAD16_BYTE("e61-06.40", 0x400000, 0x200000, CRC(2e717bfe) SHA1(1be54cd2ec65d8fd49a5c09b5d27791fd7a320d4) )
	ROM_RELOAD(                  0x800000, 0x200000) //fix sound
...
ROM_START( landmkrp )
	...
	ROM_LOAD16_BYTE("snd-4.32", 0xc00000, 0x80000, CRC(e9dc18f6) SHA1(c84920246a9967b155e137893c080bce6850db85) )
	ROM_LOAD16_BYTE("snd-5.33", 0xd00000, 0x80000, CRC(8af91ca8) SHA1(853d2a036602338539cf25e68eac1e686c0861d5) )
	ROM_LOAD16_BYTE("snd-6.34", 0xe00000, 0x80000, CRC(6f520b82) SHA1(c559c80386de08256b2f8cbf198271223a83fdb9) )
	ROM_LOAD16_BYTE("snd-7.35", 0xf00000, 0x80000, CRC(69410f0f) SHA1(ff023842383ce26818ec7361831e122737a9e94b) )
ROM_END
