...
ROM_START( pbobbl2u )
	...
	ROM_REGION16_BE(0x800000, REGION_SOUND1 , ROMREGION_ERASE00 )	// V2: 4 banks, only 2 populated
	ROM_LOAD16_BYTE("e10-04.rom", 0x000000, 0x200000, BAD_DUMP CRC(5c0862a6) SHA1(f916f63b8629239e3221e1e231e1b39962ef38ba) )	// C8 C9 CA CB
	ROM_LOAD16_BYTE("e10-03.rom", 0x400000, 0x200000, BAD_DUMP CRC(46d68ac8) SHA1(ad014e9f0d458308014959ca6823077f581ab088) )	// CC CD CE CF
ROM_END
