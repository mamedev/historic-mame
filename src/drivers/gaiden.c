...
ROM_START( gaiden_rom )
	...
	ROM_LOAD( "14.bin",    0x010000, 0x20000, 0x00d6531c )
	ROM_LOAD( "15.bin",    0x030000, 0x20000, 0xae21271b )
	ROM_LOAD( "16.bin",    0x050000, 0x20000, 0x4dee5eec )
	ROM_LOAD( "17.bin",    0x070000, 0x20000, 0x9e0c7684 )
	ROM_LOAD( "18.bin",    0x090000, 0x20000, 0xc76c8d20 )
	ROM_LOAD( "19.bin",    0x0b0000, 0x20000, 0xc3845b96 )
	ROM_LOAD( "20.bin",    0x0d0000, 0x20000, 0x40e78ca5 )
	ROM_LOAD( "21.bin",    0x0f0000, 0x20000, 0xccdcbd02 )
	ROM_LOAD( "gaiden.6",  0x110000, 0x20000, 0xde50047a )	/* sprites A1 */
	ROM_LOAD( "gaiden.8",  0x130000, 0x20000, 0xc0d813a6 )	/* sprites B1 */
	ROM_LOAD( "gaiden.10", 0x150000, 0x20000, 0xfc2e2818 )	/* sprites C1 */
	ROM_LOAD( "gaiden.12", 0x170000, 0x20000, 0xe7739fed )	/* sprites D1 */
	ROM_LOAD( "gaiden.7",  0x190000, 0x20000, 0x9f40c78e )	/* sprites A2 */
	ROM_LOAD( "gaiden.9",  0x1b0000, 0x20000, 0xdeea0a22 )	/* sprites B2 */
	ROM_LOAD( "gaiden.11", 0x1d0000, 0x20000, 0xfb2d2641 )	/* sprites C2 */
	ROM_LOAD( "gaiden.13", 0x1f0000, 0x20000, 0xbd928520 )	/* sprites D2 */
...
ROM_START( shadoww_rom )
	...
	ROM_LOAD( "gaiden.8",    0x130000, 0x20000, 0xc0d813a6 )	/* sprites B1 */
	ROM_LOAD( "gaiden.10",   0x150000, 0x20000, 0xfc2e2818 )	/* sprites C1 */
	ROM_LOAD( "shadoww.12a", 0x170000, 0x10000, 0xb9da7f3c )	/* sprites D1 */
	ROM_LOAD( "shadoww.12b", 0x180000, 0x10000, 0xe2915fb7 )	/* sprites D1 */
	ROM_LOAD( "gaiden.7",    0x190000, 0x20000, 0x9f40c78e )	/* sprites A2 */
	ROM_LOAD( "gaiden.9",    0x1b0000, 0x20000, 0xdeea0a22 )	/* sprites B2 */
	ROM_LOAD( "gaiden.11",   0x1d0000, 0x20000, 0xfb2d2641 )	/* sprites C2 */
	ROM_LOAD( "shadoww.13a", 0x1f0000, 0x10000, 0x5e66bed4 )	/* sprites D2 */
	ROM_LOAD( "shadoww.13b", 0x200000, 0x10000, 0x8a0508d7 )	/* sprites D2 */
...
ROM_START( tknight_rom )
	ROM_REGION(0x40000)	/* 2*128k for 68000 code */
	ROM_LOAD_EVEN( "tkni1.bin", 0x00000, 0x20000, 0xf9df4597 )
	ROM_LOAD_ODD ( "tkni2.bin", 0x00000, 0x20000, 0x354ec882 )

	ROM_REGION(0x210000)     /* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "tkni5.bin", 0x000000, 0x10000, 0xeda2959c )	/* 8x8 tiles */
	ROM_LOAD( "tkni7.bin", 0x010000, 0x80000, 0xb678d5a4 )
	ROM_LOAD( "tkni6.bin", 0x090000, 0x80000, 0xf9162a62 )
	ROM_LOAD( "tkni9.bin", 0x110000, 0x80000, 0xba0e1e88 )	/* sprites */
	ROM_LOAD( "tkni8.bin", 0x190000, 0x80000, 0xe64f1921 )	/* sprites */

	ROM_REGION(0x10000)	/* 64k for the audio CPU */
	ROM_LOAD( "tkni3.bin", 0x0000, 0x10000, 0x29949050 )   /* Audio CPU is a Z80  */

	ROM_REGION(0x20000)	/* 128k for ADPCM samples - sound chip is OKIM6295 */
	ROM_LOAD( "tkni4.bin", 0x0000, 0x20000, 0x7767d549 ) /* samples */
ROM_END
