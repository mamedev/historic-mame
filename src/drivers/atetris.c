...
INPUT_PORTS_START( ports )
        ...
        PORT_BITX(0x04, 0x00, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Freeze", OSD_KEY_5, IP_JOY_NONE )
        PORT_DIPSETTING(0x00, DEF_STR( Off ) )
        PORT_DIPSETTING(0x04, DEF_STR( On ) )
        PORT_BITX(0x08, IP_ACTIVE_HIGH, IPT_SERVICE, "Freeze Step", OSD_KEY_6, IP_JOY_NONE )
