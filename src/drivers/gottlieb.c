...
INPUT_PORTS_START( reactor_input_ports )
	...
	PORT_START	/* IN1 */
	PORT_BITX(0x01, IP_ACTIVE_HIGH, IPT_SERVICE, "Select in Service Mode", OSD_KEY_F1, IP_JOY_NONE )
	PORT_BITX(0x02, 0x02, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Service Mode", OSD_KEY_F2, IP_JOY_NONE )
...
INPUT_PORTS_START( mplanets_input_ports )
	PORT_START	/* DSW */
	PORT_DIPNAME( 0x08, 0x00, "Round Select" )
	PORT_DIPSETTING(    0x00, "Off" )
	PORT_DIPSETTING(    0x08, "On" )
	PORT_DIPNAME( 0x01, 0x00, "Demo Sounds" )
	PORT_DIPSETTING(    0x01, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x14, 0x00, "Coinage" )
	PORT_DIPSETTING(    0x04, "2 Coins/1 Credit" )
	PORT_DIPSETTING(    0x00, "1 Coin/1 Credit" )
	PORT_DIPSETTING(    0x10, "1 Coin/2 Credits" )
	PORT_DIPSETTING(    0x14, "Free Play" )
	PORT_DIPNAME( 0x20, 0x00, "Lives" )
	PORT_DIPSETTING(    0x00, "3" )
	PORT_DIPSETTING(    0x20, "5" )
	PORT_DIPNAME( 0x02, 0x00, "Bonus Life" )
	PORT_DIPSETTING(    0x00, "10000" )
	...
	PORT_BITX(0x40, IP_ACTIVE_HIGH, IPT_SERVICE, "Select in Service Mode", OSD_KEY_F1, IP_JOY_NONE )
...
INPUT_PORTS_START( qbert_input_ports )
	...
	PORT_DIPSETTING(    0x01, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x10, 0x00, "Free Play" )
	PORT_DIPSETTING(    0x00, "Off" )
...
/* 0x40 must be connected to the IP16 line */
	...
	PORT_DIPSETTING (   0x00, "On" )
	PORT_BITX(0x80, IP_ACTIVE_HIGH, IPT_SERVICE, "Select in Service Mode", OSD_KEY_F1, IP_JOY_NONE )
...
INPUT_PORTS_START( qbertqub_input_ports )
	...
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x35, 0x00, "Coinage" )
...
/* 0x25 "2 Coins/1 Credit"
   ...
   0x34 "Free Play" */
	...
	PORT_DIPNAME( 0x80, 0x00, "Difficulty" )
...
INPUT_PORTS_START( krull_input_ports )
	...
	PORT_DIPSETTING(    0x01, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_BITX(0x02, IP_ACTIVE_HIGH, IPT_SERVICE, "Select in Service Mode", OSD_KEY_F1, IP_JOY_NONE )
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN1 )
	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN2 )
	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN )
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN )
...
INPUT_PORTS_START( mach3_input_ports )
	...
	PORT_DIPNAME( 0x09, 0x08, "Coinage" )
	PORT_DIPSETTING(    0x08, "2 Coins/1 Credit" )
	PORT_DIPSETTING(    0x01, "3 Coins/1 Credit" )
	PORT_DIPSETTING(    0x09, "4 Coins/1 Credit" )
	PORT_DIPSETTING(    0x00, "Free Play" )
	PORT_DIPNAME( 0x10, 0x00, "Lives" )
	PORT_DIPSETTING(    0x00, "3" )
	PORT_DIPSETTING(    0x10, "5" )
	PORT_DIPNAME( 0x24, 0x00, "Bonus Life" )
	...
	PORT_DIPSETTING(    0x00, "Normal" )
	PORT_DIPSETTING(    0x02, "Hard" )
	PORT_DIPNAME( 0x40, 0x40, "Demo Sounds" )
	PORT_DIPSETTING(    0x00, "Off" )
	PORT_DIPSETTING(    0x40, "On" )
...
INPUT_PORTS_START( usvsthem_input_ports )
	PORT_START      /* DSW0 */
	/* TODO: values are different for 5 lives */
	PORT_DIPNAME( 0x09, 0x00, "Coinage" )
	PORT_DIPSETTING(    0x00, "1 Coin/1 Credit" )
	PORT_DIPSETTING(    0x08, "2 Coins/1 Credit" )
...
INPUT_PORTS_START( stooges_input_ports )
	...
	PORT_DIPSETTING (   0x00, "Normal" )
	PORT_DIPSETTING (   0x02, "Hard" )
	PORT_DIPNAME (0x40, 0x00, "Bonus Life At" )
...
INPUT_PORTS_START( curvebal_input_ports )
	...
	PORT_DIPNAME( 0x11, 0x00, "Difficulty" )
