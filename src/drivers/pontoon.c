...
INPUT_PORTS_START( input_ports )
	...
	PORT_BITX(0x20, IP_ACTIVE_LOW,  0, "Start Hopper", OSD_KEY_7, IP_JOY_NONE, 0)
	...
	PORT_BITX(0x20, IP_ACTIVE_LOW,  IPT_BUTTON1, "Hit", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 0)
	...
	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN )	/* Token Out */
