...
GAME( 1982, kram,     0,        mcu,     kram,     0, ROT0,   "Taito America Corporation", "Kram (set 1)" )
GAME( 1982, kram2,    kram,     mcu,     kram,     0, ROT0,   "Taito America Corporation", "Kram (set 2)" )
GAME( 1982, zookeep,  0,        zookeep, zookeep,  0, ROT0,   "Taito America Corporation", "Zoo Keeper (set 1)" )
GAME( 1982, zookeep2, zookeep,  zookeep, zookeep,  0, ROT0,   "Taito America Corporation", "Zoo Keeper (set 2)" )
GAME( 1982, zookeep3, zookeep,  zookeep, zookeep,  0, ROT0,   "Taito America Corporation", "Zoo Keeper (set 3)" )
