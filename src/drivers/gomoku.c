...
ROM_START( gomoku )
	...
	ROM_LOAD( "rj_1.7a",      0x0000, 0x1000, 0xed20d539 )
	ROM_LOAD( "rj_2.7c",      0x1000, 0x1000, 0x26a28516 )
	ROM_LOAD( "rj_3.7d",      0x2000, 0x1000, 0xd05db072 )
	ROM_LOAD( "rj_4.7f",      0x3000, 0x1000, 0x6e3d1c18 )

	ROM_REGION( 0x1000, REGION_GFX1, ROMREGION_DISPOSE )	// text char
	ROM_LOAD( "rj_6.4r",      0x0000, 0x1000, 0xed26ae36 )

	ROM_REGION( 0x1000, REGION_SOUND1, 0 )	// sound
	ROM_LOAD( "rj_7.3c",      0x0000, 0x1000, 0xd1ed1365 )

	ROM_REGION( 0x0040, REGION_PROMS, 0 )
	ROM_LOAD( "rj_prom.1m",   0x0000, 0x0020, 0x5da2f2bd )	// TEXT color
	ROM_LOAD( "rj_prom.1l",   0x0020, 0x0020, 0xfe4ef393 )	// BG color

	ROM_REGION( 0x0100, REGION_USER1, 0 )	// BG draw data X
	ROM_LOAD( "rj_prom.8n",   0x0000, 0x0100, 0x9ba43222 )

	ROM_REGION( 0x0100, REGION_USER2, 0 )	// BG draw data Y
	ROM_LOAD( "rj_prom.7p",   0x0000, 0x0100, 0x5b5464f8 )

	ROM_REGION( 0x0100, REGION_USER3, 0 )	// BG character data
	ROM_LOAD( "rj_prom.7r",   0x0000, 0x0100, 0x3004585a )

	ROM_REGION( 0x0800, REGION_USER4, 0 )	// program ?
	ROM_LOAD( "rj_5.4e",      0x0000, 0x0800, 0xeaf541b4 )

	ROM_REGION( 0x0020, REGION_USER5, 0 )	// –³‚¢‚Æ‹N“®‚¹‚¸
	ROM_LOAD( "rj_prom.9k",   0x0000, 0x0020, 0xcff72923 )
ROM_END
