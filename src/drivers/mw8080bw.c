...
static WRITE8_HANDLER( seawolf_periscope_lamp_w )
{
	...
	output_set_value("TORP_LAMP_4", data & 0x01);
	output_set_value("TORP_LAMP_3", data & 0x02);
	output_set_value("TORP_LAMP_2", data & 0x04);
	output_set_value("TORP_LAMP_1", data & 0x08);

	output_set_value("READY_LAMP",  data & 0x10);

	output_set_value("RELOAD_LAMP", data & 0x20);
}


static UINT32 seawolf_controller_input_r(void *param)
{
	static const UINT32 gray_code_5_bit[] =
	{
		0,  1,  3,  2,  6,  7,  5,  4,
	...
	return gray_code_5_bit[readinputportbytag(SEAWOLF_GUN_PORT_TAG)];
}
...
static INPUT_PORTS_START( seawolf )
	PORT_START_TAG("IN0")
	PORT_BIT( 0x1f, IP_ACTIVE_HIGH, IPT_SPECIAL ) PORT_CUSTOM(seawolf_controller_input_r, 0)
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON1 ) PORT_PLAYER(1)
	PORT_DIPNAME( 0xc0, 0x40, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("G4:1,2")
	PORT_DIPSETTING(    0x00, "60 seconds + 20 extended" )
	PORT_DIPSETTING(    0x40, "70 seconds + 20 extended" )
	PORT_DIPSETTING(    0x80, "80 seconds + 20 extended" )
	PORT_DIPSETTING(    0xc0, "90 seconds + 20 extended" )

	PORT_START_TAG("IN1")
	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 )
	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_START1 )
	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( Coinage ) ) PORT_DIPLOCATION("G4:3,4")
	...
	/* 2 fakes port for the 'Reset High Score' input, which has a DIP to enable it */
	...
	PORT_DIPNAME( 0x01, 0x01, "Enable Reset High Score" ) PORT_DIPLOCATION("G4:5")
...
static UINT32 gunfight_gun_input_r(void *param)
{
	static const UINT32 gray_code_3_bit[] =
	{
		1, 5, 7, 3, 2, 6, 4, 0
	};
	...
	return gray_code_3_bit[normal_binary];
}
...
static INPUT_PORTS_START( gunfight )
	...
	PORT_BIT( 0x70, IP_ACTIVE_HIGH, IPT_SPECIAL ) PORT_CUSTOM(gunfight_gun_input_r, GUNFIGHT_GUN_P1_PORT_TAG)
	...
	PORT_BIT( 0x70, IP_ACTIVE_HIGH, IPT_SPECIAL ) PORT_CUSTOM(gunfight_gun_input_r, GUNFIGHT_GUN_P2_PORT_TAG)
	...
	PORT_START_TAG(GUNFIGHT_GUN_P1_PORT_TAG)
	PORT_BIT( 0xff, 0x80, IPT_PADDLE ) PORT_MINMAX(0x01,0xff) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CENTERDELTA(0) PORT_CODE_DEC(KEYCODE_N) PORT_CODE_INC(KEYCODE_H) PORT_PLAYER(1)

	PORT_START_TAG(GUNFIGHT_GUN_P2_PORT_TAG)
	PORT_BIT( 0xff, 0x80, IPT_PADDLE ) PORT_MINMAX(0x01,0xff) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CENTERDELTA(0) PORT_CODE_DEC(KEYCODE_M) PORT_CODE_INC(KEYCODE_J) PORT_PLAYER(2)
INPUT_PORTS_END
...
static INPUT_PORTS_START( tornbase )
	...
	PORT_DIPNAME( 0x80, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("B1:7")
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	...
	PORT_DIPNAME ( 0x78, 0x40, DEF_STR( Coinage ) ) PORT_DIPLOCATION("B1:2,3,4,5")
	...
	PORT_DIPNAME( 0x03, TORNBASE_CAB_TYPE_UPRIGHT_NEW, DEF_STR( Cabinet ) )
	PORT_DIPSETTING( TORNBASE_CAB_TYPE_UPRIGHT_OLD, "Upright/w One Hit Button" )
	PORT_DIPSETTING( TORNBASE_CAB_TYPE_UPRIGHT_NEW, "Upright/w P1/P2 Hit Buttons" )
	PORT_DIPSETTING( TORNBASE_CAB_TYPE_COCKTAIL, DEF_STR( Cocktail ) )
...
static INPUT_PORTS_START( zzzap )
	...
	PORT_DIPSETTING(    0x0c, "60 seconds + 30 extended" )
	PORT_DIPSETTING(    0x00, "80 seconds + 40 extended" )
	PORT_DIPSETTING(    0x08, "99 seconds + 50 extended" )
	PORT_DIPSETTING(    0x04, "Test Mode" )
	PORT_DIPNAME( 0x30, 0x00, "Extended Time At" ) PORT_DIPLOCATION("E3:5,6")
	PORT_DIPSETTING(    0x10, "2.00" )
	PORT_DIPSETTING(    0x00, "2.50" )
	PORT_DIPSETTING(    0x20, DEF_STR( None ) )
	/* PORT_DIPSETTING( 0x30, DEF_STR( None ) ) */
	PORT_DIPNAME( 0xc0, 0x00, DEF_STR( Language )) PORT_DIPLOCATION("E3:7,8")
...
static INPUT_PORTS_START( lagunar )
	...
	PORT_DIPSETTING(    0x03, DEF_STR( 2C_3C ) )
	PORT_DIPSETTING(    0x01, DEF_STR( 1C_2C ) )
	PORT_DIPNAME( 0x0c, 0x04, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("E3:3,4")
	PORT_DIPSETTING(    0x00, "45 seconds + 22 extended" )
	PORT_DIPSETTING(    0x04, "60 seconds + 30 extended" )
	PORT_DIPSETTING(    0x08, "75 seconds + 37 extended" )
	PORT_DIPSETTING(    0x0c, "90 seconds + 45 extended" )
	PORT_DIPNAME( 0x30, 0x20, "Extended Time At" ) PORT_DIPLOCATION("E3:5,6")
	PORT_DIPSETTING(    0x00, "350" )
	PORT_DIPSETTING(    0x10, "400" )
	PORT_DIPSETTING(    0x20, "450" )
	PORT_DIPSETTING(    0x30, "500" )
	PORT_DIPNAME( 0xc0, 0x00, "Test Modes") PORT_DIPLOCATION("E3:7,8")
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
...
static INPUT_PORTS_START( maze )
	...
	PORT_DIPNAME ( 0x30, 0x00, DEF_STR( Coinage ) ) PORT_DIPLOCATION("SW:1,2")
	PORT_DIPSETTING (    0x10, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING (    0x00, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING (    0x30, DEF_STR( 2C_3C ) )
	PORT_DIPSETTING (    0x20, DEF_STR( 1C_2C ) )
	PORT_DIPNAME ( 0x40, 0x40, "2 Player Game Time" ) PORT_DIPLOCATION("SW:3")
...
static UINT32 boothill_gun_input_r(void *param)
{
...
static INPUT_PORTS_START( boothill )
	...
	PORT_BIT( 0x70, IP_ACTIVE_HIGH, IPT_SPECIAL ) PORT_CUSTOM(boothill_gun_input_r, BOOTHILL_GUN_P2_PORT_TAG)
	...
	PORT_BIT( 0x70, IP_ACTIVE_HIGH, IPT_SPECIAL ) PORT_CUSTOM(boothill_gun_input_r, BOOTHILL_GUN_P1_PORT_TAG)
	...
	PORT_DIPNAME ( 0x0c, 0x04, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("SW:3,4")
	PORT_DIPSETTING (    0x00, "60 seconds" )
	...
	/* fake ports for aiming the guns */
	PORT_START_TAG(BOOTHILL_GUN_P2_PORT_TAG)
	PORT_BIT( 0xff, 0x80, IPT_PADDLE ) PORT_MINMAX(0x01,0xff) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_M) PORT_CODE_INC(KEYCODE_J) PORT_CENTERDELTA(0) PORT_PLAYER(2)

	PORT_START_TAG(BOOTHILL_GUN_P1_PORT_TAG)
	PORT_BIT( 0xff, 0x80, IPT_PADDLE ) PORT_MINMAX(0x01,0xff) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_N) PORT_CODE_INC(KEYCODE_H) PORT_CENTERDELTA(0) PORT_PLAYER(1)

	PORT_START_TAG("MUSIC_ADJ")  /* 5 */
...
static INPUT_PORTS_START( checkmat )
	...
	PORT_START_TAG("IN2")
	PORT_DIPNAME ( 0x01, 0x00, DEF_STR( Coinage ) ) PORT_DIPLOCATION("A4:1")
	PORT_DIPSETTING (    0x00, "1 Coin/1 or 2 Players" )
	PORT_DIPSETTING (    0x01, "1 Coin/1 or 2 Players, 2 Coins/3 or 4 Players" )
	PORT_DIPNAME ( 0x02, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("A4:2")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x02, DEF_STR( On ) )
	PORT_DIPNAME ( 0x0c, 0x04, "Rounds" ) PORT_DIPLOCATION("A4:3,4")
	PORT_DIPSETTING (    0x00, "2" )
	PORT_DIPSETTING (    0x04, "3" )
	PORT_DIPSETTING (    0x08, "4" )
	PORT_DIPSETTING (    0x0c, "5" )
	PORT_DIPNAME ( 0x10, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("A4:5")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x10, DEF_STR( On ) )
	PORT_DIPNAME ( 0x60, 0x00, DEF_STR( Language ) ) PORT_DIPLOCATION("A4:6,7")
	PORT_DIPSETTING (    0x00, DEF_STR( English ) )
...
static UINT32 desertgu_gun_input_r(void *param)
{
	...
	if (desertgun_get_controller_select())
	{
...
static INPUT_PORTS_START( desertgu )
	...
	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( Language ) ) PORT_DIPLOCATION("C2:5,6")
	PORT_DIPSETTING(    0x00, DEF_STR( English ) )
	...
	PORT_DIPNAME( 0x03, 0x00, DEF_STR( Coinage ) ) PORT_DIPLOCATION("C2:1,2")
	PORT_DIPSETTING(    0x02, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING(    0x00, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(    0x03, DEF_STR( 2C_3C ) )
	PORT_DIPSETTING(    0x01, DEF_STR( 1C_2C ) )
	...
	PORT_DIPNAME( 0x03, 0x01, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("C2:3,4")
...
static INPUT_PORTS_START( dplay )
	...
	PORT_START_TAG("IN2")
	PORT_DIPNAME ( 0x07, 0x00, DEF_STR( Coinage )) PORT_DIPLOCATION("C1:1,2,3")
	...
	PORT_DIPNAME ( 0x08, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("C1:4")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x08, DEF_STR( On ) )
	PORT_DIPNAME ( 0x10, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("C1:5")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x10, DEF_STR( On ) )
	PORT_DIPNAME ( 0x20, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("C1:6")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	...
	PORT_DIPNAME( 0x01, DPLAY_CAB_TYPE_UPRIGHT, DEF_STR( Cabinet ) )
	PORT_DIPSETTING( DPLAY_CAB_TYPE_UPRIGHT, DEF_STR( Upright ) )
	PORT_DIPSETTING( DPLAY_CAB_TYPE_COCKTAIL, DEF_STR( Cocktail ) )
	PORT_BIT( 0xfe, IP_ACTIVE_HIGH, IPT_UNUSED )
...
static INPUT_PORTS_START( einning )
	...
	/* PORT_DIPSETTING ( 0x07, "1 Coin per Inning" ) */
	PORT_DIPSETTING (    0x01, "1 Coin/1 Inning, 2 Coins/3 Innings" )
	PORT_DIPNAME ( 0x08, 0x00, "Wall Knock Out Behavior" ) PORT_DIPLOCATION("C1:4")
	PORT_DIPSETTING (    0x00, "Individually" )
	PORT_DIPSETTING (    0x08, "In Pairs" )
	PORT_DIPNAME ( 0x10, 0x00, "Double Score when Special Lit" ) PORT_DIPLOCATION("C1:5")
...
static INPUT_PORTS_START( gmissile )
	...
	PORT_START_TAG("IN2")
	PORT_DIPNAME ( 0x03, 0x03, DEF_STR( Coinage ) ) PORT_DIPLOCATION("D1:1,2")
	...
	PORT_DIPNAME ( 0x0c, 0x08, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("D1:3,4")
	...
	PORT_DIPSETTING (    0x0c, "90 seconds + 45 extended" )
	PORT_DIPNAME ( 0x30, 0x10, "Extended Time At" ) PORT_DIPLOCATION("D1:5,6")
	PORT_DIPSETTING (    0x00, "500" )
	PORT_DIPSETTING (    0x20, "700" )
	PORT_DIPSETTING (    0x10, "1000" )
	PORT_DIPSETTING (    0x30, "1300" )
	PORT_DIPNAME ( 0x40, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("D1:7")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
...
static INPUT_PORTS_START( m4 )
	...
	PORT_START_TAG("IN2")
	PORT_DIPNAME ( 0x03, 0x00, DEF_STR( Coinage ) ) PORT_DIPLOCATION("C1:1,2")
	PORT_DIPSETTING (    0x02, "2 Coins per Player" )
	PORT_DIPSETTING (    0x03, "2 Coins/1 or 2 Players" )
	PORT_DIPSETTING (    0x00, "1 Coin per Player" )
	PORT_DIPSETTING (    0x01, "1 Coin/1 or 2 Players" )
	PORT_DIPNAME ( 0x0c, 0x04, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("C1:3,4")
	PORT_DIPSETTING (    0x00, "60 seconds" )
	PORT_DIPSETTING (    0x04, "70 seconds" )
	PORT_DIPSETTING (    0x08, "80 seconds" )
	PORT_DIPSETTING (    0x0c, "90 seconds" )
	PORT_SERVICE_DIPLOC( 0x10, IP_ACTIVE_LOW, "C1:5" )
	PORT_DIPNAME ( 0x20, 0x00, DEF_STR( Unknown ) ) PORT_DIPLOCATION("C1:6")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x20, DEF_STR( On ) )
	PORT_DIPNAME ( 0x40, 0x00, DEF_STR( Unknown ) ) PORT_DIPLOCATION("C1:7")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x40, DEF_STR( On ) )
	PORT_DIPNAME ( 0x80, 0x00, DEF_STR( Unknown ) ) PORT_DIPLOCATION("C1:8")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x40, DEF_STR( On ) )
INPUT_PORTS_END
...
static UINT32 clowns_controller_r(void *param)
{
	...
	if (clowns_get_controller_select())
	{
...
static INPUT_PORTS_START( clowns )
	...
	PORT_DIPSETTING (    0x00, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING (    0x01, DEF_STR( 1C_2C ) )
	PORT_DIPNAME ( 0x0c, 0x00, "Bonus Game" ) PORT_DIPLOCATION("SW:3,4")
	PORT_DIPSETTING (    0x00, "No Bonus" )
	PORT_DIPSETTING (    0x04, "9000" )
	PORT_DIPSETTING (    0x08, "11000" )
	PORT_DIPSETTING (    0x0c, "13000" )
	PORT_DIPNAME ( 0x10, 0x00, "Balloon Resets" ) PORT_DIPLOCATION("SW:5")
	...
	PORT_DIPNAME ( 0x40, 0x00, DEF_STR( Lives ) ) PORT_DIPLOCATION("SW:7")
...
static INPUT_PORTS_START( shuffle )
	PORT_START_TAG("IN0")
	PORT_DIPNAME ( 0x03, 0x00, DEF_STR( Language ) ) PORT_DIPLOCATION("B3:1,2")
	PORT_DIPSETTING (    0x00, DEF_STR( English ) )
	PORT_DIPSETTING (    0x01, DEF_STR( French ) )
	PORT_DIPSETTING (    0x02, DEF_STR( German ) )
	/* PORT_DIPSETTING ( 0x03, DEF_STR( German ) ) */
	PORT_DIPNAME ( 0x0c, 0x04, "Points to Win" ) PORT_DIPLOCATION("B3:3,4")
...
static INPUT_PORTS_START( dogpatch )
	...
	PORT_START_TAG("IN2")
	PORT_DIPNAME ( 0x03, 0x02, "Number of Cans" ) PORT_DIPLOCATION("SW:1,2")
	...
	PORT_DIPNAME ( 0x10, 0x10, "Extended Time Reward" ) PORT_DIPLOCATION("SW:5")
	PORT_DIPSETTING (    0x10, "3 extra cans" )
	PORT_DIPSETTING (    0x00, "5 extra cans" )
	PORT_SERVICE_DIPLOC( 0x20, IP_ACTIVE_LOW, "SW:6" )
	PORT_DIPNAME ( 0xc0, 0x40, "Extended Time At" ) PORT_DIPLOCATION("SW:7,8")
...
static UINT32 spcenctr_stick_input_r(void *param)
{
	...
	UINT32 normal_binary = readinputportbytag(tag);

	return gray_code_6_bit[normal_binary] ^ 0x3f;
}
...
static INPUT_PORTS_START( spcenctr )
	PORT_START_TAG("IN0")
	PORT_BIT( 0x3f, IP_ACTIVE_HIGH, IPT_SPECIAL ) PORT_CUSTOM(spcenctr_stick_input_r, SPCENCTR_STICK_X_PORT_TAG)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(1)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 )

	PORT_START_TAG("IN1")
	PORT_BIT( 0x3f, IP_ACTIVE_HIGH, IPT_SPECIAL ) PORT_CUSTOM(spcenctr_stick_input_r, SPCENCTR_STICK_Y_PORT_TAG)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED )  /* not connected */
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )  /* marked as COIN #2, but the software never reads it */

	PORT_START_TAG("IN2")
	PORT_DIPNAME( 0x03, 0x02, DEF_STR( Bonus_Life ) ) PORT_DIPLOCATION("F3:1,2")
	...
	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( Coinage ) ) PORT_DIPLOCATION("F3:3,4")
	PORT_DIPSETTING(    0x04, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING(    0x00, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(    0x0c, DEF_STR( 2C_3C ) )
	PORT_DIPSETTING(    0x08, DEF_STR( 1C_3C ) )
	...
	PORT_DIPNAME( 0xc0, 0x40, "Time" ) PORT_DIPLOCATION("F3:7,8")
	PORT_DIPSETTING(    0x00, "45" )
	PORT_DIPSETTING(    0x40, "60" )
	PORT_DIPSETTING(    0x80, "75" )
	PORT_DIPSETTING(    0xc0, "90" )

	/* fake ports for the joystick */
	PORT_START_TAG(SPCENCTR_STICK_X_PORT_TAG)
	PORT_BIT( 0x3f, 0x1f, IPT_AD_STICK_X ) PORT_MINMAX(0,0x3f) PORT_SENSITIVITY(10) PORT_KEYDELTA(10) PORT_REVERSE PORT_PLAYER(1)
	PORT_BIT( 0xc0, IP_ACTIVE_HIGH, IPT_UNUSED )

	PORT_START_TAG(SPCENCTR_STICK_Y_PORT_TAG)
	PORT_BIT( 0x3f, 0x1f, IPT_AD_STICK_Y ) PORT_MINMAX(0,0x3f) PORT_SENSITIVITY(10) PORT_KEYDELTA(10) PORT_PLAYER(1)
	PORT_BIT( 0xc0, IP_ACTIVE_HIGH, IPT_UNUSED )
INPUT_PORTS_END
...
static INPUT_PORTS_START( phantom2 )
	...
	PORT_DIPSETTING (    0x01, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING (    0x00, DEF_STR( 1C_1C ) )
	PORT_DIPNAME ( 0x06, 0x06, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("SW:2,3")
	...
	PORT_DIPNAME ( 0x08, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("SW:4")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x08, DEF_STR( On ) )
	PORT_DIPNAME ( 0x10, 0x00, DEF_STR( Unused ) ) PORT_DIPLOCATION("SW:5")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x10, DEF_STR( On ) )
	PORT_SERVICE_DIPLOC( 0x20, IP_ACTIVE_LOW, "SW:6" )
...
static INPUT_PORTS_START( bowler )
	...
	PORT_DIPSETTING (    0x02, DEF_STR( German ) )
	/*PORT_DIPSETTING (  0x03, DEF_STR( German ) ) */
	PORT_DIPNAME ( 0x04, 0x04, DEF_STR( Demo_Sounds ) ) PORT_DIPLOCATION("B3:3")
	PORT_DIPSETTING (    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x04, DEF_STR( On ) )  /* every 17 minutes */
	PORT_DIPNAME ( 0x08, 0x08, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("B3:4")
	PORT_DIPSETTING (    0x00, "No Limit" )
	PORT_DIPSETTING (    0x08, "5 Minutes" )
	PORT_DIPNAME ( 0x10, 0x00, DEF_STR( Coinage ) ) PORT_DIPLOCATION("B3:5")
	PORT_DIPSETTING (    0x10, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING (    0x00, DEF_STR( 1C_1C ) )
	PORT_DIPNAME ( 0x20, 0x20, DEF_STR( Difficulty ) ) PORT_DIPLOCATION("B3:6")
	PORT_DIPSETTING (    0x20, DEF_STR( Easy ) )
	PORT_DIPSETTING (    0x00, DEF_STR( Hard ) )
	PORT_DIPNAME ( 0x40, 0x00, DEF_STR( Cabinet ) ) PORT_DIPLOCATION("B3:7")
...
static INPUT_PORTS_START( blueshrk )
	...
	PORT_DIPNAME ( 0x04, 0x04, DEF_STR( Unused ) ) PORT_DIPLOCATION("SW:3")
	PORT_DIPSETTING (    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x00, DEF_STR( On ) )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_TILT )  /* not shown on the schematics, instead DIP SW4 is connected here */
	PORT_DIPNAME ( 0x10, 0x10, DEF_STR( Unused ) ) PORT_DIPLOCATION("SW:5")
	PORT_DIPSETTING (    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING (    0x00, DEF_STR( On ) )
	PORT_DIPNAME ( 0x60, 0x40, "Replay" ) PORT_DIPLOCATION("SW:6,7")
...
static INPUT_PORTS_START( invad2ct )
	...
	PORT_DIPSETTING(    0x01, DEF_STR( 1C_2C ) )
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_DIPNAME( 0x08, 0x08, DEF_STR( Cabinet ) ) PORT_DIPLOCATION("SW:2") /* this switch changes how score is displayed */
...
/* 596 */ GAME( 1976, seawolf,  0,      seawolf,  seawolf,  0, ROT0,   "Midway", "Sea Wolf", GAME_IMPERFECT_SOUND )
/* 597 */ GAMEL(1975, gunfight, 0,      gunfight, gunfight, 0, ROT0,   "Midway", "Gun Fight", GAME_IMPERFECT_SOUND, layout_hoffff20 )
/* 605 */ GAME( 1976, tornbase, 0,      tornbase, tornbase, 0, ROT0,   "Midway", "Tornado Baseball", GAME_IMPERFECT_SOUND )
/* 610 */ GAME( 1976, 280zzzap, 0,      zzzap,    zzzap,    0, ROT0,   "Midway", "Datsun 280 Zzzap", GAME_NO_SOUND )
/* 611 */ GAMEL(1976, maze,     0,      maze,     maze,     0, ROT0,   "Midway", "Amazing Maze", GAME_NO_SOUND, layout_ho4f893d )
/* 612 */ GAME( 1977, boothill, 0,      boothill, boothill, 0, ROT0,   "Midway", "Boot Hill" , 0 )
/* 615 */ GAME( 1977, checkmat, 0,      checkmat, checkmat, 0, ROT0,   "Midway", "Checkmate", GAME_NO_SOUND )
/* 618 */ GAME( 1977, desertgu, 0,      desertgu, desertgu, 0, ROT0,   "Midway", "Desert Gun", GAME_IMPERFECT_SOUND )
/* 619 */ GAME( 1977, dplay,    0,      dplay,    dplay,    0, ROT0,   "Midway", "Double Play", GAME_IMPERFECT_SOUND )
/* 622 */ GAME( 1977, lagunar,  0,      zzzap,    lagunar,  0, ROT90,  "Midway", "Laguna Racer", GAME_NO_SOUND )
/* 623 */ GAME( 1977, gmissile, 0,      gmissile, gmissile, 0, ROT0,   "Midway", "Guided Missile", GAME_IMPERFECT_SOUND )
/* 626 */ GAME( 1977, m4,       0,      m4,       m4,       0, ROT0,   "Midway", "M-4", GAME_IMPERFECT_SOUND )
/* 630 */ GAMEL(1978, clowns,   0,      clowns,   clowns,   0, ROT0,   "Midway", "Clowns (rev. 2)", GAME_IMPERFECT_SOUND, layout_clowns )
/* 630 */ GAMEL(1978, clowns1,  clowns, clowns,   clowns1,  0, ROT0,   "Midway", "Clowns (rev. 1)", GAME_IMPERFECT_SOUND, layout_clowns )
/* 640 Space Walk (dump does not exist) */
/* 642 */ GAME( 1978, einning,  0,      dplay,    einning,  0, ROT0,   "Midway", "Extra Inning", GAME_IMPERFECT_SOUND )
/* 643 */ GAME( 1978, shuffle,  0,      shuffle,  shuffle,  0, ROT90,  "Midway", "Shuffleboard", GAME_NO_SOUND )
/* 644 */ GAME( 1977, dogpatch, 0,      dogpatch, dogpatch, 0, ROT0,   "Midway", "Dog Patch", GAME_IMPERFECT_SOUND )
/* 645 */ GAME( 1980, spcenctr, 0,      spcenctr, spcenctr, 0, ROT0,   "Midway", "Space Encounters", GAME_IMPERFECT_SOUND )
/* 652 */ GAMEL(1979, phantom2, 0,      phantom2, phantom2, 0, ROT0,   "Midway", "Phantom II", GAME_IMPERFECT_SOUND, layout_hoa0a0ff )
/* 730 */ GAME( 1978, bowler,   0,      bowler,   bowler,   0, ROT90,  "Midway", "Bowling Alley", GAME_NO_SOUND )
/* 739 */ GAMEL(1978, invaders, 0,      invaders, invaders, 0, ROT270, "Midway", "Space Invaders", GAME_IMPERFECT_SOUND, layout_invaders )
/* 742 */ GAME( 1978, blueshrk, 0,      blueshrk, blueshrk, 0, ROT0,   "Midway", "Blue Shark", GAME_IMPERFECT_SOUND )
/* 749 4 Player Bowling Alley (cocktail, dump does not exist) */
/* 851 */ GAMEL(1980, invad2ct, 0,      invad2ct, invad2ct, 0, ROT90,  "Midway", "Space Invaders II (Midway, cocktail)", 0, layout_invad2ct )
