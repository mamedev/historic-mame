...
ROM_START( narc )
	ROM_REGIONX( 0x100000, REGION_CPU1 )     /*34010 code */
	...
	ROM_REGIONX( 0x50000, REGION_CPU3 )     /* slave sound CPU */
...
GAME( 1992, mk,       0,       mk,      mk,      mk,       ROT0_16BIT, "Midway",   "Mortal Kombat (rev 3.0 08/31/92)" )
...
GAME( 1991, term2,    0,       term2,   term2,   term2,    ROT0_16BIT, "Midway",   "Terminator 2 - Judgment Day (rev LA3 03/27/92)" )
...
GAMEX(1993, nbajam,   0,       nbajam,  nbajam,  nbajam,   ROT0_16BIT, "Midway",   "NBA Jam", GAME_NOT_WORKING )
