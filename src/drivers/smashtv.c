...
INPUT_PORTS_START( narc_input_ports )
	...
	PORT_BITX(0x10, IP_ACTIVE_LOW,  0, "Advance", OSD_KEY_F2, IP_JOY_NONE )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "Vault Switch", OSD_KEY_7, IP_JOY_NONE )
...
INPUT_PORTS_START( trog_input_ports )
	...
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_TILT ) /* Slam Switch */
	PORT_BITX(0x10, IP_ACTIVE_LOW,  0, "Test", OSD_KEY_F2, IP_JOY_NONE )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "Service Credit", OSD_KEY_9, IP_JOY_NONE )
...
INPUT_PORTS_START( smashtv_input_ports )
	...
	PORT_BITX(0x10, IP_ACTIVE_LOW,  0, "Test", OSD_KEY_F2, IP_JOY_NONE )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "Service Credit", OSD_KEY_7, IP_JOY_NONE )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN3 ) /* coin3 */
...
INPUT_PORTS_START( term2_input_ports )
	...
	PORT_START	    /* IN4 */
	PORT_ANALOG( 0xff, 0x00, IPT_TRACKBALL_X|IPF_REVERSE, 10, 10, 0x0f, 0, 0xff)
