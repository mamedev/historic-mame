...
static void kangaroo_init_machine(void)
{
	...
	/* NMI short after power on, so that masked the bug? The NMI is generated */
...
ROM_START( kangaroo_rom )
	...
	ROM_LOAD( "tvg75.bin", 0x0000, 0x1000, 0xc79eeb0a )
	ROM_LOAD( "tvg76.bin", 0x1000, 0x1000, 0x1f254c59 )
	...
	ROM_LOAD( "tvg83.bin", 0x10000, 0x1000, 0x5da33f11 )	/* graphics ROMs */
	ROM_LOAD( "tvg85.bin", 0x11000, 0x1000, 0x6450024c )
	ROM_LOAD( "tvg84.bin", 0x12000, 0x1000, 0x6d872ead )
