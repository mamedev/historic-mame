...
ROM_START( popeye_rom )
	...
	ROM_LOAD( "popeye.pr1",  0x0000, 0x0020, 0xda51a083 ) /* background palette */
	ROM_LOAD( "popeye.pr2",  0x0020, 0x0020, 0x6ad20000 ) /* char palette */
	ROM_LOAD( "popeye.pr3",  0x0040, 0x0100, 0xa15c0000 ) /* sprite palette - low 4 bits */
	ROM_LOAD( "popeye.pr4",  0x0140, 0x0100, 0xf4bc0e00 ) /* sprite palette - high 4 bits */
ROM_END
