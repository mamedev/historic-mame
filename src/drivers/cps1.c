...
INPUT_PORTS_START( forgottn_input_ports )
	...
	PORT_START      /* DSWA */
	PORT_DIPNAME( 0xff, 0xff, "DIP A" )
	PORT_DIPSETTING(    0xff, "Off" )
	PORT_DIPSETTING(    0x00, "On" )

	PORT_START      /* DSWB */
	PORT_DIPNAME( 0xff, 0xff, "DIP B" )
	PORT_DIPSETTING(    0xff, "Off" )
	PORT_DIPSETTING(    0x00, "On" )

	PORT_START      /* DSWC */
	PORT_DIPNAME( 0xff, 0xff, "DIP C" )
	PORT_DIPSETTING(    0xff, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
...
INPUT_PORTS_START( ghouls_input_ports )
	...
	PORT_DIPSETTING(    0x00, "Off" )
	PORT_DIPSETTING(    0x08, "On" )
	PORT_DIPNAME( 0x10, 0x10, "Flip Screen" )
...
INPUT_PORTS_START( strider_input_ports )
	...
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x08, 0x08, "Free Play" )
...
INPUT_PORTS_START( willow_input_ports )
	...
	PORT_DIPNAME( 0x20, 0x20, "Unknown" ) /* Unused ? */
	PORT_DIPSETTING(    0x20, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x40, 0x20, "Unknown" ) /* Unused ? */
	PORT_DIPSETTING(    0x40, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
...
INPUT_PORTS_START( ffight_input_ports )
	...
	PORT_DIPSETTING(    0x00, "Hardest" )
	PORT_DIPNAME( 0x60, 0x60, "Bonus Life" )
...
INPUT_PORTS_START( mercs_input_ports )
	...
	PORT_DIPSETTING(    0x04, "1 Coin/4 Credits" )
	PORT_DIPSETTING(    0x03, "1 Coin/6 Credits" )
	PORT_DIPNAME( 0x38, 0x38, "Unknown" )
	...
	PORT_START      /* DSWC */
	PORT_DIPNAME( 0x07, 0x07, "Unknown" )
	PORT_DIPSETTING(    0x00, "0" )
...
INPUT_PORTS_START( cawing_input_ports )
	...
	PORT_START      /* DSWB */
	PORT_DIPNAME( 0x07, 0x07, "Difficulty Level 1" )
	PORT_DIPSETTING(    0x07, "Very Easy" )
...
INPUT_PORTS_START( sf2_input_ports )
	...
	PORT_START      /* DSWC */
	PORT_DIPNAME( 0x03, 0x03, "Unknown" )
	PORT_DIPSETTING(    0x00, "1" )
	PORT_DIPSETTING(    0x03, "2" )
	PORT_DIPSETTING(    0x02, "3" )
	PORT_DIPSETTING(    0x01, "4" )
...
INPUT_PORTS_START( pnickj_input_ports )
	...
	PORT_DIPSETTING(    0x08, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x30, 0x30, "Unknown" )
	PORT_DIPSETTING(    0x00, "1" )
	PORT_DIPSETTING(    0x10, "2" )
...
INPUT_PORTS_START( megaman_input_ports )
	...
	PORT_START      /* DSWA */
	PORT_DIPNAME( 0x1f, 0x1f, "Coinage" )
...
#define MACHINE_DRIVER(CPS1_DRVNAME, CPS1_IRQ, CPS1_CPU_FRQ) \
	MACHINE_DRV(CPS1_DRVNAME, CPS1_IRQ, 2, CPS1_CPU_FRQ)
...
MACHINE_DRV   ( forgottn,  cps1_interrupt, 1, CPS1_DEFAULT_CPU_SLOW_SPEED )
MACHINE_DRV   ( ghouls,    cps1_interrupt, 1, CPS1_DEFAULT_CPU_SLOW_SPEED )
MACHINE_DRIVER( strider,   cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( dwj,       cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( willow,    cps1_interrupt2, CPS1_DEFAULT_CPU_SLOW_SPEED )
MACHINE_DRIVER( unsquad,   cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( ffight,    cps1_interrupt2, 10000000 )  /* 10 MHz */
MACHINE_DRIVER( c1941,     cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( mercs,     cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( mtwins,    cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( msword,    cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( cawing,    cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( nemo,      cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRV   ( sf2,       cps1_interrupt3, 1, 12000000 )   /* 12 MHz */
MACHINE_DRIVER( c3wonders, cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( kod,       cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
MACHINE_DRIVER( captcomm,  cps1_interrupt2, CPS1_DEFAULT_CPU_SPEED )
