...
ROM_START( taotaido )
	...
	ROM_LOAD16_WORD_SWAP( "1-u90.bin", 0x00000, 0x80000, 0xa3ee30da )
	ROM_LOAD16_WORD_SWAP( "2-u91.bin", 0x80000, 0x80000, 0x30b7e4fb )

	ROM_REGION( 0x30000, REGION_CPU2, 0 ) /* z80 Code */
	ROM_LOAD( "3-u113.bin", 0x000000, 0x20000, 0xa167c4e4 )
	ROM_RELOAD ( 0x10000, 0x20000 )

	ROM_REGION( 0x100000, REGION_SOUND1, 0 ) /* sound samples */
	ROM_LOAD( "u104.bin",     0x000000, 0x100000, 0xe89387a9 )

	ROM_REGION( 0x200000, REGION_SOUND2, 0 ) /* sound samples */
	ROM_LOAD( "u127.bin",     0x00000, 0x200000, 0x0cf0cb23 )

	ROM_REGION( 0x600000, REGION_GFX1, 0 ) /* Sprites */
	ROM_LOAD( "u86.bin", 0x000000, 0x200000, 0x908e251e )
	ROM_LOAD( "u87.bin", 0x200000, 0x200000, 0xc4290ba6 )
	ROM_LOAD( "u88.bin", 0x400000, 0x200000, 0x407d9aeb )

	ROM_REGION( 0x200000, REGION_GFX2, 0 ) /* BG Tiles */
	ROM_LOAD( "u15.bin", 0x000000, 0x200000, 0xe95823e9 )
ROM_END

ROM_START( taotaida )
	ROM_REGION( 0x100000, REGION_CPU1, 0 ) /* 68000 Code */
	ROM_LOAD16_WORD_SWAP( "tt0-u90.bin", 0x00000, 0x80000, 0x69d4cca7 )
	ROM_LOAD16_WORD_SWAP( "tt1-u91.bin", 0x80000, 0x80000, 0x41025469 )
