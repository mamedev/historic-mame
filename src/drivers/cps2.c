...
ROM_START( mshvsf )
	...
	ROM_LOAD_WIDE_SWAP("mvsu.06a", 0x180000, 0x80000, 0x959f3030 )
	ROM_LOAD_WIDE_SWAP("mvsu.07b", 0x200000, 0x80000, 0x7f915bdb )
	ROM_LOAD_WIDE_SWAP("mvsu.08a", 0x280000, 0x80000, 0xc2813884 )
	ROM_LOAD_WIDE_SWAP("mvsu.09b", 0x300000, 0x80000, 0x3ba08818 )
	ROM_LOAD_WIDE_SWAP("mvsu.10b", 0x380000, 0x80000, 0xcf0dba98 )
...
ROM_START( xmvsf )
	...
	ROM_LOAD_WIDE_SWAP("xvsu.07",  0x200000, 0x80000, 0x08f0abed )
	ROM_LOAD_WIDE_SWAP("xvsu.08",  0x280000, 0x80000, 0x81929675 )
	ROM_LOAD_WIDE_SWAP("xvsu.09",  0x300000, 0x80000, 0x9641f36b )
...
static struct MachineDriver machine_driver_cpsx =
{
	/* basic machine hardware */
	{
		{
...
ROM_START( sfex )
	ROM_REGION( CODE_SIZE, REGION_CPU2 )      /* PSX code */
	...
	ROM_REGION( QSOUND_SIZE, REGION_CPU1 ) /* 64k for the audio CPU (+banks) */
...
GAME( 199?, sfex, 0, cpsx, cps2, 0, ROT0, "Capcom", "Street Fighter EX" )
