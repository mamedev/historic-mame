...
void init_cps2(void)
{
    ...
    if (cps_getversion() == 99)
    {
		...
		*/
		rom[0x0000/2] = 0x00ff;
		rom[0x0002/2] = 0x8000;  /* Dummy stack pointer */
		rom[0x0004/2] = 0x0000;
		rom[0x0006/2] = 0x00c2;  /* Dummy start vector */
		...
		rom[0x00c0/2] = 0x4e73;   /* RETE */
		rom[0x00c2/2] = 0x6000;
		rom[0x00c4/2] = 0x00c2;   /* BRA 00c2 */
...
ROM_START( 19xxh )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "19xhx.03a", XOR_BASE+0x000000, 0x80000, 0x374ce871 )
	ROM_LOAD16_WORD_SWAP( "19xhx.04a", XOR_BASE+0x080000, 0x80000, 0xebd16e33 )
	ROM_LOAD16_WORD_SWAP( "19xhx.05a", XOR_BASE+0x100000, 0x80000, 0x0bb5ad27 )
	ROM_LOAD16_WORD_SWAP( "19xhx.06a", XOR_BASE+0x180000, 0x80000, 0x3663c8d2 )
...
ROM_START( armwar )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pwgux.03b", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "pwgux.04b", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( pgear )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pwgjx.03a", XOR_BASE+0x000000, 0x80000, 0xcf0284a9 )
	ROM_LOAD16_WORD_SWAP( "pwgjx.04a", XOR_BASE+0x080000, 0x80000, 0x99437cf1 )
...
ROM_START( pgearr1 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pwgjx.03", XOR_BASE+0x000000, 0x80000, 0xebd9e371 )
	ROM_LOAD16_WORD_SWAP( "pwgjx.04", XOR_BASE+0x080000, 0x80000, 0xe05a4756 )
...
ROM_START( armwara )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pwgax.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "pwgax.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( avspj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "avpjx.03d", XOR_BASE+0x000000, 0x80000, 0x94095fb0 )
	ROM_LOAD16_WORD_SWAP( "avpjx.04d", XOR_BASE+0x080000, 0x80000, 0xa56b00ae )
...
ROM_START( batcirj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "btcjx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "btcjx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "btcjx.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "btcjx.06", XOR_BASE+0x180000, 0x80000, 0x00000000 )
...
ROM_START( batcira )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "btcax.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "btcax.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "btcax.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "btcax.06", XOR_BASE+0x180000, 0x80000, 0x00000000 )
...
ROM_START( cybotsj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "cybjx.03", XOR_BASE+0x000000, 0x80000, 0x867c9acd )
	ROM_LOAD16_WORD_SWAP( "cybjx.04", XOR_BASE+0x080000, 0x80000, 0x57ed677f )
...
ROM_START( ddtodj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "dadjx.03a", XOR_BASE+0x000000, 0x80000, 0x4c7334d3 )
	ROM_LOAD16_WORD_SWAP( "dadjx.04a", XOR_BASE+0x080000, 0x80000, 0xcfd15109 )
	ROM_LOAD16_WORD_SWAP( "dadjx.05a", XOR_BASE+0x100000, 0x80000, 0xd23bcd71 )
...
ROM_START( ddsom )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "dd2ux.03d", XOR_BASE+0x000000, 0x80000, 0x5cecbdb3 )
	ROM_LOAD16_WORD_SWAP( "dd2ux.04d", XOR_BASE+0x080000, 0x80000, 0x1307a77d )
...
ROM_START( ddsomj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "dd2jx.03b", XOR_BASE+0x000000, 0x80000, 0xa63488bb )
	ROM_LOAD16_WORD_SWAP( "dd2jx.04b", XOR_BASE+0x080000, 0x80000, 0xe3ff7985 )
...
ROM_START( dimahoo )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "gmdux.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
...
ROM_START( gmahou )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "gmdjx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
...
ROM_START( ecofe )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "uecex.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "uecex.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "uecex.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "uecex.06", XOR_BASE+0x180000, 0x80000, 0x00000000 )
...
ROM_START( uecology )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "uecej.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "uecej.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "uecej.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "uecej.06", XOR_BASE+0x180000, 0x80000, 0x00000000 )
...
ROM_START( gwingj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "ggwjx.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "ggwjx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( mmatrixj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mmxjx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mmxjx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mmxjx.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
...
ROM_START( mshh )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mshhx.03c", XOR_BASE+0x000000, 0x80000, 0x6daf52bb )
	ROM_LOAD16_WORD_SWAP( "mshhx.04c", XOR_BASE+0x080000, 0x80000, 0x5684655a )
...
ROM_START( mshvsf )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mvsux.03d", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mvsux.04d", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( mshvsfj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mvsjx.03i", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mvsjx.04i", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( mshvsfj1 )
	...
	ROM_LOAD16_WORD_SWAP( "mvsj.05g", 0x100000, 0x80000, 0x9515a245 )
	ROM_LOAD16_WORD_SWAP( "mvs.06a",  0x180000, 0x80000, 0x959f3030 )
	ROM_LOAD16_WORD_SWAP( "mvs.07b",  0x200000, 0x80000, 0x7f915bdb )
	ROM_LOAD16_WORD_SWAP( "mvs.08a",  0x280000, 0x80000, 0xc2813884 )
	ROM_LOAD16_WORD_SWAP( "mvs.09b",  0x300000, 0x80000, 0x3ba08818 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mvsjx.03h", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mvsjx.04h", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( mvsc )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mvcux.03d", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mvcux.04d", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( mvscj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mvcjx.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mvcjx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( mvscjr1 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mvcjx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mvcjx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( mvsch )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "mvchx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "mvchx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( nwarr )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "vphux.03f", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "vphux.04c", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "vphux.05e", XOR_BASE+0x100000, 0x80000, 0x00000000 )
...
ROM_START( vhuntj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "vphjx.03b", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "vphjx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "vphjx.05a", XOR_BASE+0x100000, 0x80000, 0x00000000 )
...
ROM_START( rckman2j )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "rm2jx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "rm2jx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "rm2jx.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
...
ROM_START( sfzj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfzjx.03c", XOR_BASE+0x000000, 0x80000, 0xd6b17a9b )
...
ROM_START( sfzjr1 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfzjx.03b", XOR_BASE+0x000000, 0x80000, 0xb501f03c )
...
ROM_START( sfzjr2 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfzjx.03a", XOR_BASE+0x000000, 0x80000, 0x3cc138b5 )
...
ROM_START( sfz2 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sz2jx.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sz2jx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( sfz2a )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "szajx.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "szajx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( sfa3 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sz3ux.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sz3ux.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( sfz3 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sz3jx.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sz3jx.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( sfz3r1 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sz3jx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sz3jx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( sgemf )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pcfux.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
...
ROM_START( pfghtj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pcfjx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
...
ROM_START( sgemfh )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pcfhx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
...
ROM_START( smbomber )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "smbjx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "smbjx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "smbjx.05", XOR_BASE+0x100000, 0x80000, 0x00000000 )
...
ROM_START( spf2t )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pzfux.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
...
ROM_START( spf2xj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "pzfjx.03a", XOR_BASE+0x000000, 0x80000, 0xc2e3f231 )
...
ROM_START( ssf2j )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "ssfjx.03b", XOR_BASE+0x000000, 0x80000, 0x693985dd )
	ROM_LOAD16_WORD_SWAP( "ssfjx.04a", XOR_BASE+0x080000, 0x80000, 0xf866d34a )
	ROM_LOAD16_WORD_SWAP( "ssfjx.05",  XOR_BASE+0x100000, 0x80000, 0x7282bb56 )
	ROM_LOAD16_WORD_SWAP( "ssfjx.06b", XOR_BASE+0x180000, 0x80000, 0xc597bc4a )
	ROM_LOAD16_WORD_SWAP( "ssfjx.07",  XOR_BASE+0x200000, 0x80000, 0x2af7cab2 )
...
ROM_START( ssf2jr1 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "ssfjx.03a", XOR_BASE+0x000000, 0x80000, 0xc1b1d0c1 )
	ROM_LOAD16_WORD_SWAP( "ssfjx.04a", XOR_BASE+0x080000, 0x80000, 0xf866d34a )
	ROM_LOAD16_WORD_SWAP( "ssfjx.05",  XOR_BASE+0x100000, 0x80000, 0x7282bb56 )
	ROM_LOAD16_WORD_SWAP( "ssfjx.06",  XOR_BASE+0x180000, 0x80000, 0xcc027506 )
	ROM_LOAD16_WORD_SWAP( "ssfjx.07",  XOR_BASE+0x200000, 0x80000, 0x2af7cab2 )
...
ROM_START( ssf2jr2 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "ssfjx.03", XOR_BASE+0x000000, 0x80000, 0xc3eca34c )
	ROM_LOAD16_WORD_SWAP( "ssfjx.04", XOR_BASE+0x080000, 0x80000, 0x4e1080c2 )
	ROM_LOAD16_WORD_SWAP( "ssfjx.05", XOR_BASE+0x100000, 0x80000, 0x7282bb56 )
	ROM_LOAD16_WORD_SWAP( "ssfjx.06", XOR_BASE+0x180000, 0x80000, 0xcc027506 )
	ROM_LOAD16_WORD_SWAP( "ssfjx.07", XOR_BASE+0x200000, 0x80000, 0x2af7cab2 )
...
ROM_START( vhunt2 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "vh2jx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "vh2jx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( vsav2 )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "vs2jx.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "vs2jx.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( xmcotajr )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "xmnox.03a", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "xmnox.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( xmvsf )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "xvsux.03h", XOR_BASE+0x000000, 0x80000, 0x1539c639 )
	ROM_LOAD16_WORD_SWAP( "xvsux.04h", XOR_BASE+0x080000, 0x80000, 0x68916b3f )
...
ROM_START( xmvsfj )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "xvsjx.03d", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "xvsjx.04d", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
ROM_START( xmvsfa )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "xvsax.03", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "xvsax.04", XOR_BASE+0x080000, 0x80000, 0x00000000 )
...
GAMEX(1996, 19xxj,    19xx,    cps2, 19xx,    cps2, ROT270,       "Capcom", "19XX: The War Against Destiny (Japan 951207)", GAME_NOT_WORKING )
GAME( 1996, 19xxh,    19xx,    cps2, 19xx,    cps2, ROT270,       "Capcom", "19XX: The War Against Destiny (Hispanic 951218)" )
GAMEX(1994, armwar,   0,       cps2, avsp,    cps2, ROT0_16BIT,   "Capcom", "Armoured Warriors (US 941024)", GAME_NOT_WORKING )
...
GAMEX(1994, armwara,  armwar,  cps2, avsp,    cps2, ROT0_16BIT,   "Capcom", "Armoured Warriors (Asia 940920)", GAME_NOT_WORKING )
...
GAMEX(1998, sfa3,     0,       cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Alpha 3 (US 980629)", GAME_NOT_WORKING )
GAMEX(1998, sfz3,     sfa3,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Zero 3 (Japan 980727)", GAME_NOT_WORKING )
GAMEX(1998, sfz3r1,   sfa3,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Street Fighter Zero 3 (Japan 980629)", GAME_NOT_WORKING )
...
GAMEX(1994, xmcotajr, xmcota,  cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "X-Men: Children of the Atom (Japan 941208 rent version)", GAME_NOT_WORKING )
