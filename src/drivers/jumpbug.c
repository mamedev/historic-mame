...
ROM_START( jumpbug_rom )
	...
	ROM_LOAD( "jb1", 0x0000, 0x1000, 0x79963f12 , 0x415aa1b7 )
	ROM_LOAD( "jb2", 0x1000, 0x1000, 0xa43443aa , 0xb1c27510 )
	ROM_LOAD( "jb3", 0x2000, 0x1000, 0xbaf5db29 , 0x97c24be2 )
	ROM_LOAD( "jb4", 0x3000, 0x1000, 0x48f5b817 , 0x66751d12 )
	ROM_LOAD( "jb5", 0x8000, 0x1000, 0x817144dd , 0xe2d66faf )
	ROM_LOAD( "jb6", 0x9000, 0x1000, 0x58440d82 , 0x49e0bdfd )
	ROM_LOAD( "jb7", 0xa000, 0x1000, 0xef8ff5ab , 0x690025ee )

	ROM_REGION_DISPOSE(0x3000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "jbi", 0x0000, 0x0800, 0x5857c05d , 0x7749b111 )
	ROM_LOAD( "jbj", 0x0800, 0x0800, 0xdd2b5d5b , 0x06e8d7df )
	ROM_LOAD( "jbk", 0x1000, 0x0800, 0x53ddcbb5 , 0xb8dbddf3 )
	ROM_LOAD( "jbl", 0x1800, 0x0800, 0x66b19093 , 0x9a091b0a )
	ROM_LOAD( "jbm", 0x2000, 0x0800, 0x7bac88f8 , 0x8a0fc082 )
	ROM_LOAD( "jbn", 0x2800, 0x0800, 0x3bdc2b52 , 0x155186e0 )
ROM_END

ROM_START( jbugsega_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "jb1.prg", 0x0000, 0x4000, 0xecb42886 , 0xb223fca9 )
	ROM_LOAD( "jb2.prg", 0x8000, 0x2800, 0x14302ed6 , 0x1b2eb25f )
