...
{
	{ 1, 0x000000, &tiles_8x8_04,	32*16*0, 32  }, // [0] Scroll 0
	{ 1, 0x040000, &tiles_8x8_04,	32*16*1, 32  }, // [1] Scroll 1
	{ 1, 0x080000, &tiles_8x8_01,	32*16*2, 32  }, // [2] Scroll 2
	{ 1, 0x090000, &road_layout_1M,	32*16*3, 64  }, // [3] Road 0
	{ 1, 0x090000, &road_layout_1M,	32*16*5, 64  }, // [4] Road 1
	{ 2, 0x000000, &tiles_16x16_4M,	32*16*7, 128 }, // [5] Sprites
	{ -1 }
};
...
{
	{ 1, 0x000000, &tiles_8x8_08,	0x0000, 16  }, // [0] Scroll 0
	{ 1, 0x080000, &tiles_8x8_08,	0x0100, 16  }, // [1] Scroll 1
	{ 1, 0x100000, &tiles_8x8_02,	0x0200, 16  }, // [2] Scroll 2
	{ 1, 0x120000, &road_layout_2M,	0x0300, 64  }, // [3] Road 0
	{ 1, 0x320000, &road_layout_1M,	0x0700, 64  }, // [4] Road 1
	{ 2, 0x000000, &tiles_16x16_5M,	0x0b00, 128 }, // [5] Sprites
	{ -1 }
};
...
ROM_START( cischeat )
	...
	ROM_REGION_DISPOSE(0x190000)	/* Region 1 - temporary for gfx roms */
	ROM_LOAD( "ch9071.a14",  0x000000, 0x040000, 0x7a6d147f ) // scroll 0
	ROM_LOAD( "ch9071.t74",  0x040000, 0x040000, 0x735a2e25 ) // scroll 1
	ROM_LOAD( "ch9071.07",   0x080000, 0x010000, 0x3724ccc3 ) // scroll 2
	ROM_LOAD( "ch9073.r21",  0x090000, 0x080000, 0x2943d2f6 ) // Road
	ROM_LOAD( "ch9073.r22",  0x110000, 0x080000, 0x2dd44f85 )

	ROM_REGION_DISPOSE(0x400000)		/* Region 2 - sprites */
	...
	ROM_REGION(0x100000)			/* Region 8 - second halves of program ROMs */
...
/* Sprites unpacking - For the Sprite Manager */
{
	...
	cischeat_untangle_sprites(2);	// Untangle sprites (region 2)
	astyanax_rom_decode(3);			// Decrypt sound cpu code (cpu 3)
}
...
ROM_START( f1gpstar )
	...
	ROM_REGION_DISPOSE(0x420000)	/* Region 1 - temporary for gfx roms */
	ROM_LOAD( "90015-31.r56",  0x000000, 0x080000, 0x0c8f0e2b ) // scroll 0
	ROM_LOAD( "90015-32.r57",  0x080000, 0x080000, 0x9c921cfb ) // scroll 1
	ROM_LOAD( "9188a-30.v10",  0x100000, 0x020000, 0x0ef1fbf1 ) // scroll 2
	ROM_LOAD( "90015-05.w10",  0x120000, 0x080000, 0x8eb48a23 ) // Road 0
	ROM_LOAD( "90015-06.w11",  0x1a0000, 0x080000, 0x32063a68 )
	ROM_LOAD( "90015-07.w12",  0x220000, 0x080000, 0x0d0d54f3 )
	ROM_LOAD( "90015-08.w14",  0x2a0000, 0x080000, 0xf48a42c5 )
	ROM_LOAD( "90015-09.w13",  0x320000, 0x080000, 0x55f49315 ) // Road 1
	ROM_LOAD( "90015-10.w15",  0x3a0000, 0x080000, 0x678be0cb )

	ROM_REGION_DISPOSE(0x500000)		/* Region 2 - sprites */
	...
	ROM_REGION(0x80000)				/* Region 8 - second halves of program ROMs */
