...
ROM_START( cischeat )
	...
	ROM_REGIONX( 0x010000, REGION_GFX3 | REGIONFLAG_DISPOSE )
	...
	ROM_REGIONX( 0x400000, REGION_GFX5 | REGIONFLAG_DISPOSE )	/* sprites */
	...
	ROM_REGIONX( 0x80000, REGION_SOUND1 )	/* samples */
	ROM_LOAD( "ch9071.r23", 0x000000, 0x080000, 0xc7dbb992 ) // 2 x 0x40000

	ROM_REGIONX( 0x80000, REGION_SOUND2 )	/* samples */
...
ROM_START( f1gpstar )
	...
	ROM_REGIONX( 0x80000, REGION_USER1 )	/* second halves of program ROMs */
	...
	ROM_REGIONX( 0x200000, REGION_GFX4 | REGIONFLAG_DISPOSE )
	...
	ROM_REGIONX( 0x100000, REGION_GFX5 | REGIONFLAG_DISPOSE )
	ROM_LOAD( "90015-09.w13",  0x000000, 0x080000, 0x55f49315 ) // Road 1
	ROM_LOAD( "90015-10.w15",  0x080000, 0x080000, 0x678be0cb )

	ROM_REGIONX( 0x500000, REGION_GFX6 | REGIONFLAG_DISPOSE )	/* sprites */
