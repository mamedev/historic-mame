...
INPUT_PORTS_START( skydiver_input_ports )
	...
	PORT_START		/* fake port, gets mapped to Sky Diver ports */
	PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNKNOWN, "(D) OPT SW NEXT TEST", OSD_KEY_D, IP_JOY_NONE )
	PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_UNKNOWN, "(F) OPT SW", OSD_KEY_F, IP_JOY_NONE )
	PORT_BITX(0x04, IP_ACTIVE_LOW, IPT_UNKNOWN, "(E) OPT SW", OSD_KEY_E, IP_JOY_NONE )
	PORT_BITX(0x08, IP_ACTIVE_LOW, IPT_UNKNOWN, "(H) OPT SW DIAGNOSTICS", OSD_KEY_H, IP_JOY_NONE )
	...
	PORT_DIPNAME( 0x10, 0x00, "Hard/Easy" )
	...
	PORT_START		/* fake port, gets mapped to Sky Diver ports */
	PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_SERVICE | IPF_TOGGLE, "Self Test", OSD_KEY_F2, IP_JOY_NONE )
