...
INPUT_PORTS_START( skydiver_input_ports )
	...
	PORT_START		/* fake port, gets mapped to Sky Diver ports */
	PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNKNOWN, "(D) OPT SW NEXT TEST", OSD_KEY_D, IP_JOY_NONE, 0 )
	PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_UNKNOWN, "(F) OPT SW", OSD_KEY_F, IP_JOY_NONE, 0 )
	PORT_BITX(0x04, IP_ACTIVE_LOW, IPT_UNKNOWN, "(E) OPT SW", OSD_KEY_E, IP_JOY_NONE, 0 )
	PORT_BITX(0x08, IP_ACTIVE_LOW, IPT_UNKNOWN, "(H) OPT SW DIAGNOSTICS", OSD_KEY_H, IP_JOY_NONE, 0 )
	PORT_BIT (0x10, IP_ACTIVE_LOW, IPT_START1 )
	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_COIN1 | IPF_IMPULSE, IP_NAME_DEFAULT, IP_KEY_DEFAULT, IP_JOY_DEFAULT, 1 )
	PORT_BIT (0x40, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_COIN2 | IPF_IMPULSE, IP_NAME_DEFAULT, IP_KEY_DEFAULT, IP_JOY_DEFAULT, 1 )

	PORT_START		/* fake port, gets mapped to Sky Diver ports */
	PORT_DIPNAME( 0x03, 0x00, "Misses", IP_KEY_NONE )
	PORT_DIPSETTING(	0x00, "3 Misses" )
	PORT_DIPSETTING(	0x01, "4 Misses" )
	PORT_DIPSETTING(	0x02, "5 Misses" )
	PORT_DIPSETTING(	0x03, "6 Misses" )
	PORT_DIPNAME( 0x0C, 0x00, "Coins", IP_KEY_NONE )
	PORT_DIPSETTING(	0x00, "Free Play" )
	PORT_DIPSETTING(	0x04, "1 Coin 2 Plays" )
	PORT_DIPSETTING(	0x08, "1 Coin 1 Play" )
	PORT_DIPSETTING(	0x0C, "2 Coins 1 Play" )
	PORT_DIPNAME( 0x10, 0x00, "Hard/Easy", IP_KEY_NONE )
	PORT_DIPSETTING(	0x00, "Hard" )
	PORT_DIPSETTING(	0x10, "Easy" )
	PORT_DIPNAME( 0x20, 0x00, "Extended Play", IP_KEY_NONE )
	...
	PORT_START		/* fake port, gets mapped to Sky Diver ports */
	PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_SERVICE | IPF_TOGGLE, "Self Test", OSD_KEY_F2, IP_JOY_NONE, 0 )
