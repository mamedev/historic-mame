...
ROM_START( dowild_rom )
	...
	ROM_LOAD( "w1", 0x0000, 0x2000, 0xaeac2454 , 0x097de78b )
	ROM_LOAD( "w3", 0x4000, 0x2000, 0x54fca40a , 0xfc6a1cbb )
	ROM_LOAD( "w4", 0x6000, 0x2000, 0xb549e115 , 0x8aac1d30 )
	ROM_LOAD( "w2", 0x8000, 0x2000, 0x443cb69e , 0x0914ab69 )

	ROM_REGION_DISPOSE(0xc000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "w5", 0x0000, 0x4000, 0x2df6441e , 0xb294b151 )
	ROM_LOAD( "w6", 0x4000, 0x2000, 0x2b17a47b , 0x57e0208b )
	ROM_LOAD( "w7", 0x6000, 0x2000, 0xa68f1277 , 0x5001a6f7 )
	ROM_LOAD( "w8", 0x8000, 0x2000, 0xff188768 , 0xec503251 )
	ROM_LOAD( "w9", 0xa000, 0x2000, 0xfec01f0c , 0xaf7bd7eb )

	ROM_REGION(0x0100)	/* color prom */
	ROM_LOAD( "dowild.clr", 0x0000, 0x0100, 0xd0599f79 , 0xa703dea5 )

	ROM_REGION(0x10000)	/* 64k for the second CPU */
	ROM_LOAD( "w10", 0x0000, 0x4000, 0x431c3ca4 , 0xd1f37fba )
ROM_END

ROM_START( jjack_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "j1.bin", 0x0000, 0x2000, 0xcd2da76d , 0x87f29bd2 )
	ROM_LOAD( "j3.bin", 0x4000, 0x2000, 0xaadcd8e6 , 0x35b0517e )
	ROM_LOAD( "j4.bin", 0x6000, 0x2000, 0x9306bcd2 , 0x35bb316a )
	ROM_LOAD( "j2.bin", 0x8000, 0x2000, 0x1c2c2a84 , 0xdec52e80 )

	ROM_REGION_DISPOSE(0xc000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "j5.bin", 0x0000, 0x4000, 0xe4549bd8 , 0x75038ff9 )
	ROM_LOAD( "j6.bin", 0x4000, 0x2000, 0x62d40f3c , 0x5937bd7b )
	ROM_LOAD( "j7.bin", 0x6000, 0x2000, 0x2e94b664 , 0xcf8ae8e7 )
	ROM_LOAD( "j8.bin", 0x8000, 0x2000, 0x0914de92 , 0x84f6fc8c )
	ROM_LOAD( "j9.bin", 0xa000, 0x2000, 0xd5d6f378 , 0x3f9bb09f )

	ROM_REGION(0x0400)	/* proms */
	ROM_LOAD( "bprom1.bin", 0x0000, 0x0200, 0x337ebd08 , 0x2f0955f2 ) /* color prom */
	ROM_LOAD( "bprom2.bin", 0x0200, 0x0200, 0xb72016ca , 0x2747ca77 ) /* ??? */

	ROM_REGION(0x10000)	/* 64k for the second CPU */
	ROM_LOAD( "j0.bin", 0x0000, 0x4000, 0x25a030a6 , 0xab042f04 )
ROM_END

ROM_START( dorunrun_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "2764.p1", 0x0000, 0x2000, 0x8ce02038 , 0x95c86f8e )
	ROM_LOAD( "2764.l1", 0x4000, 0x2000, 0x8a8056e4 , 0xe9a65ba7 )
	ROM_LOAD( "2764.k1", 0x6000, 0x2000, 0xafdb2121 , 0xb1195d3d )
	ROM_LOAD( "2764.n1", 0x8000, 0x2000, 0xffaac0aa , 0x6a8160d1 )

	ROM_REGION_DISPOSE(0xc000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "27128.a3", 0x0000, 0x4000, 0x62269746 , 0x4be96dcf )
	ROM_LOAD( "2764.m4", 0x4000, 0x2000, 0xd51d97c3 , 0x4bb231a0 )
	ROM_LOAD( "2764.l4", 0x6000, 0x2000, 0x423b4513 , 0x0c08508a )
	ROM_LOAD( "2764.j4", 0x8000, 0x2000, 0xe53d66a5 , 0x79287039 )
	ROM_LOAD( "2764.h4", 0xa000, 0x2000, 0xf652c7f0 , 0x523aa999 )

	ROM_REGION(0x0100)	/* color prom */
	ROM_LOAD( "dorunrun.clr", 0x0000, 0x0100, 0x6cce092a , 0xd5bab5d5 )

	ROM_REGION(0x10000)	/* 64k for the second CPU */
	ROM_LOAD( "27128.p7", 0x0000, 0x4000, 0x0f9be91f , 0x8b06d461 )
ROM_END

ROM_START( spiero_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "sp1.bin", 0x0000, 0x2000, 0xcc3428ee , 0x08d23e38 )
	ROM_LOAD( "sp3.bin", 0x4000, 0x2000, 0xcc45a37d , 0xfaa0c18c )
	ROM_LOAD( "sp4.bin", 0x6000, 0x2000, 0xc9964244 , 0x639b4e5d )
	ROM_LOAD( "sp2.bin", 0x8000, 0x2000, 0x8e065230 , 0x3a29ccb0 )

	ROM_REGION_DISPOSE(0xc000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "sp5.bin", 0x0000, 0x4000, 0x81ddb357 , 0x1b704bb0 )
	ROM_LOAD( "sp6.bin", 0x4000, 0x2000, 0x5dc7b99b , 0x00f893a7 )
	ROM_LOAD( "sp7.bin", 0x6000, 0x2000, 0x37eb2d0d , 0x173e5c6a )
	ROM_LOAD( "sp8.bin", 0x8000, 0x2000, 0x08e60916 , 0x2e66525a )
	ROM_LOAD( "sp9.bin", 0xa000, 0x2000, 0xff4c1b7e , 0x9c571525 )

	ROM_REGION(0x0400)	/* proms */
	ROM_LOAD( "bprom1.bin", 0x0000, 0x0200, 0x265118c5 , 0xfc1b66ff ) /* color prom */
	ROM_LOAD( "bprom2.bin", 0x0200, 0x0200, 0xb72016ca , 0x2747ca77 ) /* ??? */

	ROM_REGION(0x10000)	/* 64k for the second CPU */
	ROM_LOAD( "sp0.bin", 0x0000, 0x4000, 0x0f9be91f , 0x8b06d461 )
ROM_END

ROM_START( kickridr_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "k1", 0x0000, 0x2000, 0xbc77e7f3 , 0xdfdd1ab4 )
	ROM_LOAD( "k3", 0x4000, 0x2000, 0x299a68c4 , 0x412244da )
	ROM_LOAD( "k4", 0x6000, 0x2000, 0xe4e2c6a0 , 0xa67dd2ec )
	ROM_LOAD( "k2", 0x8000, 0x2000, 0x1325e773 , 0xe193fb5c )

	ROM_REGION_DISPOSE(0xc000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "k5", 0x0000, 0x4000, 0x197f8237 , 0x3f7d7e49 )
	ROM_LOAD( "k6", 0x4000, 0x2000, 0xdc19cfbf , 0x94252ed3 )
	ROM_LOAD( "k7", 0x6000, 0x2000, 0x2f8ac3fe , 0x7ef2420e )
	ROM_LOAD( "k8", 0x8000, 0x2000, 0x88eecb70 , 0x29bed201 )
	ROM_LOAD( "k9", 0xa000, 0x2000, 0x50dc5584 , 0x847584d3 )

	ROM_REGION(0x0100)	/* color prom */
	ROM_LOAD( "kickridr.clr", 0x0000, 0x0100, 0x54154173 , 0x73ec281c )

	ROM_REGION(0x10000)	/* 64k for the second CPU */
	ROM_LOAD( "k10", 0x0000, 0x4000, 0xd77bd167 , 0x6843dbc0 )
ROM_END
