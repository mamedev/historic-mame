...
//  PORT_DIPSETTING(    0x01, "Lightgun" )
	...
	PORT_BIT( 0xff, 0xb0, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 0.97, 0.02, 0) PORT_MINMAX(0x80,0xfc) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_PLAYER(1)

	PORT_START_TAG("P1 Lightgun X")	/* IN9 - 57001 */
	PORT_BIT( 0xff, 0x60, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb7) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_PLAYER(1)

	PORT_START_TAG("P2 Lightgun Y")	/* IN10 - 57002 */
	PORT_BIT( 0xff, 0xb0, IPT_LIGHTGUN_Y ) PORT_CROSSHAIR(Y, 0.97, 0.02, 0) PORT_MINMAX(0x80,0xfc) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_PLAYER(2)

	PORT_START_TAG("P2 Lightgun X")	/* IN11 - 57003 */
	PORT_BIT( 0xff, 0x70, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 1.0, 0.0, 0) PORT_MINMAX(0x07,0xb7) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_PLAYER(2)
