...
ROM_START( nycaptor )
	...
	ROM_LOAD( "a50_04",   0x00000, 0x4000, 0x33d971a3 )
	ROM_LOAD( "a50_03",   0x04000, 0x4000, 0x8557fa44 )
	ROM_LOAD( "a50_02",   0x10000, 0x4000, 0x9697b898 )
	ROM_LOAD( "a50_01",   0x14000, 0x4000, 0x0965f84a )

	ROM_REGION( 0x10000, REGION_CPU2, 0 )
	ROM_LOAD( "a50_05-2", 0x0000, 0x4000, 0x7796655a )
	ROM_LOAD( "a50_06",   0x4000, 0x4000, 0x450d6783 )

	ROM_REGION( 0x10000, REGION_CPU3, 0 )
	ROM_LOAD( "a50_15",   0x0000, 0x4000, 0xf8a604e5 )
	ROM_LOAD( "a50_16",   0x4000, 0x4000, 0xfc24e11d )

	ROM_REGION( 0x0800, REGION_CPU4, 0 )
	ROM_LOAD( "a50_17",   0x0000, 0x0800, 0x69fe08dc )

	ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT )
	ROM_LOAD( "a50_07",   0x00000, 0x4000, 0xb3b330cf )
	ROM_LOAD( "a50_09",   0x04000, 0x4000, 0x22e2232e )
	ROM_LOAD( "a50_11",   0x08000, 0x4000, 0x2c04ad4f )
	ROM_LOAD( "a50_13",   0x0c000, 0x4000, 0x9940e78d )
	ROM_LOAD( "a50_08",   0x10000, 0x4000, 0x3c31be14 )
	ROM_LOAD( "a50_10",   0x14000, 0x4000, 0xce84dc5a )
	ROM_LOAD( "a50_12",   0x18000, 0x4000, 0x3fb4cfa3 )
	ROM_LOAD( "a50_14",   0x1c000, 0x4000, 0x24b2f1bf )
ROM_END

ROM_START( cyclshtg )
	ROM_REGION( 0x18000, REGION_CPU1, 0 )
	ROM_LOAD( "a97_01.i17",   0x00000, 0x4000, 0x686fac1a )
	ROM_LOAD( "a97_02.i16",   0x04000, 0x4000, 0x48a812f9 )
	ROM_LOAD( "a97_03.u15",   0x10000, 0x4000, 0x67ad3067 )
	ROM_LOAD( "a97_04.u14",   0x14000, 0x4000, 0x804e6445 )

	ROM_REGION( 0x10000, REGION_CPU2, 0 )
	ROM_LOAD( "a97_05.u22",   0x0000, 0x4000, 0xfdc36c4f )
	ROM_LOAD( "a80_06.u23",   0x4000, 0x4000, 0x2769c5ab )
	ROM_LOAD( "a97_06.i24",   0x8000, 0x4000, 0xc0473a54 )

	ROM_REGION( 0x10000, REGION_CPU3, 0 )
	ROM_LOAD( "a80_16.i26",   0x0000, 0x4000, 0xce171a48 )
	ROM_LOAD( "a80_17.i25",   0x4000, 0x4000, 0xa90b7bbc )

	ROM_REGION( 0x0800, REGION_CPU4, 0 )
	ROM_LOAD( "a80_18",       0x0000, 0x0800, 0x00000000 ) /* Missing */

	ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT )

	ROM_LOAD( "a97_07.u8",    0x00000, 0x4000, 0x8f2baf57 )
	ROM_LOAD( "a80_09.u9",    0x04000, 0x4000, 0x3ef06dff )
	ROM_LOAD( "a80_10.u10",   0x08000, 0x4000, 0x345f576c )
	ROM_LOAD( "a80_11.u11",   0x0c000, 0x4000, 0x29e1293b )
	ROM_LOAD( "a80_12.u23",   0x10000, 0x4000, 0x9ff04c85 )
	ROM_LOAD( "a80_13.u33",   0x14000, 0x4000, 0x96a67c6b )
	ROM_LOAD( "a80_14.u34",   0x18000, 0x4000, 0x91642de8 )
	ROM_LOAD( "a80_15.u39",   0x1c000, 0x4000, 0x2cefb47D )
ROM_END
