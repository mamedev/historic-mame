...
ROM_START( solarfox_rom )
	...
	ROM_LOAD( "sfcpu.3b", 0x0000, 0x1000, 0x1b63bbb9 , 0x8c40f6eb )
	ROM_LOAD( "sfcpu.4b", 0x1000, 0x1000, 0x9f1f7dc7 , 0x4d47bd7e )
	ROM_LOAD( "sfcpu.5b", 0x2000, 0x1000, 0x4b7d8bc1 , 0xb52c3bd5 )
	ROM_LOAD( "sfcpu.4d", 0x3000, 0x1000, 0xae2ca80e , 0xbd5d25ba )
	ROM_LOAD( "sfcpu.5d", 0x4000, 0x1000, 0x426dcdab , 0xdd57d817 )
	ROM_LOAD( "sfcpu.6d", 0x5000, 0x1000, 0x508903cd , 0xbd993cd9 )
	ROM_LOAD( "sfcpu.7d", 0x6000, 0x1000, 0x51468c4e , 0x8ad8731d )

	ROM_REGION_DISPOSE(0x0a000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "sfcpu.4g", 0x0000, 0x1000, 0x44e0e0c0 , 0xba019a60 )
	ROM_LOAD( "sfcpu.5g", 0x1000, 0x1000, 0xb69f2685 , 0x7ff0364e )
	ROM_LOAD( "sfvid.1e", 0x2000, 0x2000, 0x803cf0ae , 0x3da25495 )
	ROM_LOAD( "sfvid.1d", 0x4000, 0x2000, 0x6eeff5c5 , 0x4d8445cf )
	ROM_LOAD( "sfvid.1b", 0x6000, 0x2000, 0xb92428f4 , 0x78801e83 )
	ROM_LOAD( "sfvid.1a", 0x8000, 0x2000, 0x1e42fb6a , 0x9d9b5d7e )

	ROM_REGION(0x10000)	/* 64k for the audio CPU */
	ROM_LOAD( "sfsnd.7a", 0x0000, 0x1000, 0xc3945494 , 0xcdecf83a )
	ROM_LOAD( "sfsnd.8a", 0x1000, 0x1000, 0xd43589ef , 0xcb7788cb )
	ROM_LOAD( "sfsnd.9a", 0x2000, 0x1000, 0x9f5bd101 , 0x304896ce )
ROM_END

ROM_START( kick_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "cpu_b3", 0x0000, 0x1000, 0xb8eacdee , 0x65924917 )
	ROM_LOAD( "cpu_b4", 0x1000, 0x1000, 0x34b3c82d , 0x27929f52 )
	ROM_LOAD( "cpu_b5", 0x2000, 0x1000, 0x962e11c0 , 0x69107ce6 )
	ROM_LOAD( "cpu_d4", 0x3000, 0x1000, 0xb8cf9c4b , 0x04a23aa1 )
	ROM_LOAD( "cpu_d5", 0x4000, 0x1000, 0x59d87236 , 0x1d2834c0 )
	ROM_LOAD( "cpu_d6", 0x5000, 0x1000, 0x59cd7833 , 0xddf84ce1 )

	ROM_REGION_DISPOSE(0x0a000)	/* temporary space for graphics (disposed after conversion) */
	ROM_LOAD( "cpu_g4", 0x0000, 0x1000, 0x4bdb4c47 , 0xb4d120f3 )
	ROM_LOAD( "cpu_g5", 0x1000, 0x1000, 0xbfe7b19f , 0xc3ba4893 )
	ROM_LOAD( "vid_a1", 0x2000, 0x2000, 0x7dbb39e5 , 0x77da795e )
	ROM_LOAD( "vid_b1", 0x4000, 0x2000, 0xdc44b7e0 , 0xf3be56a1 )
	ROM_LOAD( "vid_d1", 0x6000, 0x2000, 0x9abb5055 , 0x565ea97d )
	ROM_LOAD( "vid_e1", 0x8000, 0x2000, 0x6d2149ad , 0x2c5d6b55 )

	ROM_REGION(0x10000)	/* 64k for the audio CPU */
	ROM_LOAD( "sio_a7", 0x0000, 0x1000, 0x02d981f3 , 0x9e35c02e )
	ROM_LOAD( "sio_a8", 0x1000, 0x1000, 0xc5223442 , 0xca2b7c28 )
	ROM_LOAD( "sio_a9", 0x2000, 0x1000, 0xbe9ef560 , 0xd1901551 )
	ROM_LOAD( "sio_a10", 0x3000, 0x1000, 0x1667420b , 0xd36ddcdc )
ROM_END

ROM_START( kicka_rom )
	ROM_REGION(0x10000)	/* 64k for code */
	ROM_LOAD( "mccpua2", 0x0000, 0x1000, 0x04581d20 , 0x22fa42ed )
	ROM_LOAD( "mccpub2", 0x1000, 0x1000, 0x16695047 , 0xafaca819 )
	ROM_LOAD( "mccpuc2", 0x2000, 0x1000, 0x43109576 , 0x6054ee56 )
	ROM_LOAD( "mccpud2", 0x3000, 0x1000, 0xf9771753 , 0x263af0f3 )
	ROM_LOAD( "mccpue2", 0x4000, 0x1000, 0x6c3fedbb , 0xeaaa78a7 )
	ROM_LOAD( "mccpuf2", 0x5000, 0x1000, 0xa98b1d6b , 0xc06c880f )

	ROM_REGION_DISPOSE(0x0a000)	/* temporary space for graphics (disposed after conversion) */
ROM_LOAD( "cpu_g4", 0x0000, 0x1000, 0x4bdb4c47 , 0xb4d120f3 )
ROM_LOAD( "cpu_g5", 0x1000, 0x1000, 0xbfe7b19f , 0xc3ba4893 )
	ROM_LOAD( "lmcvgd3", 0x2000, 0x1000, 0x2044da80 , 0x3a0e28ac )
	ROM_LOAD( "hmcvgd3", 0x3000, 0x1000, 0x1d77e365 , 0x8082a663 )
	ROM_LOAD( "lmcvgc3", 0x4000, 0x1000, 0xbc8a3350 , 0xc7d4cbac )
	ROM_LOAD( "hmcvgc3", 0x5000, 0x1000, 0xb912a690 , 0xb229c37b )
	ROM_LOAD( "lmcvgb3", 0x6000, 0x1000, 0xa5307d78 , 0x78274c1d )
	ROM_LOAD( "hmcvgb3", 0x7000, 0x1000, 0x43ea028a , 0x21718c1d )
	ROM_LOAD( "lmcvga3", 0x8000, 0x1000, 0x5c2030e6 , 0xfe452138 )
	ROM_LOAD( "hmcvga3", 0x9000, 0x1000, 0x1101794b , 0x1aa5382e )
