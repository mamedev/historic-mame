...
to the TC0100SCN tilemap chip, debuted in the multi-screen game
Ninja Warriors (c)1987. The TC0100SCN includes a separate text
layer.


TODO
====
Why does the adpcm Z80 write so many bytes to $e000-ffff in rom?
...
/*
  palette convert test
*/
static READ16_HANDLER( paletteram16_r ){
  return paletteram16[offset];
}

WRITE16_HANDLER( dump_message ){
...
static MEMORY_READ16_START( darius_readmem )
	...
	{ 0xd00000, 0xd0ffff, PC080SN_word_0_r },	/* tilemaps */
	  //{ 0xd80000, 0xd80fff, MRA16_RAM },		/* palette */
...
static WRITE_HANDLER( sound_bankswitch_w ){
  ...
  if( banknum != data ){
    banknum = data;
    cpu_setbank( 1, RAM + (banknum * 0x8000) + 0x10000 );
  }
}
...
/*
  darius sound mixer/pan control
*/
...
static MEMORY_WRITE_START( darius_sound2_writemem )
	{ 0x0000, 0xffff, MWA_NOP },	/* $1ce-1d6 prog writes many bytes to ROM */
	/* yes, no RAM */
MEMORY_END
...
INPUT_PORTS_START( darius )
	...
	PORT_START	/* DSW, coinage will vary by country */
...
GAME( 1986, dariusj,  darius,   darius,   darius,   darius,   ROT0, "Taito Corporation", "Darius (Japan)" )
GAME( 1986, dariuso,  darius,   darius,   darius,   darius,   ROT0, "Taito Corporation", "Darius (Japan old version)" )
GAME( 1986, dariuse,  darius,   darius,   darius,   darius,   ROT0, "Taito Corporation", "Darius (Extra) (Japan)" )
