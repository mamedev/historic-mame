...
ROM_START( route16_rom )
	...
	ROM_LOAD( "pr09", 0x0000, 0x0100, 0x82db0201 ) /* top bitmap */
	ROM_LOAD( "pr10", 0x0100, 0x0100, 0x82db0201 ) /* bottom bitmap */
...
ROM_START( speakres_rom )
	ROM_REGION(0x10000)     /* 64k for code */
	ROM_LOAD( "speakres.1", 0x0000, 0x0800, 0x5e358977 )
	ROM_LOAD( "speakres.2", 0x0800, 0x0800, 0xf057be61 )
	ROM_LOAD( "speakres.3", 0x1000, 0x0800, 0x63b8b21e )
	ROM_LOAD( "speakres.4", 0x1800, 0x0800, 0xd20d162f )
	ROM_LOAD( "speakres.5", 0x2000, 0x0800, 0xe611e255 )
	ROM_LOAD( "speakres.6", 0x2800, 0x0800, 0xc4c0bc7a )
	...
	ROM_REGION(0x10000)     /* 64k for the second CPU */
	ROM_LOAD( "speakres.7", 0x0000, 0x0800, 0xb8bb6613 )
	ROM_LOAD( "speakres.8", 0x0800, 0x0800, 0x2148d22e )
ROM_END
